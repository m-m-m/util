...
public interface MetakeyId3v2 extends MetakeyAudioVideo {
  ...
  /**
   * Contains the size in bytes of the file representing the audio, excluding
   * the ID3v2 tag, represented as a numeric string.
   */
  String TSIZ = "TSIZ";

  /**
   * The language(s) of the text or lyrics of the audio. According to ID3 the
   * language is represented with three characters according to ISO-639-2 while
   * {@link #LANGUAGE} is defined as single language in ISO-639-1. If more than
   * one language is used in the text their language codes should follow
  ...
  /**
   * Contains more information about the people behind a remix and similar
  ...
  /**
   * Contains a numeric string with a year of the recording. This frames is
   * typically four characters long (e.g. 1999 or 2011).
   */
  String TYER = "year";
