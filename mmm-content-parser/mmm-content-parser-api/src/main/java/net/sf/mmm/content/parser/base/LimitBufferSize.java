 ...
 * {@link net.sf.mmm.content.parser.api.ContentParserService parser-service} and
 * can be implemented by {@link net.sf.mmm.content.parser.api.ContentParser
 * parsers}. It allows to {@link #setMaximumBufferSize(int) configure} the
 * maximum size used for buffers when parsing the content.
 * 
...
public interface LimitBufferSize {
  ...
  /**
   * This method can be called to configure the {@link #getMaximumBufferSize()
   * maximum buffer size} used for buffers when parsing a content.
   * 
   ...
   * may allocate another array of about that size. This is a legal behaviour of
   * the {@link net.sf.mmm.content.parser.api.ContentParser parser}. So if you
   * want to limit your heap-size use a reasonable lower value for
   * <code>maxBytes</code>. Please do NOT use values lower than 1024 (You do NOT
   * want to parse Word-Documents with J2ME on your mobile phone, do you?).<br>
