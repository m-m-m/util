...
public class ContentParserXlsxTest extends AbstractContentParserPoiTest {

  public void checkParser(ContentParser parser, long filesize) throws Exception {

    GenericContext properties = parse(parser, "test.xlsx", filesize);
  ...
  protected ContentParser getContentParser() {
    ...
    ContentParserXlsx parser = new ContentParserXlsx();
    parser.initialize();
    return parser;
  }
