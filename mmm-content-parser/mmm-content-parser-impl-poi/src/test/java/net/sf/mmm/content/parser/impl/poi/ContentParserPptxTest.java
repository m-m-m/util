...
public class ContentParserPptxTest extends AbstractContentParserPoiTest {

  public void checkParser(ContentParser parser, long filesize) throws Exception {

    GenericContext properties = parse(parser, "test.pptx", filesize);
  ...
  protected ContentParser getContentParser() {
    ...
    ContentParserPptx parser = new ContentParserPptx();
    parser.initialize();
    return parser;
  }
