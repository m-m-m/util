...
import net.sf.mmm.content.parser.impl.AbstractContentParserTextMarkupAware;
...
public class ContentParserHtml extends AbstractContentParserTextMarkupAware {
  ...
  /**
   * @see net.sf.mmm.content.parser.impl.AbstractContentParserText#parse(java.io.InputStream,
   *      long)
   * 
   * @param inputStream
   * @param filesize
