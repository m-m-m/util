 ...
 * multiple {@link Filetype}s for a single mimetype).
 * 
...
public interface Filetype {
  ...
  /**
   * This method gets the default extension associated with this filetype (e.g.
   * ".jpg").
   * 
   ...
   * 
   * @param index is the position of the requested sub-type.
   * @return the sub-type at the given index.
   */
  Filetype getSubType(int index);
   ...
   * <code>type1.{@link #isParentType(Filetype) isParentType}(type1)</code>
   * will always be <code>true</code> and
   * <code>type1.{@link #isParentType(Filetype) isParentType}(type2)</code>
   * will be <code>true</code> only if ...
   * 
   * @param type is the filetype to compare.
   * @return <code>true</code> if the given filetype is a parent type of this
   *         filetype or the same object.
   */
  boolean isParentType(Filetype type);

  /**
   * This method determines if the given filetype is a sub type of this filetype
   * or the same object. <br>
   * The expression
   * <code>type1.{@link #isSubType(Filetype) isSubType}(type2)</code> will
   * produce the same result as
   * <code>type2.{@link #isParentType(Filetype) isParentType}(type1)</code>.
   * 
   * @param type is the filetype to compare.
   * @return <code>true</code> if the given filetype is located in the subtree
   *         represented by the current filetype as node.
   */
  boolean isSubType(Filetype type);
   ...
   * 
   * @return <code>true</code> if the filetype is abstract, <code>false</code>
   *         otherwise.
   */
  boolean isAbstract();
   ...
   */
  Iterator<? extends Filetype> getSubTypes();
