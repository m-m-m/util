...
public interface Pool<E> {
  ...
  /**
   * This method releases the given <code>element</code>. It will be put back
   * into the pool.<br>
   * <b>ATTENTION:</b><br>
   * Only call this method if you are sure that the given <code>element</code>
   * is NOT in use anymore. Therefore no reference should exist on the
   * <code>element</code> and you should NOT have passed the
   * <code>element</code> to a third-party library that may keep it in some
   * cache.
   * 
