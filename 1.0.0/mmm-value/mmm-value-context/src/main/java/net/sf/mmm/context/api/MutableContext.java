...
public interface MutableContext extends Context {
   ...
   * the given <code>value</code>. If the variable is already set, it will be
   * overriden.
   * 
   ...
   * inherited from a {@link Context#createChildContext() parent context} can
