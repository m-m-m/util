 ...
 * {@link ExtendedComponentDescriptor#getImplementation() component} associated
 * with a {@link #getLifecyclePhase() phase} of the
...
public final class LifecycleMethod {
  ...
  /**
   * This is the {@link #getLifecyclePhase() lifecycle-phase} for the execution
   * of the component in a separate {@link Thread thread}. The component should
   * also support {@link #LIFECYCLE_STOP stop} or
  ...
  /**
   * This is the {@link #getLifecyclePhase() lifecycle-phase} for reconfiguring
   * a {@link #LIFECYCLE_PAUSE paused} component.
   * 
   * @see #LIFECYCLE_PAUSE
   * 
   * The suggested signature is: <br>
   ...
   * The constructor.
   * 
   * @param lifecyclePhase is the {@link #getLifecyclePhase() phase}.
   * @param lifecycleMethod is the {@link #getLifecycleMethod() method}.
   */
