...
public class SaxXmlWriter extends AbstractXmlWriter {
    ...
    public void writeEndElement(String tagname, String namespacePrefix) throws XmlException {
        ...
        try {
            if (namespacePrefix == null) {
                ...
                this.handler.endElement(namespaceUri, tagname, createQualifiedName(namespacePrefix,
                        tagname));
            }
    ...
    public void writeAttribute(String name, String value, String namespacePrefix) throws XmlException {
        ...
        if (namespacePrefix == null) {
            ...
            this.currentAttributes.addAttribute(namespaceUri, name, createQualifiedName(
                    namespacePrefix, name), DEFAULT_ATTRIBUTE_TYPE, value);
        }
    }
     ...
     * {@inheritDoc}
     */
    public void writeNamespaceDeclaration(String namespacePrefix, String namespaceUri) throws XmlException {

        this.prefix2namespaceUriMap.put(namespacePrefix, namespaceUri);
        if (this.currentName != null) {
            this.currentAttributes.addAttribute(XmlUtil.NAMESPACE_URI_XMLNS, namespacePrefix,
                    createQualifiedName("xmlns", namespacePrefix), DEFAULT_ATTRIBUTE_TYPE,
                    namespaceUri);
        }
    }
