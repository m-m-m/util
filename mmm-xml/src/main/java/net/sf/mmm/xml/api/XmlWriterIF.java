/* $Id: XmlWriterIF.java 191 2006-07-24 21:00:49Z hohwille $ */
...
public interface XmlWriterIF {
    ...
    /**
     * This method opens an XML {@link org.w3c.dom.Element element} in the
     * default namespace. The XML element must be closed using the
    ...
    /**
     * This method sets an attribute of the previously opened element. This
     ...
     *        is the plain (not encoded) value of the attribute.
     * @param namespacePrefix
     *        is the key of the referenced namespace. A value of
     ...
     * @throws XmlException
     *         if the serialization produced an error (I/O Error,
     ...
     *        characters such as &amp; have to be escaped by the implementation
     *        of this method.
     * @throws XmlException
     *         if the serialization produced an error (I/O Error, invalid XML,
     *         etc.)
     ...
     *        character sequence "]]>" has to be escaped by the implementation
     *        of this method.
     * @throws XmlException
     *         if the serialization produced an error (I/O Error, invalid XML,
     *         etc.)
