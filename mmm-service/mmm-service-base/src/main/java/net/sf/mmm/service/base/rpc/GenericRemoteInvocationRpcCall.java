 ...
 * {@link net.sf.mmm.service.api.rpc.RemoteInvocationService}. It contains the data for a single method call.
 * 
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
public class GenericRemoteInvocationRpcCall implements RemoteInvocationCall {
   ...
   */
  public GenericRemoteInvocationRpcCall(String serviceInterfaceName, String methodName, int signature,
   ...
   *         {@link net.sf.mmm.service.api.rpc.RemoteInvocationService} interface to invoke.
   */
