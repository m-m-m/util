...
public class ReflectionUtilTest extends Assertions {
  ...
  public void testGenericTypeComponent() throws Exception {
    ...
    type = getReflectionUtil().createGenericType(ExParameterizedStringList.class.getGenericSuperclass()).getComponentType();
    assertThat(type.getRetrievalClass()).isEqualTo(String.class);
  ...
  public void testGenericTypeAssignableFrom() throws Exception {
    ...
    assertThat(superType.toString()).isEqualTo("java.util.Map<? extends java.lang.Number, ? extends java.lang.CharSequence>");
  ...
  public void testToTypeAndToString() throws Exception {
    ...
    checkTypeParser("java.util.Map<? super java.lang.String, ? extends java.lang.String>", "Map<? super String, ? extends String>");
    checkTypeParser("java.util.Map<java.util.List<java.lang.String>, java.util.Set<java.lang.String>>", "Map<List<String>, Set<String>>");
    checkTypeParser("?[]", "?[]");
    checkTypeParser("java.util.List<?>[]", "List<?>[]");
  }
  ...
  public void testFindResourceNames() throws Exception {
    ...
    String hyphenation = "net/sf/mmm/util/text/hyphenation_de.xml";
