 ...
 * {@link #invoke(Object, int) perform something} (e.g. get or remove) for a given <code>index</code> of an
 * indexed property.
 * 
...
public interface PojoPropertyAccessorIndexedNonArg extends PojoPropertyAccessor {
   ...
   * @return the result of the invocation. Will be <code>null</code> if void (e.g. remove method).
