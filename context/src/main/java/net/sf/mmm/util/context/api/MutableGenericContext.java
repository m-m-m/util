...
public interface MutableGenericContext extends GenericContext {
  ...
  /**
   * This method sets the variable specified by {@code variableName} to the given {@code value}. If
   ...
   *         {@code null} if the variable was undefined or NOT overridden in this context.
   */
  Object setVariable(String variableName, Object value);

  /**
   * This method sets the variable given by {@code value}. If the variable is already set, it will be
  ...
  /**
   * This method removes (unsets) the variable specified by {@code variableName}. This will only remove a
   ...
   * You might want to {@link #setVariable(String, Object) set} a variable to {@code null} instead.
   * 
   * @param variableName is the name of the variable to unset.
   * @return the old value of the variable or {@code null} if the variable is NOT defined (in this
   *         context).
   */
