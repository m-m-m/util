...
public abstract class AbstractConfigurationDocument implements ConfigurationDocumentIF,
    ...
    protected void detectInclusionCycle() throws ConfigurationException {
        ...
        while (doc != null) {
            if (accessId.equals(doc.access.getUniqueUri())) {
                throw new ConfigurationException(NlsResourceBundle.ERR_INCLUDE_CYCLE, accessId,
                        this);
            }
            doc = doc.parentDoc;
        }
     ...
     * {@link ConfigurationChangeEvent change-event}. This method must be
     * called by the {@link ConfigurationIF configurations} of this document on
     * any change.
     * 
     * @see #save()
     * 
    ...
    /**
     * This method saves the configuration to the given output stream. The
     * stream must NOT be closed by this method.
     * 
     * @param outputStream
     ...
     * 
     * @return the {@link #getConfiguration() root-node} of the loaded and
    ...
    /**
     * This method loads the configuration from the given input stream. The
     * stream must NOT be closed by this method.
     * 
     * @param inputStream
    ...
    /**
     * This inner class represents a container for a {@link #configuration} and
     * a {@link #listener}. Additionally it is a
