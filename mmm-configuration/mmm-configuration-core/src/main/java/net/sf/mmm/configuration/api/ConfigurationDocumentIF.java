...
public interface ConfigurationDocumentIF {
  ...
  /**
   * This is the URI of the {@link ConfigurationIF#getNamespaceUri() namespace}
   ...
   * {@link ConfigurationIF.Type#ATTRIBUTE attribute} that defines the format of
   * the {@link ConfigurationIF configuration} to {@link #NAME_INCLUDE include}.
  ...
  /**
   * This is the {@link ConfigurationIF#getName() name} of an optional
   * {@link ConfigurationIF.Type#ATTRIBUTE attribute} that defines how to access
   * the {@link ConfigurationIF configuration} to {@link #NAME_INCLUDE include}.
   * This corresponds to the
  ...
  /**
   * This is the {@link ConfigurationIF#getName() name} of an optional
   * {@link ConfigurationIF.Type#ATTRIBUTE attribute} that defines the relative
   * {@link ConfigurationIF#getPath() path} of the
  ...
  /**
   * This is the {@link ConfigurationIF#getName() name} of an
   * {@link ConfigurationIF.Type#ATTRIBUTE attribute} that can be applied to any
   * {@link ConfigurationIF.Type#ELEMENT element}. It must have the
   ...
   * The {@link ContextIF#getVariableNames() name} of the valiable is defined by
   * the child {@link ConfigurationIF.Type#ATTRIBUTE attribute}
   ...
   * {@link net.sf.mmm.value.api.GenericValueIF#getObject() read} (e.g.
   * "http://localhost:8080").
   * 
