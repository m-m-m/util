...
public interface ConfigurationAccessFactoryIF {
    ...
    /**
     * This is the suffix for a context variable pointing to an implementation
     * of this interface for the according type.
     * 
    ...
    /**
     * This is the suffix for a context variable containg the current href used
     * as base if the
     * {@link net.sf.mmm.configuration.api.ConfigurationDocumentIF#NAME_INCLUDE_HREF}
     * is a relative path.
     */
     ...
     * {@link ConfigurationAccessIF#isReadOnly() read-only}. The default value
     * is <code>false</code>.
     */
     ...
     *        {@link ContextIF#getValue(String) "variables"} containing the
     *        factory
     ...
     * according to its configuration (even if it currently has exaclty one
     * single access) it should return <code>false</code>.<br>
