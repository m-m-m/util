/* $Id: PropertiesDocument.java 200 2006-08-01 21:30:00Z hohwille $ */
...
public class PropertiesDocument extends AbstractConfigurationDocument {
    ...
    /**
     * This method determines if the properties are treated flat. In this case
     * all properties are direct children of the root-node.<br>
     ...
     * properties are treated as tree (NOT {@link #isFlat() flat}) is used
     * analog to
     * {@link net.sf.mmm.configuration.api.ConfigurationIF#PATH_SEPARATOR} but
    ...
    protected AbstractConfiguration load(InputStream inputStream) throws ConfigurationException {
        ...
        try {
            ...
            PropertiesElement root = new PropertiesElement(getParentConfiguration(), this, "",
                    name, namespace);
            // TODO: namespace support...
            for (Object key : this.properties.keySet()) {
                String keyString = key.toString();
                if (this.flat) {
                    PropertiesElement child = new PropertiesElement(root, this, keyString,
                            keyString, namespace);
                    root.addChild(child);
                } else {
