...
public interface ConfigurationFactoryIF {
    ...
    /**
     * The prefix for the {@link ContextIF#getValue(String) variables}
     * containing the factory
     * {@link #configure(String, ContextIF, ConfigurationIF) configuration}.<br>
     * Here an example in XML notation (to make it obvious we use "foo" instead
     * of "xml"):
     * 
     * <pre>
     ...
     *        gives read/write access to the configuration data.
     * @param context
     *        is the {@link ConfigurationDocumentIF#getContext() context} for
     *        the document.
     * @return the loaded configuration.
     * @throws ConfigurationException
     *         if the configuration data could not be read or is illegal.
