...
public class DescendantPathParser {
   ...
   */
  public static Condition parseCondition(CharSequenceScanner parser, List<SimplePathSegment> segmentList,
      boolean strict) {
   ...
   */
  public static PathSegment parseSegment(CharSequenceScanner parser, List<SimplePathSegment> segmentList,
      boolean strict) {
   ...
   */
  public static PathSegment[] parsePath(CharSequenceScanner parser, boolean strict) {
   ...
   */
  public static void parsePath(CharSequenceScanner parser, List<PathSegment> segments, boolean strict,
