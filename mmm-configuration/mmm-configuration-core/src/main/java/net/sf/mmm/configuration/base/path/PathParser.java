/* $Id: PathParser.java 191 2006-07-24 21:00:49Z hohwille $ */
...
public class PathParser {
            ...
            switch (c) {
                ...
                case ConfigurationIF.PATH_CONDITION_END:
                    if (comparatorLength == 0) {
                        ...
                        ComparatorIF comparator = ComparatorManager.getInstance()
                                .getComparator(cmp);
                        ...
                        condition = new Condition(namePattern, childName, value, valuePattern,
                                comparator);
                    }
                    break;
                case '*':
    ...
    /**
     * This method reads all segments of a simple path. A simple path is build
     * by one or multiple segments separated by
