...
public interface RevisionHistory {
  ...
  /**
   * This method gets the date when the given <code>action</code> was
   * performed on the associated revision.
   * 
   * @see net.sf.mmm.content.security.api.ContentAction
   * 
   * @param action is the action for that the date of performing is requested.
   *        This should be the name of an
   *        {@link net.sf.mmm.content.security.api.ContentAction action} - e.g.
   *        {@link net.sf.mmm.content.security.api.ContentAction#ACTION_CREATE}.
