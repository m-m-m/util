...
public interface ContentFolder extends ContentResource {
  ...
  /**
   * The {@link net.sf.mmm.content.api.ContentObject#getName() name} of the
   * resources-{@link ContentFolder folder}. All
   * {@link ContentResource content-resources} are located below this folder.
   */
  ...
  /**
   * The {@link net.sf.mmm.content.api.ContentObject#getName() name} of the id-{@link ContentFolder folder}.
   * 
   * @see #PATH_IDS
   */
  String NAME_IDS = "ids";
   ...
   * {@link net.sf.mmm.content.value.api.ContentId#toString() name} of their
   * {@link net.sf.mmm.content.api.ContentObject#getId() ID}. No
   * {@link ContentResource resource} will return a {@link #getPath() path}
   * below this folder. This folder will (usually) NOT be browseable (have an
   * empty {@link #getChildren() child-list}).
   */
