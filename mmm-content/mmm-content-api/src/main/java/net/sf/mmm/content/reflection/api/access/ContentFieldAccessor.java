 ...
 * {@link net.sf.mmm.content.reflection.api.ContentField field} of a
 * {@link net.sf.mmm.content.api.ContentObject content-object}. According to the
 * {@link net.sf.mmm.content.reflection.api.ContentField#getContentModifiers()
 ...
 *        {@link net.sf.mmm.content.reflection.api.ContentField#getJavaClass()}.
...
public interface ContentFieldAccessor<CLASS, FIELD> {
   ...
   *         compatible with the
   *         {@link net.sf.mmm.content.reflection.api.ContentField#getFieldType()
   *         type} of the field.
   */
