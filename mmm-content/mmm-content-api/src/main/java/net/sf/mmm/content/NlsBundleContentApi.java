 ...
 * @since 1.0.0
 */
public class NlsBundleContentApi extends AbstractResourceBundle {

  /**
   * The constructor.
   */
  public NlsBundleContentApi() {
  ...
  /** @see net.sf.mmm.content.reflection.base.ContentClassLoaderException */
  ...
  /** @see net.sf.mmm.content.api.ContentModelSystemModifyException */
  public static final String ERR_MODIFY_SYSTEM = "Can NOT modify \"{0}\" because it is required by the system!";

  /** @see net.sf.mmm.content.api.ContentCastException */
