 ...
 * {@link net.sf.mmm.content.reflection.api.ContentClass ContentClass}.
 * 
...
public final class ContentClassId extends AbstractContentId {
  ...
  /**
   * the id of the root {@link net.sf.mmm.content.reflection.api.ContentClass
  ...
  /**
   * the id of the {@link net.sf.mmm.content.reflection.api.ContentClass
   * content-class} that reflects
   * {@link net.sf.mmm.content.reflection.api.ContentReflectionObject
   ...
   * the id of the {@link net.sf.mmm.content.reflection.api.ContentClass
   * content-class} that reflects
   * {@link net.sf.mmm.content.reflection.api.ContentField content-field}.
   */
