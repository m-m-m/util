 ...
 * {@link net.sf.mmm.content.api.ContentObject} in a content-repository.<br/>
 * It is build out of four parts:
 * <ul>
 * <li>{@link #getObjectId() object-id} - unique ID of a
 * {@link net.sf.mmm.content.api.ContentObject} of a particular
 * {@link net.sf.mmm.content.reflection.api.ContentClass} (type).</li>
 * <li>{@link #getClassId() class-id} - is the id of the
 * {@link net.sf.mmm.content.reflection.api.ContentClass} that reflects the
 * {@link net.sf.mmm.content.api.ContentObject} identified by this
 * {@link ContentId}.</li>
 * <li>{@link #getRevision() revision} - a
 * {@link net.sf.mmm.content.api.ContentObject}
 * {@link net.sf.mmm.content.reflection.api.ContentClass#isRevisionControlled() can}
 * have multiple {@link net.sf.mmm.content.reflection.api.ContentClass#getRevision()
 ...
 * {@link net.sf.mmm.content.resource.api.ContentResource} this ID points to the
 * exact revision in the history of that resource.<br>
 * Since the {@link #getRevision() revision} and {@link #getClassId() class} of
 * a {@link net.sf.mmm.content.api.ContentObject content-object} does not
 ...
 * (e.g. DB lookup). Especially a {@link net.sf.mmm.content.api.ContentObject}
...
public interface ContentId extends Datatype<ContentId> {
  ...
  /**
   * the id number of the {@link net.sf.mmm.content.reflection.api.ContentClass
   ...
   * {@link net.sf.mmm.content.api.ContentObject#getId() unique identifier} of a
   * {@link net.sf.mmm.content.api.ContentObject} for a particular
   * {@link net.sf.mmm.content.reflection.api.ContentClass}.
   * 
   ...
   * {@link net.sf.mmm.content.reflection.api.ContentClass} reflecting the identified
   * object.
   * 
   * @see net.sf.mmm.content.api.ContentObject#getContentClassId()
   * @see #getContentClassId()
   * 
   * @see net.sf.mmm.content.reflection.api.ContentClass#CLASS_ID
   * @see net.sf.mmm.content.reflection.api.ContentField#CLASS_ID
   * 
   * @return the classId.
   */
  int getClassId();
   ...
   * of an object.
   * 
   * @see net.sf.mmm.content.api.ContentObject#getRevision()
   * @see net.sf.mmm.content.api.ContentObject#LATEST_REVISION
   * 
   * @return the revision.
   */
  int getRevision();
   ...
   * {@link net.sf.mmm.content.reflection.api.ContentClass}. It is build by using the
   * {@link #getClassId() class-ID} as {@link #getObjectId() object-ID} and
   * {@link net.sf.mmm.content.reflection.api.ContentClass#CLASS_ID} as
