 ...
 * {@link net.sf.mmm.content.reflection.api.ContentClass}es. It is capable of reading
 * a {@link net.sf.mmm.content.reflection.api.ContentClass} from a configuration
 * (e.g. XML) provided from any data-source (e.g. filesystem, classpath,
 * database).<br/>
...
public interface ContentClassLoader<CLASS> {
   ...
   *         way.
   */
  ContentClass<CLASS> loadClasses() throws ContentModelException;
