...
public final class ContentModelEvent<CLASS> implements ChangeEvent {
  ...
  private final ContentClass<CLASS> contentClass;

  /** the field that this event is about */
  private final ContentField<CLASS, ?> contentField;
   ...
   */
  public ContentClass<CLASS> getContentClass() {
   ...
   */
  public ContentField<CLASS, ?> getContentField() {
