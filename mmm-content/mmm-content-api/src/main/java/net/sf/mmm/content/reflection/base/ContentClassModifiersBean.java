 ...
 * interface.
 * 
 * @see net.sf.mmm.content.reflection.api.ContentClass#getContentModifiers()
 * 
...
public class ContentClassModifiersBean extends AbstractContentModifiersBean implements
  ...
  /**
   * the {@link net.sf.mmm.content.reflection.api.ContentClass#getContentModifiers()
   * modifiers} for a {@link #isSystem() system}
   * {@link net.sf.mmm.content.reflection.api.ContentClass content-class}.
   */
   ...
   * the {@link net.sf.mmm.content.reflection.api.ContentClass#getContentModifiers()
   * modifiers} for a {@link #isSystem() system}
   * {@link net.sf.mmm.content.reflection.api.ContentClass content-class} that is NOT
   ...
   * the {@link net.sf.mmm.content.reflection.api.ContentClass#getContentModifiers()
   * modifiers} for a
   * {@link net.sf.mmm.content.reflection.api.ContentModifiers#isSystem() system}
   * {@link net.sf.mmm.content.reflection.api.ContentClass content-class} that is
   * {@link #isFinal() final}.
   */
  ...
  /**
   * the {@link net.sf.mmm.content.reflection.api.ContentClass#getContentModifiers()
   * modifiers} for a "normal" {@link net.sf.mmm.content.reflection.api.ContentClass
   * content-class}.
   */
