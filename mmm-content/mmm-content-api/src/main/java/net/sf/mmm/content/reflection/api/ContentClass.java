...
public interface ContentClass<CLASS extends ContentObject> extends ContentReflectionObject<CLASS>,
  ...
  /**
   * The first {@link net.sf.mmm.content.datatype.api.ContentId#getClassId()
   * class-ID} that can be used for custom classes. All
   * {@link net.sf.mmm.content.datatype.api.ContentId#getClassId() class-ID}
   ...
   * 
   * @see net.sf.mmm.content.api.ContentClassAnnotation#revisionControl()
   * 
