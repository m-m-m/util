 ...
 * validation. While Java defines a very sophisticated API provided by {@code javax.validation} it is 
 ...
 * {@code javax.validation} to the client. However, the price of this complexity is reduced turn-around times
