 ...
 * <a name="documentation"/><h2>Client Dialog Impl (GWT)</h2> 
 * This package and its sub-package contains the implementation of the {@link net.sf.mmm.client.api.dialog Client Dialog API} using 
 * GWT (Google Web Toolkit), GWTP (GWT-Platform) and GIN (GWT INjection). It extends GWTP with abstract base classes to
 * build a web client framework.<br/>
 * <b>INSTRUCTIONS:</b><br/>
 ...
 * <ul>
 * <li>Create an interface extending {@link net.sf.mmm.client.base.gwt.dialog.common.UiHandlersAbstractPresenter} named
 * <code>basepackage.<em>x</em>.common.UiHandlers<em>X</em></code>.</li>
 * <li>Create an interface extending {@link net.sf.mmm.client.base.gwt.dialog.common.AbstractView} named 
 * <code>basepackage.<em>x</em>.common.<em>X</em>View</code>.</li>
 * <li>Create a class extending {@link net.sf.mmm.client.base.gwt.dialog.view.AbstractViewImpl} and implementing 
 * <code><em>X</em>View</code> named <code>basepackage.<em>x</em>.view.<em>X</em>ViewImpl</code>.</li>
 * <li>Create a subclass of {@link net.sf.mmm.client.base.gwt.dialog.presenter.AbstractPresenter} named 
