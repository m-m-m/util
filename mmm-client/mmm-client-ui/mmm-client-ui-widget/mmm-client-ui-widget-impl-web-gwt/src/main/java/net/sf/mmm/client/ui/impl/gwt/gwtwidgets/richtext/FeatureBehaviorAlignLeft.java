...
/**
 * This is the implementation of {@link FeatureBehavior} for {@link RichTextFeature#ALIGN_LEFT}.
 * 
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
class FeatureBehaviorAlignLeft extends AbstractSimpleClickFeatureBehavior {
   ...
   */
  public FeatureBehaviorAlignLeft(RichTextToolbar richTextToolbar) {
  ...
  public RichTextFeature getFeature() {
    ...
    return RichTextFeature.ALIGN_LEFT;
  }
  ...
  public void onClick(ClickEvent event) {
    ...
    getFormatter().setJustification(Justification.LEFT);
  }
