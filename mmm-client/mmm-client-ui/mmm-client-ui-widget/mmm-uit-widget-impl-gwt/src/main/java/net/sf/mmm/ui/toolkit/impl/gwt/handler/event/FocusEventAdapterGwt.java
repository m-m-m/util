...
public class FocusEventAdapterGwt implements FocusHandler, BlurHandler {
   ...
   * The constructor.
   * 
   * @param source is the source of the events (typically {@link net.sf.mmm.ui.toolkit.api.widget.UiWidget}).
   * @param sender is the sender of events (will typically be
   *        {@link net.sf.mmm.ui.toolkit.base.handler.event.FocusEventSender}).
   */
   ...
   * {@link net.sf.mmm.ui.toolkit.api.attribute.AttributeWriteFocused#setFocused(boolean)}.
   */
