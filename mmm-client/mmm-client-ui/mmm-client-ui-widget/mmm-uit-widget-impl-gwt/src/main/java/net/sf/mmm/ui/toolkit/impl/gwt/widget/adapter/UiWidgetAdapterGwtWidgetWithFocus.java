...
/**
 * This is the implementation of {@link UiWidgetAdapterWithFocus} using GWT based on {@link Widget}.
 * 
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 * @param <WIDGET> is the generic type of {@link #getWidget()}.
 */
public abstract class UiWidgetAdapterGwtWidgetWithFocus<WIDGET extends Widget> extends UiWidgetAdapterGwtWidget<WIDGET>
    implements UiWidgetAdapterWithFocus<WIDGET>, AttributeWriteKeyboardFilter {
   ...
   * The constructor.
   */
  public UiWidgetAdapterGwtWidgetWithFocus() {
