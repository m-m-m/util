 ...
 * and enter a value of the type {@link Instant} with day, month and year as well as the time in hours,
 ...
 * @since 1.0.0
 */
public abstract interface UiWidgetDateTimeField extends UiWidgetTextualInputField<Instant>, UiWidgetNative {
