 ...
 * @since 1.0.0
 */
public interface UiWidgetColorField extends UiWidgetField<Color> {

  /** The {@link #getPrimaryStyle() primary style} of the internal color box. */
  String STYLE_COLOR_BOX = "ColorBox";
