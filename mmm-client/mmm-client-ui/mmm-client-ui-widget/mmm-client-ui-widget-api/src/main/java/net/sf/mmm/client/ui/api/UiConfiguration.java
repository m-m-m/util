...
public interface UiConfiguration {
   ...
   * {@link net.sf.mmm.client.ui.base.binding.UiDataBinding}. So you can highly customize your labels for your
   ...
   * {@link net.sf.mmm.util.pojo.path.api.TypedProperty#getTitle() property title} that is used as fallback if
   * lookup fails. <br>
   ...
   * {@link net.sf.mmm.util.nls.api.NlsBundle}. For each
   * {@link net.sf.mmm.util.pojo.path.api.TypedProperty#getTitle() property title} such as
   * <code>lastName</code> you define an according method in your bundle (NlsBundleMyLabelsRoot):<br>
   *
   * <pre>
   ...
   * </pre>
   *
   * E.g. for German localization you define <code>NlsBundleMyLabels_de.properties</code> in the same package
   * with this content:
   *
   * <pre>
   * lastName = Nachname
   ...
   * automatically to your localized label text ("Last Name", "Vorname", or whatever). <br>
   * Now if you refactor your code so the property <code>lastName</code> gets renamed to <code>surename</code>
   ...
   * You could also use "Partner_surename" as {@link net.sf.mmm.util.pojo.path.api.TypedProperty#getTitle()
   * property title} if you want to have a different label for surename in a different business object e.g.
   * <code>Address</code>. You only need to ensure that the
   * {@link net.sf.mmm.util.pojo.path.api.TypedProperty#getTitle() property title} matches the method name and
   * therefore key in your {@link net.sf.mmm.util.nls.api.NlsBundleWithLookup}. You can also use
   ...
   * <br>
   * <b>NOTE:</b><br>
   * It is recommended to specify the {@link net.sf.mmm.util.pojo.path.api.TypedProperty#getPropertyType()
   * property type} in your {@link net.sf.mmm.util.pojo.path.api.TypedProperty} constant. However, this is
   ...
   * this purpose such as {@link net.sf.mmm.util.pojo.path.api.TypedProperty#TypedProperty(String, String)}. <br>
   *
   ...
   *         {@link net.sf.mmm.util.nls.base.NlsMessageLookupProxy} in your custom implementation of this
   *         method.
   */
