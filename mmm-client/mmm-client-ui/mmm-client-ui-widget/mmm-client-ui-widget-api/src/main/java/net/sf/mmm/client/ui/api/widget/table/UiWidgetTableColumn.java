 ...
 * {@link net.sf.mmm.client.ui.api.widget.model.AbstractUiTableModel#getColumn(int) column} of a
 * {@link UiWidgetListTable} or {@link UiWidgetTreeTable}.<br/>
 * 
...
public interface UiWidgetTableColumn<ROW, CELL> extends UiWidget, HasValueValidators<CELL>, AttributeWriteStringTitle,
  ...
  /**
   * This method sorts the {@link net.sf.mmm.client.ui.api.widget.table.UiWidgetListTable#getValue()
