...
/**
 * This is the interface for a {@link UiWidgetTextualInputField input field widget} that represents a {@link Double}
 * field. Such field allows to enter a value of the type {@link Double}. For advanced usability the widget shall be a so
 ...
 * @since 1.0.0
 */
public interface UiWidgetDoubleField extends UiWidgetTextualInputField<Double>, UiWidgetRangeField<Double>,
    UiWidgetNative {
