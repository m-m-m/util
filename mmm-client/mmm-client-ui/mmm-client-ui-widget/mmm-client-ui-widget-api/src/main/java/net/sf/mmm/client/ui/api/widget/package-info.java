 ...
 * The main entry point is the {@link net.sf.mmm.client.ui.api.widget.UiWidgetFactoryNative} that allows to
 * {@link net.sf.mmm.client.ui.api.widget.UiWidgetFactoryNative#create(Class) create} arbitrary
