...
/**
 * This is the abstract interface for a {@link UiWidgetRegular regular widget} that represents a <em>data table</em>.
 * That is a table showing rows of data with their attributes in columns. It has the following features:
 * <ul>
 ...
 * {@link UiWidgetTableColumn#getTitle() title}, and {@link UiWidgetTableColumn#getTooltip() tooltip} that will be used
 * for the header of the column.</li>
 * <li>Scrolling of the table rows as needed while header (and potential footer) remains steady.</li>
 * <li>{@link UiWidgetTableColumn columns} can be {@link UiWidgetTableColumn#sort(net.sf.mmm.util.lang.api.SortOrder)
 * sorted} using {@link UiWidgetTableColumn#setSortComparator(Comparator) custom comparators} by clicking the column
 * header. Clicking again will swap between ascending and descending order what is also visualized by an arrow icon.</li>
 * <li>{@link UiWidgetTableColumn columns} can be {@link UiWidgetTableColumn#isResizable() resized} by clicking to the
 * right of the column header and moving the right column border horizontally.</li>
 * <li>{@link UiWidgetTableColumn columns} can be {@link UiWidgetTableColumn#isReorderable() reordered} by dragging them
 * around.</li>
 * <li>{@link UiWidgetTableColumn columns} can be {@link UiWidgetTableColumn#isEditable() edited} by double-clicking on
 * cells or programmatically.</li>
 * <li>...</li>
 * </ul>
 * <br/>
 * <b>Note:</b><br/>
