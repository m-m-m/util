 ...
 * field. Such field is like {@link UiWidgetTextAreaField} but allows to enter rich text with markup. It should support
 ...
 * hyperlinks and images should be possible.
 * 
...
public interface UiWidgetRichTextField extends UiWidgetTextualInputField<String>, AttributeWriteKeyboardFilter,
   ...
   * <ul>
   * <li>The value was entered using a {@link UiWidgetRichTextField} (and NOT any other widget) in the same client
   * instance.</li>
   * <li>The value was received from a trusted server on a reliable path (using TLS) and that server strictly validates
   * all markup.</li>
   ...
   * {@link RichTextFeature}s are active. This method allows to reduce the offered features to those explicitly
   * specified to this method. Then only these features are visible in the toolbar of this rich-text field and
   * accessibly via keyboard shortcuts.
   * 
