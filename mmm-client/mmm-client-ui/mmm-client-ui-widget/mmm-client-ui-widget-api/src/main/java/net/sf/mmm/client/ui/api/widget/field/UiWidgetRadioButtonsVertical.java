 ...
 * limited number of {@link #getOptions() options} (less than ten). Otherwise use {@link UiWidgetComboBoxField}
 * instead.<br/>
 ...
 */
public interface UiWidgetRadioButtonsVertical<VALUE> extends UiWidgetOptionsField<VALUE>, UiWidgetNative {
