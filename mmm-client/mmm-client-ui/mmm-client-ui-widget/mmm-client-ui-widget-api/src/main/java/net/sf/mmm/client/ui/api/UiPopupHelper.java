...
public interface UiPopupHelper {
   ...
   */
  void showPopup(String message, MessageSeverity severity, Callback<String> callback);
   ...
   *        the "OK" button). The given {@link String} value will always be {@link #BUTTON_ID_OK}.
   */
  void showPopup(String message, MessageSeverity severity, String title, Callback<String> callback);
   ...
   * {@link #showPopup(String, MessageSeverity, String, Callback, String, String)}. An example for a misuse of
   ...
   */
  void showPopup(String message, MessageSeverity severity, String title, Callback<String> callback, String labelOk,
      String labelCancel);
