 ...
 * {@link net.sf.mmm.util.pojo.descriptor.base.accessor.PojoPropertyAccessorBuilder}. However, we want to be the minimum
 * needed so users can replace reflective approaches with generated code or the like. Please note that there is no
 * reflection available in GWT context and therefore you will have limitations. If your custom needs differ from what is
 * offered out of the box, this is the place where to hook into.
 * 
...
public interface UiDataBindingAdapter<VALUE> {
   ...
   * @param propertyType is the {@link Class} reflecting the {@link TypedProperty#getPropertyType() property type}.
  ...
  /**
   * This method determines the allowed {@link Range} of the value for the specified <code>property</code> in the
   * {@link net.sf.mmm.util.pojo.api.Pojo} associated with this adapter. It will consider JSR 303 annotations such as
   * {@link javax.validation.constraints.Min}, {@link javax.validation.constraints.Max},
  ...
  /**
   * This method gets the {@link TypedProperty#getPropertyType() property type} of the given {@link TypedProperty}. This
   * method might work even if {@link TypedProperty#getPropertyType()} returns <code>null</code>.
   * 
   * @param <T> is the generic {@link TypedProperty#getPropertyType() property type}.
   * 
   * @param property is the {@link TypedProperty}.
