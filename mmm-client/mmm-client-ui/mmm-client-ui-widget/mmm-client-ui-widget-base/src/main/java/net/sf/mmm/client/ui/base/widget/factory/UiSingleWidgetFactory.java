 ...
 * @since 1.0.0
 * @param <WIDGET> the generic type of the {@link UiWidget} that is {@link #create(AbstractUiContext) created}
 *        by this factory.
 */
public interface UiSingleWidgetFactory<WIDGET extends UiWidget> {
   ...
   * this factory.
   * 
   * @param context is the instance of {@link AbstractUiContext}.
