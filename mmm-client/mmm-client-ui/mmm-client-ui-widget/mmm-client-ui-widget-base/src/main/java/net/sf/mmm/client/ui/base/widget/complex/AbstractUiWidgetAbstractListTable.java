 ...
 * @since 1.0.0
 */
public abstract class AbstractUiWidgetAbstractListTable<ADAPTER extends UiWidgetAdapterListTable, ROW> extends
    AbstractUiWidgetActive<ADAPTER, List<ROW>> implements UiWidgetAbstractListTable<ROW> {
   ...
   * 
   * @see AbstractUiWidgetAbstractListTable#sort(AbstractUiWidgetTableColumn)
   */
