 ...
 * @since 1.0.0
 */
public class UiWidgetDoubleFieldTestImpl extends AbstractUiWidgetDoubleField<UiWidgetAdapterTestDoubleField> {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetDoubleField> {
    ...
    public UiWidgetDoubleField create(UiContext context) {
      ...
      return new UiWidgetDoubleFieldTestImpl(context);
    }
