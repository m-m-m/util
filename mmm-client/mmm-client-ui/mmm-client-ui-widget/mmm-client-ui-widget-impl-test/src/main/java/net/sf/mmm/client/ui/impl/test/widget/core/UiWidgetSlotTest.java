 ...
 * @since 1.0.0
 */
public class UiWidgetSlotTest extends AbstractUiWidgetSlot<UiWidgetAdapterTestCompositeRegular> {
   ...
   */
  public UiWidgetSlotTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetSlot> {
    ...
    public UiWidgetSlot create(UiContext context) {
      ...
      return new UiWidgetSlotTest(context);
    }
