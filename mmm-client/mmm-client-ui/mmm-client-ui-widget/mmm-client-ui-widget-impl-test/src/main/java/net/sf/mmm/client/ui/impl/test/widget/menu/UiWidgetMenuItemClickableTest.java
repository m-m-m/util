 ...
 * @since 1.0.0
 */
public class UiWidgetMenuItemClickableTest extends AbstractUiWidgetMenuItemClickable<UiWidgetAdapterTest> {
   ...
   */
  public UiWidgetMenuItemClickableTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetMenuItemClickable> {
    ...
    public UiWidgetMenuItemClickable create(UiContext context) {
      ...
      return new UiWidgetMenuItemClickableTest(context);
    }
