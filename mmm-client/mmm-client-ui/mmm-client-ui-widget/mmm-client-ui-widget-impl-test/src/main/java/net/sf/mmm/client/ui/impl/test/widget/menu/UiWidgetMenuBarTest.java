 ...
 * @since 1.0.0
 */
public class UiWidgetMenuBarTest extends AbstractUiWidgetMenuBar<UiWidgetAdapterTestMenuBar> {
   ...
   */
  public UiWidgetMenuBarTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetMenuBar> {
    ...
    public UiWidgetMenuBar create(UiContext context) {
      ...
      return new UiWidgetMenuBarTest(context);
    }
