 ...
 * @since 1.0.0
 */
public class UiWidgetIntegerFieldTest extends AbstractUiWidgetIntegerField<UiWidgetAdapterTestIntegerField> {
   ...
   */
  public UiWidgetIntegerFieldTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetIntegerField> {
    ...
    public UiWidgetIntegerField create(UiContext context) {
      ...
      return new UiWidgetIntegerFieldTest(context);
    }
