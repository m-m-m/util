 ...
 * @since 1.0.0
 */
public class UiWidgetCollapsableSectionTest extends AbstractUiWidgetCollapsableSection<UiWidgetAdapterTest> {
   ...
   */
  public UiWidgetCollapsableSectionTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetCollapsableSection> {
    ...
    public UiWidgetCollapsableSection create(UiContext context) {
      ...
      return new UiWidgetCollapsableSectionTest(context);
    }
