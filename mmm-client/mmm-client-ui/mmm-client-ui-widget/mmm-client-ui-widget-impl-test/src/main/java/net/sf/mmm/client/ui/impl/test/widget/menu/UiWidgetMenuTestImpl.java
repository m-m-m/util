 ...
 * @since 1.0.0
 */
public class UiWidgetMenuTestImpl extends AbstractUiWidgetMenu<UiWidgetAdapterTestMenu> {
   ...
   */
  public UiWidgetMenuTestImpl(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetMenu> {
    ...
    public UiWidgetMenu create(UiContext context) {
      ...
      return new UiWidgetMenuTestImpl(context);
    }
