 ...
 * @since 1.0.0
 */
public class UiWidgetGridRowTest extends AbstractUiWidgetGridRow<UiWidgetAdapterTestGridRow> {
   ...
   */
  public UiWidgetGridRowTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetGridRow> {
    ...
    public UiWidgetGridRow create(UiContext context) {
      ...
      return new UiWidgetGridRowTest(context);
    }
  }
