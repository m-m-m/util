 ...
 * @since 1.0.0
 */
public class UiWidgetGridCellTest extends AbstractUiWidgetGridCell<UiWidgetAdapterTestCompositeRegular> {
   ...
   */
  public UiWidgetGridCellTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetGridCell> {
    ...
    public UiWidgetGridCell create(UiContext context) {
      ...
      return new UiWidgetGridCellTest(context);
    }
  }
