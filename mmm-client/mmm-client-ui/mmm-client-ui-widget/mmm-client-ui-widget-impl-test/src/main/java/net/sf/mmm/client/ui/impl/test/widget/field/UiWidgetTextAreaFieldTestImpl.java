 ...
 * @since 1.0.0
 */
public class UiWidgetTextAreaFieldTestImpl extends AbstractUiWidgetTextAreaField<UiWidgetAdapterTestStringField> {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetTextAreaField> {
    ...
    public UiWidgetTextAreaField create(UiContext context) {
      ...
      return new UiWidgetTextAreaFieldTestImpl(context);
    }
