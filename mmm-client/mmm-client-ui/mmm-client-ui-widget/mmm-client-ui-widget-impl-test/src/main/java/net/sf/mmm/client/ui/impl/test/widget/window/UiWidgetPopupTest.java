 ...
 * @since 1.0.0
 */
public class UiWidgetPopupTest extends AbstractUiWidgetPopup<UiWidgetAdapterTestCompositeRegular> {
   ...
   */
  public UiWidgetPopupTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetPopup> {
    ...
    public UiWidgetPopup create(UiContext context) {
      ...
      return new UiWidgetPopupTest(context);
    }
  }
