 ...
 * @since 1.0.0
 */
public class UiWidgetRichTextFieldTest extends AbstractUiWidgetRichTextField<UiWidgetAdapterTestStringField> {
   ...
   */
  public UiWidgetRichTextFieldTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetRichTextField> {
    ...
    public UiWidgetRichTextField create(UiContext context) {
      ...
      return new UiWidgetRichTextFieldTest(context);
    }
