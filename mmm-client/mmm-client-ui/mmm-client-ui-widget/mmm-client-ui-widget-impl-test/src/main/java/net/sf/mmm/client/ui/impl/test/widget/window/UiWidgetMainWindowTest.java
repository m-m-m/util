 ...
 * @since 1.0.0
 */
public class UiWidgetMainWindowTest extends AbstractUiWidgetMainWindow<UiWidgetAdapterTestCompositeRegular> {
   ...
   */
  public UiWidgetMainWindowTest(UiContext context) {
