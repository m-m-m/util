 ...
 * @since 1.0.0
 */
public class UiWidgetDateFieldTest extends AbstractUiWidgetDateField<UiWidgetAdapterTestDateField> {
   ...
   */
  public UiWidgetDateFieldTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetDateField> {
    ...
    public UiWidgetDateField create(UiContext context) {
      ...
      return new UiWidgetDateFieldTest(context);
    }
