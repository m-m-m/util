 ...
 * @since 1.0.0
 */
public class UiWidgetPasswordFieldTest extends AbstractUiWidgetPasswordField<UiWidgetAdapterTestStringField> {
   ...
   */
  public UiWidgetPasswordFieldTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetPasswordField> {
    ...
    public UiWidgetPasswordField create(UiContext context) {
      ...
      return new UiWidgetPasswordFieldTest(context);
    }
