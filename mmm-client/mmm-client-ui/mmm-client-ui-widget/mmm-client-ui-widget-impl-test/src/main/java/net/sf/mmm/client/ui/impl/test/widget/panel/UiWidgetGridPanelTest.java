 ...
 * @since 1.0.0
 */
public class UiWidgetGridPanelTest extends AbstractUiWidgetGridPanel<UiWidgetAdapterTestGridPanel> {
   ...
   */
  public UiWidgetGridPanelTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetGridPanel> {
    ...
    public UiWidgetGridPanel create(UiContext context) {
      ...
      return new UiWidgetGridPanelTest(context);
    }
  }
