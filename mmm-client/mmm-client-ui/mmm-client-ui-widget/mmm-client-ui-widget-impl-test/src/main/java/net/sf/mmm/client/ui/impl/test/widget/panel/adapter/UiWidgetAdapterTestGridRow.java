...
/**
 * This is the implementation of {@link UiWidgetAdapterGridRow} for testing without a native toolkit.
 * 
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
public class UiWidgetAdapterTestGridRow extends UiWidgetAdapterTestComposite<UiWidgetGridCell> implements
    UiWidgetAdapterGridRow {

  /**
   * The constructor.
   */
  public UiWidgetAdapterTestGridRow() {
