 ...
 * @since 1.0.0
 */
public class UiWidgetIntegerSliderFieldTest extends
   ...
   */
  public UiWidgetIntegerSliderFieldTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetIntegerSliderField> {
    ...
    public UiWidgetIntegerSliderField create(UiContext context) {
      ...
      return new UiWidgetIntegerSliderFieldTest(context);
    }
