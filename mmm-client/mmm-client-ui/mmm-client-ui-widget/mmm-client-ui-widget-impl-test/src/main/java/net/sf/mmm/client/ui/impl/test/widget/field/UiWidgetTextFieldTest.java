 ...
 * @since 1.0.0
 */
public class UiWidgetTextFieldTest extends AbstractUiWidgetTextField<UiWidgetAdapterTestStringField> {
   ...
   */
  public UiWidgetTextFieldTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetTextField> {
    ...
    public UiWidgetTextField create(UiContext context) {
      ...
      return new UiWidgetTextFieldTest(context);
    }
