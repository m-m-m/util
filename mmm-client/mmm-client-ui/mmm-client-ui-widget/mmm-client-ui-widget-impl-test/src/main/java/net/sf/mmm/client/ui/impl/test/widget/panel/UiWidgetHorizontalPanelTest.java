 ...
 * @since 1.0.0
 */
public class UiWidgetHorizontalPanelTest extends AbstractUiWidgetHorizontalPanel<UiWidgetAdapterTestCompositeRegular> {
   ...
   */
  public UiWidgetHorizontalPanelTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetHorizontalPanel> {
    ...
    public UiWidgetHorizontalPanel create(UiContext context) {
      ...
      return new UiWidgetHorizontalPanelTest(context);
    }
  }
