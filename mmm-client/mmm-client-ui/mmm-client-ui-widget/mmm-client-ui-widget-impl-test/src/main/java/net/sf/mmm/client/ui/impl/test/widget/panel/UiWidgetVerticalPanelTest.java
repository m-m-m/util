 ...
 * @since 1.0.0
 */
public class UiWidgetVerticalPanelTest extends AbstractUiWidgetVerticalPanel<UiWidgetAdapterTestCompositeRegular> {
   ...
   */
  public UiWidgetVerticalPanelTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetVerticalPanel> {
    ...
    public UiWidgetVerticalPanel create(UiContext context) {
      ...
      return new UiWidgetVerticalPanelTest(context);
    }
  }
