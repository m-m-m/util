 ...
 * @since 1.0.0
 */
public class UiWidgetSectionTest extends AbstractUiWidgetSection<UiWidgetAdapterTest> {
   ...
   */
  public UiWidgetSectionTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetSection> {
    ...
    public UiWidgetSection create(UiContext context) {
      ...
      return new UiWidgetSectionTest(context);
    }
