 ...
 * @since 1.0.0
 */
public class UiWidgetLabelTest extends AbstractUiWidgetLabel<UiWidgetAdapterTest> {
   ...
   */
  public UiWidgetLabelTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetLabel> {
    ...
    public UiWidgetLabel create(UiContext context) {
      ...
      return new UiWidgetLabelTest(context);
    }
