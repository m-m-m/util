 ...
 * @since 1.0.0
 */
public class UiWidgetTabPanelTest extends AbstractUiWidgetTabPanel<UiWidgetAdapterTestTabPanel> {
   ...
   */
  public UiWidgetTabPanelTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetTabPanel> {
    ...
    public UiWidgetTabPanel create(UiContext context) {
      ...
      return new UiWidgetTabPanelTest(context);
    }
