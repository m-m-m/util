 ...
 * @since 1.0.0
 */
public class UiWidgetBorderPanelTest extends AbstractUiWidgetBorderPanel<UiWidgetAdapterTestCompositeRegular> {
   ...
   */
  public UiWidgetBorderPanelTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetBorderPanel> {
    ...
    public UiWidgetBorderPanel create(UiContext context) {
      ...
      return new UiWidgetBorderPanelTest(context);
    }
  }
