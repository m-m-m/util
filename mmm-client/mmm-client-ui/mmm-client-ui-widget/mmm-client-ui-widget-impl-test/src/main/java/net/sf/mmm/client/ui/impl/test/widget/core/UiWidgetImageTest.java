 ...
 * @since 1.0.0
 */
public class UiWidgetImageTest extends AbstractUiWidgetImage<UiWidgetAdapterTest> {
   ...
   */
  public UiWidgetImageTest(UiContext context) {
  ...
  public static class Factory extends AbstractUiSingleWidgetFactoryNative<UiWidgetImage> {
    ...
    public UiWidgetImage create(UiContext context) {
      ...
      return new UiWidgetImageTest(context);
    }
