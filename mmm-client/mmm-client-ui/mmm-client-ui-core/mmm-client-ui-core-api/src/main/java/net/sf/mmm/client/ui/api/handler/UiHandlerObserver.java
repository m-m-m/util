 ...
 * 
 * @see net.sf.mmm.client.ui.api.attribute.AttributeWriteHandlerObserver
 * 
...
public interface UiHandlerObserver {
   ...
   *        useful for {@link net.sf.mmm.client.ui.api.attribute.AttributeWriteHandlerObserver objects} that
