...
public abstract interface AttributeReadMaximumValue<VALUE> {
  ...
  /**
   * This method gets the <em>maximum</em>
   ...
   * less or equal to this <code>maximum</code>.
   * 
   * @return the maximum allowed for {@link net.sf.mmm.util.lang.api.attribute.AttributeReadValue#getValue()
   *         value}.
   */
