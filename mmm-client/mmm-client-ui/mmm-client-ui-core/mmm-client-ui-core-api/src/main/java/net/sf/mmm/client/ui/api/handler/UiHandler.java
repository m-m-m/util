 ...
 * from the <em>view</em> (UI). These are typically implemented by the controller or presenter following the
 * <em>MVC</em> or <em>MVP</em> paradigm. Such action operations shall be methods that start with the prefix
