...
/**
 * This is the implementation of {@link FeatureBehavior} for {@link RichTextFeature#UNORDERED_LIST}.
 * 
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
class FeatureBehaviorUnorderedList extends AbstractSimpleClickFeatureBehavior {
   ...
   */
  public FeatureBehaviorUnorderedList(RichTextToolbar richTextToolbar) {
  ...
  public RichTextFeature getFeature() {
    ...
    return RichTextFeature.UNORDERED_LIST;
  }
