 ...
 * to generate implementations of {@link PojoDescriptor} for a particular {@link net.sf.mmm.util.pojo.api.Pojo
 * POJO}.
 *
...
public class PojoDescriptorGenerator extends AbstractPojoDescriptorGenerator {
  ...
  @Override
  protected void generateClassDeclaration(JClassType inputType, TreeLogger logger, ClassSourceFileComposerFactory sourceComposerFactory,
      GeneratorContext context) {
  ...
  @Override
  protected void generateClassContents(JClassType inputType, TreeLogger logger, SourceWriter sourceWriter, String simpleName, GeneratorContext context) {
   ...
   */
  private void generateMethodNewInstance(JClassType inputType, SourceWriter sourceWriter, PojoDescriptor<?> pojoDescriptor) {
   ...
   */
  protected void generateConstructor(SourceWriter sourceWriter, String simpleName, JClassType inputType, PojoDescriptor<?> pojoDescriptor,
      GeneratorContext context) {
  ...
  private static PojoDescriptor<?> getPojoDescriptor(JClassType inputType) {
    ...
    PojoDescriptorBuilder descriptorBuilder = PojoDescriptorBuilderFactoryImpl.getInstance().createPublicMethodDescriptorBuilder();
    Class<?> inputClass;
    try {
  ...
  protected static class StatefulPropertyGenerator {
    ...
    /**
     * This method generates the source-code block to get the {@link PojoDescriptor} for the {@code superType}
     ...
     * @param superPropertyDescriptor is the {@link PojoPropertyDescriptor} of the super-type or {@code null}
     *        if NOT available.
     ...
     */
    protected void generateAccessorStatement(PojoPropertyDescriptor propertyDescriptor, PojoPropertyAccessorMode<?> mode,
