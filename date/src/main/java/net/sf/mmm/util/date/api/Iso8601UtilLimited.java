...
public interface Iso8601UtilLimited {
  ...
  /**
   * This method formats the given {@code date} as a date and time in the format "yyyy-MM-ddTHH:mm:ssZ" (UTC)
   * according to {@link Iso8601UtilLimited ISO 8601}.
   *
  ...
  /**
   * This method formats the given {@code date} as a date and time according to {@link Iso8601UtilLimited ISO
   * 8601}.
   *
   * @param date is the {@link Date} to format.
   * @param extendedDate if {@code false} the basic date format ("yyyyMMdd") is used, if {@code true} the
