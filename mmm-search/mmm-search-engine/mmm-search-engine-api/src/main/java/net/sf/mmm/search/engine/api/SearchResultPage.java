 ...
 * <code>{@link #getPageCount()}*{@link #getHitsPerPage()}+{@link #getPageHitCount()}-1</code>
 * <br>
...
public interface SearchResultPage {
  ...
  /**
   * This method gets the total number of hits for this {@link #getQuery()
   * query}.
   * 
  ...
  /**
   * This method gets the number of {@link #getPageHit(int) hits} per
   * {@link SearchResultPage page}. The {@link #getPageCount() last page} may
   * have less hits than this value.
   * 
   ...
   * {@link SearchResultPage search result}, where <code>0</code> is the first
   * page and <code>{@link #getPageCount()} - 1</code> is the last page.
   * 
   ...
   * is the {@link #getPageIndex() last} {@link #getPageCount() page}. The value
   * will be greater than zero, except for the {@link #getPageIndex() first
   * page} that may have a {@link #getPageHitCount() page hit count} of
   * <code>0</code> if the {@link #getQuery() search query} produced no hits.
   * 
  ...
  /**
   * This method gets the {@link SearchHit hit} of this {@link SearchResultPage
   * page} at the given <code>index</code>.<br>
   * Please note, that the <code>index</code> is relative to this
   * {@link SearchResultPage page}. The absolute index of the {@link SearchHit
   * hit} is
   ...
   * links should be rendered for paging. The <code>pagingRange</code> actually
   ...
   * E.g. assume <code>pagingCount</code> is 2 and you would have a
   * {@link #getPageCount() page-count} of e.g. <code>10</code>. Then you would
   * render links for visiting the pages from <code>0</code> to <code>4</code>
   * if your {@link #getPageIndex() page-index} is <code>0</code>,<code>1</code>
   * , or <code>2</code>. For a {@link #getPageIndex() page-index} of
   * <code>3</code>, you would render the links from <code>1</code> to
   * <code>5</code> and so on.<br>
   * The calculation is performed per call so avoid multiple calls of this
   * method if possible.
   * 
   ...
   * E.g. assume <code>pagingCount</code> is 2 and you would have a
   * {@link #getPageCount() page-count} of e.g. <code>10</code>. Then you would
   * render links for visiting the pages from <code>5</code> to <code>9</code>
   * if your {@link #getPageIndex() page-index} is <code>7</code>,<code>8</code>
   * , or <code>9</code>. For a {@link #getPageIndex() page-index} of
   * <code>6</code>, you would render the links from <code>4</code> to
