...
public interface SearchResult {
  ...
  /**
   * This method gets the total number of hits for this {@link SearchResult search-result}.
   * 
  ...
  /**
   * This method gets the number of {@link SearchResultPage pages} used to split the {@link #getHitCount()
   * total} {@link SearchHit hits} using the {@link SearchResultPage#DEFAULT_HITS_PER_PAGE default} number of
   * hits per page. An empty search result will have one empty page.
   * 
  ...
  /**
   * This method gets number of {@link SearchResultPage pages} used to split the {@link #getHitCount() total}
   * hits using the given <code>hitsPerPage</code>. An empty search result will have one empty page.
   * 
   * @param hitsPerPage is the desired number of {@link SearchResultPage#getHitsPerPage() hits per page}. This
   *        should be a value like 5, 10, 20, 30, ..., 100.
   * @return the number of {@link SearchResultPage pages} required to split the {@link #getHitCount() total}
   *         {@link SearchHit hits}.
   */
  int getPageCount(int hitsPerPage);

  /**
   * This method gets the {@link SearchResultPage page} of this {@link SearchResult search-result} at the
   * given <code>pageIndex</code> using the {@link SearchResultPage#DEFAULT_HITS_PER_PAGE default} number of
   * hits per page.
   * 
  ...
  /**
   * This method gets the {@link SearchResultPage page} of this {@link SearchResult search-result} at the
   * given <code>pageIndex</code> using the given <code>hitsPerPage</code>.
   * 
   * @see SearchEngine#search(SearchQuery, int)
   * 
   * @param pageIndex is the {@link SearchResultPage#getPageIndex() page index} of the requested
   ...
   *        <code>{@link SearchResultPage#getPageCount()}</code>. The recommended strategy is to return the
   *        last page in this case.
   * @param hitsPerPage is the number of {@link SearchHit hits} contained in a {@link SearchResultPage}.
   * @return the requested page.
   */
