 ...
 * {@link SearchQueryBuilder}.<br/>
 * End users should typically use {@link SearchEngine#getQueryBuilder()}
 * instead.
 * 
...
public interface SearchQueryBuilderFactory {
   ...
   *        {@link net.sf.mmm.search.api.config.SearchConfiguration#getFields()
   *        fields} will be used for the query parsing and
   *        {@link net.sf.mmm.search.api.config.SearchConfiguration#getProperties()
