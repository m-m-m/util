...
public interface SearchProperties {
  ...
  /**
   * The key for the auto-refresh {@link #getProperty(String) option}. A value of "true" indicates that the
   * {@link net.sf.mmm.search.engine.api.SearchEngine} should be
   * {@link net.sf.mmm.search.engine.api.ManagedSearchEngine#refresh() refreshed} automatically within a
   * periodically delay.
   */
   ...
   * {@link net.sf.mmm.search.engine.api.SearchEngine}. The properties may be implementation-dependent.
   * Undefined/unsupported properties will simply be ignored.
   * 
   ...
   * @return the value of the property for the given <code>key</code> or <code>null</code> if the property is
   *         undefined.
   */
