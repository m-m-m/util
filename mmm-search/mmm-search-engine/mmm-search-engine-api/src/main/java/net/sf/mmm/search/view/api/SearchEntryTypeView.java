 ...
 * Further only the {@link SearchEntryType}s are represented for which there are actually
...
public interface SearchEntryTypeView extends SearchEntryType {
  ...
  /**
   * The {@link #getId() IDs} of all {@link SearchEntryType}s that have the same {@link #getTitle() title}. A
   * search filtered to this {@link SearchEntryTypeView} will search for
   * {@link net.sf.mmm.search.api.SearchEntry}s that have a
   * {@link net.sf.mmm.search.api.SearchEntry#getType() type} out of this {@link Collection}.
   * 
   ...
   * for this {@link SearchEntryTypeView}.
   * 
   * @return the number of search-entries available for this {@link SearchEntryTypeView}.
   */
  long getEntryCount();
