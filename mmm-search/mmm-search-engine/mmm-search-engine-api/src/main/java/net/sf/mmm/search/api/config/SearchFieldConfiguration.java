...
public interface SearchFieldConfiguration {
   ...
   * {@link net.sf.mmm.search.api.SearchEntry#getField(String) field}. It is
   ...
   * {@link net.sf.mmm.search.api.SearchEntry#getField(String) field} shall be
   * hidden in the view. This means it is NOT displayed in the details of a
