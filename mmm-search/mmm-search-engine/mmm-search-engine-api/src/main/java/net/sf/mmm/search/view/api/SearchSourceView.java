...
/**
 * This interface represents the view on a {@link SearchSource}. It extends
 * {@link SearchSource} with view-specific attributes.
 * 
...
public interface SearchSourceView extends SearchSource {
   ...
   * entry-count} for this {@link SearchSourceView}.
   * 
   * @return the number of search-entries available for this
   *         {@link SearchSourceView}.
   */
  long getEntryCount();
