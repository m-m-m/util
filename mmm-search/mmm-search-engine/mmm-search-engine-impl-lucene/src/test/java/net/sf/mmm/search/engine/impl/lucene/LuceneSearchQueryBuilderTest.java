 ...
 * @since 1.0.0
 */
public class LuceneSearchQueryBuilderTest {
  ...
  protected LuceneSearchQueryBuilder getQueryBuilder() {
    ...
    LuceneSearchQueryBuilder queryBuilder = new LuceneSearchQueryBuilder();
  ...
  public void testCreatePhraseQuery() {
    ...
    SearchQuery query = queryBuilder.createPhraseQuery(SearchEntry.PROPERTY_TEXT, phrase);
    ...
    for (int i = 0; i < termStrings.length; i++) {
      ...
      Assert.assertEquals(SearchEntry.PROPERTY_TEXT, terms[i].field());
    }
  }

  /**
   * Test of {@link SearchQueryBuilder#createTermQuery(String, String)} for
   * wildcard query.
   */
  @Test
  public void testCreateTermQueryWildcardPrefix() {
    ...
    SearchQueryBuilder queryBuilder = getQueryBuilder();
    SearchQuery query = queryBuilder.createTermQuery(SearchEntry.PROPERTY_TEXT, "*foo");
    ...
    Assert.assertEquals(SearchEntry.PROPERTY_TEXT, term.field());
  }
  ...
  public void testCreateTermQueryWildcardMixed() {
    ...
    SearchQueryBuilder queryBuilder = getQueryBuilder();
    SearchQuery query = queryBuilder.createTermQuery(SearchEntry.PROPERTY_TEXT, "bar*foo?quux");
  ...
  /**
   * Test of {@link SearchQueryBuilder#createTermQuery(String, String)} for term
   * query.
   */
  @Test
  ...
  public void testCreateComplexQuery() {
    ...
    SearchQuery subQuery1 = queryBuilder.createTermQuery(SearchEntry.PROPERTY_TEXT, "foo");
    complexQuery.addRequiredQuery(subQuery1);
    Assert.assertEquals(1, complexQuery.getSubQueryCount());
    SearchQuery subQuery2 = queryBuilder.createTermQuery(SearchEntry.PROPERTY_TEXT, "bar");
    complexQuery.addRequiredQuery(subQuery2);
    Assert.assertEquals(2, complexQuery.getSubQueryCount());
    SearchQuery subQuery3 = queryBuilder.createTermQuery(SearchEntry.PROPERTY_TEXT, "some");
    complexQuery.addExcludingQuery(subQuery3);
    Assert.assertEquals(3, complexQuery.getSubQueryCount());
    SearchQuery subQuery4 = queryBuilder.createTermQuery(SearchEntry.PROPERTY_TEXT, "thing");
