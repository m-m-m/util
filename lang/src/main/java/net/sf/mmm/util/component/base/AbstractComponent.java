...
/**
 * This is the abstract base class for a component that needs {@link #initialize() initialization}. We
 * strongly recommend that component implementations should be stateless and therefore thread-safe. It
 * provides an {@link #getInitializationState() initialization state} that helps to prevent accidental coding
 * mistakes. E.g. you can do this:
 *
 * <pre>
