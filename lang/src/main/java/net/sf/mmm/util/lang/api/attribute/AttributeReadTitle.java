 ...
 *        {@link String} but can also be something else (e.g. {@code net.sf.mmm.util.nls.api.NlsMessage}. It
...
public abstract interface AttributeReadTitle<TITLE> {
   ...
   *
   * @return the title or {@code null} if not set. The {@link Object#toString() string-representation} of the
   *         result (if NOT {@code null}) needs to be suitable for end-users.
   */
  TITLE getTitle();
