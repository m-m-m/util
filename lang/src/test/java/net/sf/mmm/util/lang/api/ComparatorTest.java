...
public class ComparatorTest extends Assertions {
  ...
  /**
   * This method checks the {@link CompareOperator#eval(Object, Object)} for the given {@code comparator} and
   * according {@link CompareOperator}s.
   *
   * @param arg1 is the first argument.
   * @param arg2 is the second argument.
   * @param comparator - {@link CompareOperator#EQUAL} if {@code arg1 == arg2},
   *        {@link CompareOperator#LESS_THAN} if {@code arg1 < arg2}, {@link CompareOperator#GREATER_THAN} if
   *        {@code arg1 > arg2} and {@link CompareOperator#NOT_EQUAL} otherwise.
   */
  protected void checkEvalTrue(Object arg1, Object arg2, CompareOperator comparator) {
    ...
    switch (comparator) {
      ...
      case LESS_THAN:
        ...
        break;
      default :
        throw new IllegalStateException(comparator.name());
    }
  }
