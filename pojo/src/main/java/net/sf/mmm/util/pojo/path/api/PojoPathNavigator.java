...
public interface PojoPathNavigator {
  ...
  /**
   * This method evaluates the given {@code pojoPath} for the given {@code pojo} using the given
   * {@code mode} and {@code context}. It returns the result of the evaluation. <br>
   * <b>ATTENTION:</b><br>
   ...
   * @return the result of the navigation of the given {@code pojoPath} starting at the given
   *         {@code pojo}. It may be {@code null} according to the given {@link PojoPathMode mode}.
   ...
   *         {@code null} and should be created but the instantiation failed.
   * @throws PojoPathException if the operation failed for arbitrary reasons.
   * @throws PojoPathConversionException if the result is NOT compatible with the given
   *         {@code targetClass} and could NOT be converted.
   */
  ...
  /**
   * This method determines the result-type for the given {@link PojoPath pojoPath} starting at
   * the given {@code pojoType} using the given {@code context}. <br>
   * In other words if {@link #get(Object, String, PojoPathMode, PojoPathContext) get} is invoked on this
   * navigator with an instance of {@code pojoType} the result will be an instance of the type returned
   * by this method. <br>
   ...
   * @param pojoPath is the {@link PojoPath} to navigate.
   * @param failOnUnsafePath determines how to deal with <em>unsafe</em> {@link PojoPath}s. If
   *        {@code true} and the given {@code pojoPath} is unsafe for the given
   *        {@code pojoType} an {@link PojoPathUnsafeException} is thrown and if {@code false} this
   *        method returns {@code null} in such case.
   * @param context is the {@link PojoPathContext} for this operation.
   * @return the guaranteed result-type of the navigation of the given {@code pojoPath} starting at the
   *         given {@code pojoType}. It may be {@code Object.class} e.g. in case an untyped
   *         {@link java.util.Collection} is hit. It will be {@code null} if the given
   *         {@code pojoPath} is <em>unsafe</em> and the given {@code mode} is
   *         {@link PojoPathMode#RETURN_IF_NULL}.
   * @throws IllegalPojoPathException if the given {@code pojoPath} is illegal.
   * @throws PojoPathUnsafeException if the given {@code pojoPath} is unsafe for the given
   *         {@code pojoType} and this is disallowed by {@code mode}.
   * @throws PojoPathException if the operation failed for arbitrary reasons.
   */
  ...
  /**
   * This method sets the given {@code value} for the given {@code pojoPath} in the given
   * {@code pojo} using the given {@code mode} and {@code context}. It acts like a
   * {@link #get(Object, String, PojoPathMode, PojoPathContext) get} on the {@link PojoPath#getParentPath()
   * parent-path} and then setting the {@code value} for the remaining {@link PojoPath#getSegment()
   ...
   * {@link #get(Object, String, PojoPathMode, PojoPathContext) value} of the given {@code pojoPath} that
   * has been replaced by {@code value}.</li>
   * <li></li>
   * <li></li>
   * <li></li>
   * <li></li>
   ...
   *         {@code null} and should be created but the instantiation failed.
   * @throws PojoPathException if the operation failed for arbitrary reasons.
   * @throws PojoPathConversionException if the given {@code pojo} is NOT compatible with the type
   *         required for the given {@code pojoPath} and could NOT be converted.
   */
