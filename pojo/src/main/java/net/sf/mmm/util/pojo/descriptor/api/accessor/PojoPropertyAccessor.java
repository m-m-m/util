...
public abstract interface PojoPropertyAccessor extends PojoAttributeName {
  ...
  /**
   * This method gets the {@link AccessibleObject accessible object} used to access (read/write) this
   * property.
   * 
   ...
   * {@link #getPropertyType()}. {@link GenericType#getRetrievalClass() getRetrievalClass()} if the
   * {@link #getMode() mode} is for {@link PojoPropertyAccessorMode#isReading() reading} and
   * {@link #getPropertyType()}. {@link GenericType#getAssignmentClass() getAssignmentClass()} otherwise.
   * 
