 ...
 * {@link PojoPropertyAccessorOneArgMode#ADD adding} an element using the getter from another accessor returning an
 * array or {@link java.util.Collection}.
 *
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.1.0
 */
public class PojoPropertyAccessorProxyAdd extends AbstractPojoPropertyAccessorProxyAdapterComponentType
  ...
  public Object invoke(Object pojoInstance, Object argument) {
    ...
    Object arrayCopy = getDependencies().getCollectionReflectionUtil().add(arrayOrCollection, argument);
