 ...
 * unbound wildcard as {@link PojoDescriptor PojoDescriptor<?>}{@code <&>}. In that case you can not call the
 * {@code get} or {@code set} methods.
 *
...
public interface PojoDescriptor<POJO> extends PojoAttributeType<POJO> {
   ...
   * @return the descriptor for the property identified by the given {@code propertyName} or {@code null} if
   *         no such property exists for the according {@link #getPojoClass() pojo}.
   */
   ...
   * {@code propertyName} and for the given access {@code mode}.
   *
   ...
   *        {@code mode} is
   *        {@link net.sf.mmm.util.pojo.descriptor.api.accessor.PojoPropertyAccessorNonArgMode#GET GET} it is
   *        treated as for {@link #getProperty(Object, String)}. If the given {@code mode} is
   ...
   *        modes.
   * @return the requested accessor or {@code null} if NOT found (there is no property named
   *         {@code propertyName}, the property has no accessor for the given {@code mode}, etc.).
   */
  <ACCESSOR extends PojoPropertyAccessor> ACCESSOR getAccessor(String property, PojoPropertyAccessorMode<ACCESSOR> mode);
   ...
   *         {@code propertyName} was found or no accessor exists for that property with the given
   *         {@code mode}.
   */
  <ACCESSOR extends PojoPropertyAccessor> ACCESSOR getAccessor(String property, PojoPropertyAccessorMode<ACCESSOR> mode, boolean required)
   ...
   * {@code property} from the given {@code pojo}. The result depends on the form of the given
   * {@code property} as shown by the following table:<br>
   * <table border="1">
   * <tr>
   * <th>{@code property}</th>
   * <th>accessor</th>
   ...
   * <td><small> {@link net.sf.mmm.util.pojo.descriptor.api.accessor.PojoPropertyAccessorNonArgMode#GET}
   * </small></td>
   * <td>fooBar</td>
   * <td>
   * <ul>
   ...
   * <td><small>
   * {@link net.sf.mmm.util.pojo.descriptor.api.accessor.PojoPropertyAccessorOneArgMode#GET_MAPPED} </small>
   * </td>
   * <td>fooBar['key']</td>
   * <td>
   * <ul>
   ...
   *         Depending on the POJO, the value may be {@code null}.
  ...
  /**
   * This method sets the given {@code value} for the {@link #getPropertyDescriptor(String) property} with the
   * given {@code property} of the given {@code pojo}. The effect depends on the form of the given
   * {@code property} as shown by the following table:<br>
   * <table border="1">
   * <tr>
   * <th>{@code property}</th>
   ...
   * <tr>
   * <td>{@code [a-zA-Z][a-zA-Z0-9]*}</td>
   * <td><small> {@link net.sf.mmm.util.pojo.descriptor.api.accessor.PojoPropertyAccessorOneArgMode#SET}
   * </small></td>
   * <td>fooBar</td>
   * <td>
   * <ul>
   ...
   * <td>{@code [a-zA-Z][a-zA-Z0-9]* "['" [a-zA-Z0-9]+ "']"}</td>
   * <td><small>
   * {@link net.sf.mmm.util.pojo.descriptor.api.accessor.PojoPropertyAccessorTwoArgMode#SET_MAPPED} </small>
   * </td>
   * <td>fooBar['key']</td>
   * <td>
   * <ul>
   ...
   * @return the result of the setter method. Will be {@code null} if the return type is {@code void} what
   *         should be the regular case.
   * @throws PojoPropertyNotFoundException if the property with the given {@code propertyName} was NOT
   *         {@link #getPropertyDescriptor(String) found} or has no such {@link PojoPropertyAccessor accessor}
   *         (setter).
   * @throws ReflectionException if the underlying {@link PojoPropertyAccessor#getAccessibleObject() accessor}
   *         caused an error during reflection.
   */
  Object setProperty(POJO pojo, String property, Object value) throws PojoPropertyNotFoundException, ReflectionException;
   ...
   * @since 3.1.0
   */
  <V> void setProperty(POJO pojo, TypedProperty<V> property, V value) throws PojoPropertyNotFoundException, ReflectionException;

  /**
   * This method gets the
   * {@link net.sf.mmm.util.pojo.descriptor.api.accessor.PojoPropertyAccessorNonArgMode#GET_SIZE size} of the
   * {@link #getPropertyDescriptor(String) property} with the given {@code propertyName} from the given
   * {@code pojo}.
   *
   * @param pojo is the {@link #getPojoClass() POJO} instance where to access the property.
  ...
  /**
   * This method adds the given {@code item} to the list-like {@link #getPropertyDescriptor(String) property}
   * with the given {@code propertyName} from the given {@code pojo} using the
   ...
   * @return the result of the add-method. Will be {@code null} if the return type is {@code void} what should
   *         be the regular case.
   * @throws PojoPropertyNotFoundException if the property with the given {@code propertyName} was NOT
   *         {@link #getPropertyDescriptor(String) found} or has no such {@link PojoPropertyAccessor accessor}
   *         .
   ...
   *         caused an error during reflection.
   */
  Object addPropertyItem(POJO pojo, String propertyName, Object item) throws PojoPropertyNotFoundException, ReflectionException;
   ...
   *
   * {@link #getPropertyDescriptor(String) property} with the given {@code propertyName} from the given
   * {@code pojo} {@link PojoPropertyDescriptor#getAccessor(PojoPropertyAccessorMode) accessor}.
   *
   * @param pojo is the {@link #getPojoClass() POJO} instance where to access the property.
   * @param propertyName is the {@link PojoPropertyDescriptor#getName() name} of the property.
   ...
   *         item was NOT present in the array or {@link Collection}, or {@code null} if the accessor is
   ...
   *         caused an error during reflection.
   */
  Boolean removePropertyItem(POJO pojo, String propertyName, Object item) throws PojoPropertyNotFoundException, ReflectionException;

  /**
   * This method gets the item with the given {@code index} from the list-like
   * {@link #getPropertyDescriptor(String) property} with the given {@code propertyName} of the given
   * {@code pojo} using the
   * {@link net.sf.mmm.util.pojo.descriptor.api.accessor.PojoPropertyAccessorIndexedNonArgMode#GET_INDEXED
   ...
   *         caused an error during reflection.
   */
  Object getPropertyItem(POJO pojo, String propertyName, int index) throws PojoPropertyNotFoundException, ReflectionException;
   ...
   *         caused an error during reflection.
   */
  Object setPropertyItem(POJO pojo, String propertyName, int index, Object item) throws PojoPropertyNotFoundException, ReflectionException;
