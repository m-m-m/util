...
/**
 * This is the interface for a {@link PojoPathFunction} that has a {@link #getName() name}. This allows to register such
 * functions as plugin via {@link javax.inject.Inject}.
 *
...
public interface PojoPathNamedFunction<IN, VALUE> extends PojoPathFunction<IN, VALUE> {
   ...
   * E.g. if the name is "foo", then the function can be invoked via "@foo" as {@link PojoPath#getSegment() segment}.
   *
