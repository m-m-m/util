...
public enum PojoPathMode {
   ...
   * {@link net.sf.mmm.util.pojo.api.Pojo}s if they are {@code null}. This applies to intermediate
   ...
   * {@link java.util.List#add(Object) adding} {@code null}-values. For arrays a compliant setter has to
   ...
   * an intermediate {@link net.sf.mmm.util.pojo.api.Pojo} is {@code null}. However if only the last
   * segment of the {@link PojoPath} evaluates to {@code null}, then {@code null} is returned. If an
