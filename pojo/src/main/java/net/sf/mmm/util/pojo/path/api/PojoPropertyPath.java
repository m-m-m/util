...
public interface PojoPropertyPath {
   ...
   * E.g. if this path represents {@code "foo.bar.property"} then this method would return
   * {@code "foo.bar"}.
   * 
   ...
   * this path represents {@code "foo.bar.property"} then this method would return
   * {@code "property"}.
   * 
