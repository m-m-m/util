...
/**
 * This is the interface for a {@link PojoPropertyAccessor property-accessor} that allows to {@link #invoke(Object)
 * access} a property without any argument.
 *
...
public interface PojoPropertyAccessorNonArg extends PojoPropertyAccessor {
   ...
   *        created for.
   * @return the result of the invocation. It will be {@code null} if void (e.g. initialize method). For a regular
   *         getter this will be the value of the property.
