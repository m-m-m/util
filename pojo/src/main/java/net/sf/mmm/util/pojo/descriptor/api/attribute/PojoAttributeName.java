...
public abstract interface PojoAttributeName {
   ...
   * E.g. for the {@link net.sf.mmm.util.pojo.descriptor.api.accessor.PojoPropertyAccessorNonArgMode#GET read} accessor
   * {@code public String getFooBar()} the property name would be {@code fooBar}.
   *
