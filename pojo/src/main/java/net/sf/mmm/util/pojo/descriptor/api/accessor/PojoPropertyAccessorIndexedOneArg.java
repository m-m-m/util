 ...
 * {@link #invoke(Object, int, Object) apply} an item at a given {@code index} in an indexed property.
 *
...
public interface PojoPropertyAccessorIndexedOneArg extends PojoPropertyAccessor {
   ...
   *        created for.
   * @param index is the position in the indexed property where to apply (e.g. set or insert) the given {@code item}.
