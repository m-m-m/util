...
/**
 * This is the interface used to {@link #getDescriptor(Class) get} (or create) the {@link PojoDescriptor descriptor} for
 * a given {@link net.sf.mmm.util.pojo.api.Pojo}. <br>
 * This functionality is an advanced alternative to {@link java.beans.Introspector} or
...
public interface PojoDescriptorBuilder {
   ...
   * @param <POJO> is the templated type of the {@code pojoType}.
   *
   * @param pojoType is the {@link GenericType} reflecting the {@link net.sf.mmm.util.pojo.api.Pojo} to introspect.
   * @return the descriptor used to get information about the properties of the given {@code pojoType}.
   */
