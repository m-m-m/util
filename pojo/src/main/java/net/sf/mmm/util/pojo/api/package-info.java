...
/**
 * Provides the API for dealing with {@link net.sf.mmm.util.pojo.api.Pojo}s. <a name="documentation"></a>
 * <h2>POJO API</h2> POJO is a shortcut for Plain Old Java Object and more or less means any java object. While the java
 ...
 * according object type. Using this utilities you are NOT limited by such restrictions. <br>
 * Further the generic type-system introduced with Java 5 is quite complex and NOT properly supported by existing
 * bean-utilities (see {@link net.sf.mmm.util.reflect.api.GenericType} for further details). <br>
 * Instead of the {@link java.beans.Introspector} for java-beans or
 * <a href="http://commons.apache.org/beanutils">commons-beanutils</a>, you can use the advanced introspection offered
 * by {@link net.sf.mmm.util.pojo.descriptor.api.PojoDescriptorBuilder}. <br>
 ...
 * XML) using the {@link net.sf.mmm.util.pojo.path.api.PojoPathNavigator}. <br>
