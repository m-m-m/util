...
public interface SearchIndexerDataLocationState {
   ...
   * has been indexed.
   * 
   * @see net.sf.mmm.search.indexer.api.config.SearchIndexerSource#UPDATE_STRATEGY_VCS
   * @see net.sf.mmm.search.indexer.api.config.SearchIndexerDataLocation#getUpdateStrategyVariant()
   * 
