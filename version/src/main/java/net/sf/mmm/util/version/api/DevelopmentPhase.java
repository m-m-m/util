...
public enum DevelopmentPhase implements AttributeReadValue<String> {
   ...
   * the software is typically very unstable, experimental, and the focus is on creating new functionality.
   * <br>
   ...
   *
   * @param phase is the {@link DevelopmentPhase} to compare with.
   * @return {@code true} if this phase is after the given {@code phase}, {@code false} otherwise (also if
   *         {@code phase} is {@code null}).
   */
