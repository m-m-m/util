...
public interface VersionUtil {
   ...
   * @param versionString is the {@link VersionIdentifier#toString() string representation} of a
   *        {@link VersionIdentifier}.
   * @param normalizeFormat - if {@code true} the returned {@link VersionIdentifier} will return a normalized
  ...
  /**
   * Variant of {@link #createFormatter(String, boolean)} with {@code strict} mode.
   *
