...
/**
 * This is the default implementation of the {@link LifecycleManager} interface.
 * 
...
public class DefaultLifecycleManager extends AbstractLifecycleManager {
  ...
  protected void performLifecyclePhaseAsync(
      ExtendedComponentInstanceContainer<?, ?> instanceContainer, String phase, String endState) {
  ...
  protected static class LifecycleRunner implements Runnable {
     ...
     */
    public LifecycleRunner(ExtendedComponentInstanceContainer<?, ?> componentInstanceContainer,
