...
public interface ComponentProvider<S> {
   ...
   * {@link ComponentDescriptor component} provided by this implementation.
   ...
   */
  ComponentInstanceContainer<S> request(String instanceId,
   ...
   */
  boolean release(ComponentInstanceContainer<S> instanceContainer,
   ...
   * {@link IocContainer container} that created the component is stopped
   * but the component is shared and therefore NOT
   * {@link #release(ComponentInstanceContainer, ComponentManager) released}.
   ...
   * @param componentManager
   */
  void dispose(ComponentInstanceContainer<S> instanceContainer,
      ComponentManager componentManager);
