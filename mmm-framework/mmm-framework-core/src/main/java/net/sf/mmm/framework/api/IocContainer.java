 ...
 * {@link ComponentProvider components} following the IoC (inversion of control)
 * principle. The managed components are registered in the container via a
 * {@link net.sf.mmm.framework.api.ComponentProvider provider}.<br>
 * 
...
public interface IocContainer {
   ...
   * {@link MutableIocContainer#start() start} it. The child-container can be
   * {@link MutableIocContainer#stop() stopped} while the parent-container is
   * still in use. If the parent-container is
   * {@link MutableIocContainer#stop() stopped} before, the child-container is
   * {@link MutableIocContainer#stop() stopped}, too.
   * 
   * @param name is the {@link #getName() name} of the child-container to
   *        create.
   ...
   * running after it has been {@link MutableIocContainer#start() started} until
   * it is {@link MutableIocContainer#stop() stopped}.
   * 
