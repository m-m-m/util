/* $Id: DependencyNode.java 197 2006-07-31 21:00:03Z hohwille $ */
...
public class DependencyNode<S> {
    ...
    /**
     * This method gets the dependency-node of the component this one was
     * created for.<br>
     * 
     ...
     * 
     * @param sourceNode
     *        is the {@link #getSource() source} or <code>null</code> if this
     *        is the top-level {@link IocContainerIF container}.
     */
     ...
     * </pre>
     * 
     * @return the target dependency-node or <code>null</code> if this
     ...
     *         <code>componentInstance</code> or <code>null</code> if no
     ...
     * construction or {@link #clear()} this flag is <code>false</code>. It
     * is set to <code>true</code> by {@link #setDisposed()}.
     * 
     * @return the disposed.
     */
