...
public class ComponentInjectionException extends ComponentException {
   ...
   * The constructor.
   * 
   * @param cause is the original cause of the exception.
   * @param dependecyInstance is the dependend component that could NOT be
   *        injected.
   * @param dependency is the dependency descriptor.
   * @param targetComponent is the target component where the dependency could
   *        NOT be injected to.
   */
