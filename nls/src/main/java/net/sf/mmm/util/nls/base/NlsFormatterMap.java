 ...
 * and {@link #getFormatter(String, String) retrieve} {@link NlsFormatter}s. <br>
 * <b>ATTENTION:</b><br>
...
public class NlsFormatterMap extends AbstractComponent {
   ...
   * @param formatStyle is the style defining details of formatting. May be {@code null} for default
   *        formatter.
