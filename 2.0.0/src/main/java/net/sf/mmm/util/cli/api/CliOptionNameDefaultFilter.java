...
/**
 * This is the default {@link Filter} used to decide if the
 * {@link CliOption#name() name} or {@link CliOption#aliases() alias} of a
 * {@link CliOption} is {@link #accept(String) acceptable}.
 * 
...
public class CliOptionNameDefaultFilter implements Filter<String> {
  ...
  /**
   * This method determines if a character the name (excluding the initial
   * hyphens) is acceptable. You may extend this class and override this method
   * to declare a less strict {@link CliStyle#optionNameFilter() naming style}.
   * 
   * @param c is the character to check.
   * @return <code>true</code> if the given character is acceptable,
