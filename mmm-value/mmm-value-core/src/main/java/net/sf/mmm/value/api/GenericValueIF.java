 ...
 */
public interface GenericValueIF {
     ...
     * This means that if is currently {@link #isEmpty() empty} a supplied
     ...
     * @return the requested value or the <code>defaultValue</code> if the
     *         value {@link #isEmpty() is empty}. Will only be
     *         <code>null</code> if this value {@link #isEmpty() is empty} and
     *         the <code>defaultValue</code> is <code>null</code>.
     * @throws WrongValueTypeException
     *         if the value is NOT compatible with the given <code>type</code>
    ...
    /**
     * This method gets a numeric value and also validates that it is in the
     ...
     *        <code>defaultValue</code> must NOT be <code>null</code>.
     * @param setDefault
     *        if <code>false</code> the flag {@link #isAddDefaults()} is ignored.
     * @return an instance of the value as java class or the class given by
     *         <code>defaultValue</code> if this value
     *         {@link #isEmpty() is empty}.
     * @throws WrongValueTypeException
