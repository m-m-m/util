/* $Id: ValueManagerIF.java 191 2006-07-24 21:00:49Z hohwille $ */
...
public interface ValueManagerIF<V> extends XmlSerializerIF<V> {
     ...
     * of the value. ATTENTION: please prefer to use the
     * {@link #XML_ATR_VALUE_NAME} attribute prior to this attribute. Be also
     * aware, that this attribute contains may contain the class of a value
     ...
     * To avoid using implementation class-pathes as reference for a logical
     * value type (e.g. in the content-modell) the value type can be represented
    ...
    /**
     * This method creates an instance of the managed value encoded as string.
     * It is the inverse operation of the values {@link Object#toString()}
     * method.
     * 
     * @param valueAsString
     *        is the string representation of the value in the format as
     *        produced by the <code>toString()</code> method. The given string
     *        representation must represent a value of the type managed by this
     *        value manager.
     * @return the created value.
     * @throws ValueParseException
     *         if the string representation is invalid for this value (e.g.
     *         "abc" is invalid for an integer value while a string value will
     *         accept any string and never throw this exception).
     */
     ...
     *        this implementation. The implementation should only parse the
     *        child nodes of the given element.
     ...
     */
    public void toXml(XmlWriterIF xmlWriter, V value) throws XmlException;
