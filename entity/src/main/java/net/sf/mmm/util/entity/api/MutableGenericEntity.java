...
public interface MutableGenericEntity<ID> extends GenericEntity<ID> {
   ...
   * <b>ATTENTION:</b><br>
   * This operation should only be used in specific cases and if you are aware of what you are doing. Typically the ID
   * is a {@link javax.persistence.GeneratedValue} and therefore managed by the persistence. However, for final freedom
   * we decided to add this method to the API (e.g. to copy from transfer-object to persistent-entity and vice-versa).
   *
