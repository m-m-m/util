 ...
 * <a name="documentation"></a><h2>Transfer-object API</h2>
 ...
 * <li>{@code AddressWithContactInfoTo} with the attributes from both {@code Address} and
 * {@code ContactInfo}.</li>
 * </ul>
 * Due to the lack of multi-inheritance in java, the latter case is a problem. Therefore you would have to
 * duplicate the attributes from {@code Address} or {@code ContactInfo} (or both). <br>
 ...
 * <ul>
 * <li>{@code AddressEto} extending {@link net.sf.mmm.util.transferobject.api.EntityTo} with the attributes from {@code Address}.</li>
 * <li>{@code ContactInfoEto} extending {@link net.sf.mmm.util.transferobject.api.EntityTo} with the attributes from
 * {@code ContactInfo}.</li>
 * <li>{@code AddressWithContactInfoCto} extending {@link net.sf.mmm.util.transferobject.api.CompositeTo} containing {@code AddressEto}
 * and {@code ContactInfoEto}.</li>
 * </ul>
 ...
 * (e.g. {@code AddressEto}) and {@link net.sf.mmm.util.entity.api.PersistenceEntity} (e.g.
 * {@code AddressEntity}) then both implement that interface (e.g. {@code Address}). <br>
 * <b>NOTE:</b><br>
 *
 *
 */
