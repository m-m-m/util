...
public abstract class AbstractEntity<ID> extends AbstractRevisionedEntity<ID> implements PersistenceEntity<ID> {
  ...
  /**
   * <b>ATTENTION:</b><br>
   * If your ID is not {@link GeneratedValue generated}, you need to override this method. In this case you can also
   * override {@link #setId(Object)} to change the visibility to public. <br>
   * <br>
   *
   * {@inheritDoc}
   */
