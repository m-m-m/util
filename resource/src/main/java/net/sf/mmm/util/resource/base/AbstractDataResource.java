...
public abstract class AbstractDataResource implements DataResource {
   ...
   * {@link DataResource}. The scheme-prefix has the following form: {@link java.net.URI#getScheme()
   * &lt;scheme&gt;} {@code :<suffix>} where {@code <suffix>} is the empty string or something like
   * {@code //}.
   *
