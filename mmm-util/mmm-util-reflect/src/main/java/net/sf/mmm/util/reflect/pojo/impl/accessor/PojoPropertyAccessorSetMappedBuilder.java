...
import net.sf.mmm.util.reflect.pojo.api.accessor.PojoPropertyAccessorTwoArg;
import net.sf.mmm.util.reflect.pojo.api.accessor.PojoPropertyAccessorTwoArgBuilder;
