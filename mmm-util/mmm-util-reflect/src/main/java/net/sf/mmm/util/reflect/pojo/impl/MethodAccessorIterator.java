 ...
 * {@link net.sf.mmm.util.reflect.pojo.api.PojoPropertyAccessor property-accessors} for
...
public class MethodAccessorIterator implements Iterator<AbstractPojoPropertyAccessor> {
   ...
   *        {@link net.sf.mmm.util.reflect.pojo.api.PojoPropertyAccessor#getAccessibleObject() accessor-method}.
