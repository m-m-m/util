 ...
 * initial POJO based on a POJO-path (like XPath for XML) using the
 * {@link net.sf.mmm.util.reflect.pojo.path.api.PojoPathNavigator}.<br>
 * A simple way to create new instances of POJOs is offered by the 
 * {@link net.sf.mmm.util.reflect.pojo.factory.api.PojoFactory}.
 */
