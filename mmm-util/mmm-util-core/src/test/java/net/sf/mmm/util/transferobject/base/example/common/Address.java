 ...
 * @since 3.1.0
 */
public interface Address extends MutableRevisionedEntity<Long> {
  ...
  /**
   * This method gets the zip or postal code. This is an identifier of a region, city, or even a district
