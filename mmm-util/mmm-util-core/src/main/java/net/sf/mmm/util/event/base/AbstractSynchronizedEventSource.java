 ...
 * {@link EventListener listeners} during {@link EventListener#handleEvent(Event) event-handling}.
 * 
 ...
 * @since 1.0.1
 */
public abstract class AbstractSynchronizedEventSource<E extends Event, L extends EventListener<E>> extends
