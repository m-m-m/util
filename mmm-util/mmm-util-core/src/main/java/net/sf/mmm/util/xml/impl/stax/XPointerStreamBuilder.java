 ...
 * adapts a given {@link XMLStreamReader} only selecting the contents identified
 * by a given XPointer expression.
 * 
...
public interface XPointerStreamBuilder {
  ...
  /**
   * This method creates a {@link XMLStreamReader} facade that adapts the given
   * <code>xmlReader</code> so only the contents pointed by the given
   * <code>xpointerExpression</code> are visible.
   * 
