...
public interface PojoPathNavigator {
   ...
   * @throws IllegalPojoPathException if the given <code>pojoPath</code> is illegal.
   * @throws PojoPathSegmentIsNullException if an intermediate {@link net.sf.mmm.util.pojo.api.Pojo} was
   *         <code>null</code> and the given <code>mode</code> disallows this.
   * @throws InstantiationFailedException if an intermediate {@link net.sf.mmm.util.pojo.api.Pojo} was
   *         <code>null</code> and should be created but the instantiation failed.
   ...
   *         <code>targetClass</code> and could NOT be converted.
   */
   ...
   *        <code>true</code> and the given <code>pojoPath</code> is unsafe for the given
   *        <code>pojoType</code> an {@link PojoPathUnsafeException} is thrown and if <code>false</code> this
   *        method returns <code>null</code> in such case.
   * @param context is the {@link PojoPathContext} for this operation.
   * @return the guaranteed result-type of the navigation of the given <code>pojoPath</code> starting at the
   *         given <code>pojoType</code>. It may be <code>Object.class</code> e.g. in case an untyped
   *         {@link java.util.Collection} is hit. It will be <code>null</code> if the given
   *         <code>pojoPath</code> is <em>unsafe</em> and the given <code>mode</code> is
   *         {@link PojoPathMode#RETURN_IF_NULL}.
   * @throws IllegalPojoPathException if the given <code>pojoPath</code> is illegal.
   * @throws PojoPathUnsafeException if the given <code>pojoPath</code> is unsafe for the given
   *         <code>pojoType</code> and this is disallowed by <code>mode</code>.
   * @throws PojoPathException if the operation failed for arbitrary reasons.
   */
  ...
  /**
   * This method sets the given <code>value</code> for the given <code>pojoPath</code> in the given
   ...
   * {@link #get(Object, String, PojoPathMode, PojoPathContext) value} of the given <code>pojoPath</code> that
   * has been replaced by <code>value</code>.</li>
   * <li></li>
   * <li></li>
   * <li></li>
   * <li></li>
   * </ul>
   * If <code>pojo</code> is This will typically be the value that replaced value. It may be <code>null</code>
   * .
   * 
   * @param pojo is the initial {@link net.sf.mmm.util.pojo.api.Pojo} to operate on.
   * @param pojoPath is the {@link PojoPath} to navigate.
   ...
   *         <code>null</code> and should be created but the instantiation failed.
   * @throws PojoPathException if the operation failed for arbitrary reasons.
   * @throws PojoPathConversionException if the given <code>pojo</code> is NOT compatible with the type
   *         required for the given <code>pojoPath</code> and could NOT be converted.
   */
