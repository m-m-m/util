 ...
 * framework. It is just use as abstraction layer for frameworks like spring,
 * guice or seam - you will not find a native implementation within this
 * project.
 * 
...
public interface IocContainer {
   ...
   * @throws ResourceMissingException if there is no component registered that
   *         implements the given <code>apiClass</code>.
   * @throws ResourceAmbiguousException if there are multiple components
   *         registered that implement the given <code>apiClass</code>.
   */
  <COMPONENT_API> COMPONENT_API getComponent(Class<COMPONENT_API> apiClass)
      throws ResourceAmbiguousException, ResourceMissingException;
   ...
   *        in this container.
   * @return the requested component.
   * @throws ResourceMissingException if there is no component registered under
   *         the given <code>componentId</code> or the registered component does
   *         NOT realize the given <code>apiClass</code>.
   */
