...
public interface Transformer<V> {
  ...
  /**
   * This method transforms a given <code>original</code> value. This value
   * must NOT be modified by this method. To change the <code>original</code>
   * value a new value has to be created and returned instead. If the value
