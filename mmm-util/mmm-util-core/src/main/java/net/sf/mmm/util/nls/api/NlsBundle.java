 ...
 * only way to work around this is to add an annotation to each parameter. The {@link NlsBundleFactory}
 * therefore supports the {@link javax.inject.Named} annotation for this purpose. As it is nasty to add these
