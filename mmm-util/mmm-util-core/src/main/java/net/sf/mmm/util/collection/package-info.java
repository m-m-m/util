 ...
 * {@link net.sf.mmm.util.collection.CollectionFactory} and 
 * {@link net.sf.mmm.util.collection.MapFactory}) of the various 
 ...
 * {@link net.sf.mmm.util.collection.CollectionFactoryManager} that allows 
 * to create instances of {@link java.util.Collections} and 
 * {@link java.util.Map}s in a generic way.<br>
 * Finally the {@link net.sf.mmm.util.collection.AbstractIterator} makes it 
