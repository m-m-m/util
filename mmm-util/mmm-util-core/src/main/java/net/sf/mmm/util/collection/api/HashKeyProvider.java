...
public interface HashKeyProvider<O> {
   ...
   *         {@link Object#equals(Object) equals} and {@link #hashCode() hashCode} methods of the returned
   *         object have to satisfy this circumstance. If two objects <code>o1</code> and <code>o2</code> are
   *         considered equal then <code>getHashKey(o1).equals(getHashKey(o2))</code> and
