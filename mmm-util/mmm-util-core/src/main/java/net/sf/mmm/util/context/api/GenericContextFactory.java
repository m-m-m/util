...
public interface GenericContextFactory {
  ...
  /**
   * This method creates a new instance of a {@link MutableGenericContext}. It
   * will use a {@link net.sf.mmm.util.collection.base.HashMapFactory} and
   * delegate to {@link #createContext(MapFactory)}.<br>
   * <b>ATTENTION:</b><br>
   * Such context is usually suitable even if
   * {@link GenericContext#createChildContext() child-contexts} are created and
   ...
   * {@link java.util.HashMap#get(Object)} is not academically thread-safe so if
   * you need mission-critical safety, you might want to pass
   * {@link net.sf.mmm.util.collection.base.ConcurrentHashMapFactory} to
