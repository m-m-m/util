 ...
 * resource that comes from the {@link ClassLoader#getResource(String)
 * classpath}. <br>
 ...
 * frameworks.<br>
 * The solution is to use the {@link Thread#getContextClassLoader()
 * context-class-loader} to get resources what is done by this implementation. A
...
public class ClasspathResource extends AbstractDataResource {
   ...
   * E.g. the following code would get a resource named "
   * {@linkplain ClasspathResource}.xml" from the same package where this class
   * is located:
   * 
   * <pre>
