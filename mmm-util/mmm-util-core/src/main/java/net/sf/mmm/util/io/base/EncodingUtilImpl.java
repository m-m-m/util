...
public class EncodingUtilImpl extends AbstractLoggable implements EncodingUtil {
   ...
   * <code>1110xxxx 10xxxxxx 10xxxxxx</code>. This is the lower bound to detect
  ...
  /**
   * An UTF-8 thee-byte-sequence has the form
   * <code>1110xxxx 10xxxxxx 10xxxxxx</code>. This is the upper bound to detect
   * the first char of such sequence.
   */
   ...
   * <code>11110xxx 10xxxxxx 10xxxxxx 10xxxxxx</code>. This is the lower bound
  ...
  /**
   * An UTF-8 four-byte-sequence has the form
   * <code>11110xxx 10xxxxxx 10xxxxxx 10xxxxxx</code>. This is the upper bound
   * to detect the first char of such sequence.<br>
   * <b>ATTENTION:</b><br>
   * The bytes <code>0xF5</code>, <code>0xF6</code>, or <code>0xF7</code> would
   ...
   * <em>surrogate</em>. The first has the form <code>110110xx xxxxxxxx</code>.
  ...
  /**
   * An UTF-16 four-byte-sequence consists of 2 two-byte-sequences called
   * <em>surrogate</em>. The second has the form <code>110111xx xxxxxxxx</code>.
   * This is the lower bound to detect the first char of such sequence.
   */
  ...
  protected static class UtfDetectionProcessor implements ByteProcessor {
    ...
    /**
     * The last {@link Surrogate}s for each of the {@link #bytePosition
     * positions} modulo 4.
     */
     ...
     * account.
     * 
     * @return the low-byte encoding or <code>null</code> if it looks like ASCII
     *         so far.
     */
