 ...
 * of the actual {@link net.sf.mmm.util.pojo.api.Pojo}. If the actual
 * {@link net.sf.mmm.util.pojo.api.Pojo} does NOT have such property,
 ...
 * <ul>
 * <li>If the actual {@link net.sf.mmm.util.pojo.api.Pojo} is an array,
 * the &#171;Index&#187; represents the array-index to access a contained value.</li>
 * <li>If the actual {@link net.sf.mmm.util.pojo.api.Pojo} is a
 ...
 * {@link PojoPathFunction} can make assumptions on the actual
 * {@link net.sf.mmm.util.pojo.api.Pojo} they operate on. If the actual
 * {@link net.sf.mmm.util.pojo.api.Pojo} does NOT follow these
 * assumptions the {@link PojoPath} will be illegal and cause a
 * {@link PojoPathException}.</li>
 * </ul>
 * 
 * <h3>Transitivity</h3>
 * For two {@link PojoPath}-strings <code>path1</code> and <code>path2</code>
 * and for<br>
 * <code>
 * Object pojo;<br>
 ...
 * 
 * <h3>Examples</h3>
 * The following table gives some examples:<br>
 * <table border="1">
 * <tr>
 * <th>Initial Pojo</th>
 * <th>PojoPath</th>
...
public interface PojoPath {
  ...
  /**
   * This method gets the <em>index</em> given by the
   * {@link #getSegment() segment} or <code>null</code> if it is no index.<br>
   * An <em>index</em> is an integer that represents the position of an
   * ordered container (array or {@link java.util.List}).<br>
   ...
   * {@link PojoPathFunction#FUNCTION_NAME_PREFIX} (<code>'&#64;'</code>),
   * it is treated as {@link #getFunction() function}.
   * 
