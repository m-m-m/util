...
public interface PojoPathNamedFunction<IN, VALUE> extends PojoPathFunction<IN, VALUE> {
   ...
   * {@link PojoPathNavigator} implementation.<br/>
   * E.g. if the name is "foo", then the function can be invoked via "@foo" as
   * {@link PojoPath#getSegment() segment}.
   * 
   * @return the name of the function excluding the
