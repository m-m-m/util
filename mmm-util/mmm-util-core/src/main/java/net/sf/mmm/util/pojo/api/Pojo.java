 ...
 * POJO:<br>
 * A <em>POJO</em> is a shortcut for <em>Plain Old Java Object</em> and simply
 ...
 * <ul>
 * <li>You should NOT have two setter-methods with the same name in the same
 * class. If you have <code>setFoo(Foo foo)</code> do NOT add
 * <code>setFoo(String foo)</code>. Simply add
 * <code>setFooAsString(String fooAsString)</code> instead.</li>
 * <li>A {@link Pojo} should have a public non-argument constructor. However
 ...
 * implementation of {@link PojoFactory} in order to create instances of that
 * {@link Pojo} with the utilities offered here.</li>
 * </ul>
 * 
 * <b>ATTENTION:</b><br>
