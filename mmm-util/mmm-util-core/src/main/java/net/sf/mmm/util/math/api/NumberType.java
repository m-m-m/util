...
/**
 * This class represents the {@link Class type} reflecting a specific {@link Number}. It allows to check
 * attributes like {@link #isDecimal()} or to {@link #getExactnessDifference(NumberType) compare}
 * {@link NumberType}s.<br>
...
public interface NumberType<NUMBER extends Number> {
   ...
   * value given by <code>number</code>.
   * 
   ...
   *        {@link NumberConversionException} is thrown, if <code>false</code> this method acts like a
   *        primitive cast and conversion is always successfully.
   * @return a {@link Number} instance of the {@link #getNumberClass() represented number-class} with the
   *         value of the given <code>number</code>. This will be the same instance as <code>number</code> if
   *         it is an {@link Class#isInstance(Object) instance} of the {@link #getNumberClass() represented
   *         number-class} .
   ...
   * E.g. {@link Double}, {@link Float}, or {@link java.math.BigDecimal} represent decimal values while
   * {@link Integer} or {@link Long} are NOT decimal.
   * 
  ...
  /**
   * This method gets the difference of the exactness of this {@link NumberType} and the given
   * <code>otherType</code>.<br>
   * <b>ATTENTION:</b><br>
   * Some types such as {@link Double} and {@link java.math.BigInteger} are NOT really comparable so the
   * exactness difference might only make sense if the compared {@link NumberType types} are both
   ...
   *         <code>otherType</code>, positive if this {@link NumberType} is more exact (later in the examples
