...
public enum PojoPathMode {
   ...
   * {@link net.sf.mmm.util.pojo.api.Pojo}s if they are <code>null</code>. This
   * applies to intermediate {@link net.sf.mmm.util.pojo.api.Pojo}s as well as
   * the final result of the {@link PojoPath}.<br>
   * <ul>
   ...
   * component-type} of the according getter.<br>
   * Therfore {@link java.util.List}s need to be declared using generics. If the
   ...
   * {@link java.util.List}s this is done by {@link java.util.List#add(Object)
   * adding} <code>null</code>-values. For arrays a compliant setter has to be
   * present. Then a {@link System#arraycopy(Object, int, Object, int, int)
   * copy} of the original array will be created with the required size.</li>
   ...
   * happen via the {@link net.sf.mmm.util.pojo.api.PojoFactory} provided by the
   * {@link PojoPathContext}.
   */
  CREATE_IF_NULL,
   ...
   * {@link net.sf.mmm.util.pojo.api.Pojo} is <code>null</code>. However if only
   * the last segment of the {@link PojoPath} evaluates to <code>null</code>,
   * then <code>null</code> is returned. If an &#171;Index&#187; is greater or
   * equal to the
   * {@link net.sf.mmm.util.reflect.api.CollectionReflectionUtil#getSize(Object)
