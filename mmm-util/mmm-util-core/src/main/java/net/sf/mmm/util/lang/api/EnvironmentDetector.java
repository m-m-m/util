...
/**
 * This is the interface for a detector of the environment. It can be used for dynamic decision of behavior
 ...
 * system properties}, etc. The default implementation is using spring profiles so you have to replace it if
 * you choose a different setup.
 *
...
public interface EnvironmentDetector {
  ...
  String CDI_NAME = "net.sf.mmm.util.lang.api.EnvironmentDetector";
  ...
  /**
   * @return the environment type such as {@link #ENVIRONMENT_TYPE_DEVELOPMENT},
   *         {@link #ENVIRONMENT_TYPE_TEST}, {@link #ENVIRONMENT_TYPE_ACCEPTANCE},
   *         {@link #ENVIRONMENT_TYPE_PRODUCTION}, or any other custom kind of environment.
   */
  String getEnvironmentType();

  /**
   * @return the result of
   *         <code>{@link #getEnvironmentType()}.equals({@link #ENVIRONMENT_TYPE_DEVELOPMENT})</code>.
   */
  boolean isDevelopmentEnvironment();

  /**
   * @return the result of
   *         <code>{@link #getEnvironmentType()}.equals({@link #ENVIRONMENT_TYPE_PRODUCTION})</code>.
   */
