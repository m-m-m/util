 ...
 * {@link Collection}s reflectively.
 * 
...
public interface CollectionReflectionUtil {
   ...
   * @return <code>true</code> if the given object is an array or
   *         {@link java.util.List}, <code>false</code> otherwise.
   */
   ...
   * {@link java.lang.reflect.Array#getLength(Object) length} is returned. If it
   * is a {@link java.util.Map} or {@link Collection}, its
   * {@link Collection#size() size} is returned.
   * 
   * @param arrayMapOrCollection the array, {@link java.util.Map} or
   *        {@link Collection}.
   * @return the length or size of <code>arrayMapOrCollection</code>.
   * @throws NlsIllegalArgumentException if the given
   *         <code>arrayMapOrCollection</code> is invalid (<code>null</code> or
   ...
   * @return the item at the given <code>index</code>. May be <code>null</code>
   *         if the item itself is <code>null</code> or the index is greater
   *         than the {@link #getSize(Object) size} or
   *         <code>arrayOrCollection</code>.
   * @throws NlsIllegalArgumentException if the given <code>arrayOrList</code>
   *         is invalid (<code>null</code> or neither array nor
   *         {@link java.util.List}).
   */
   ...
   * @return the item at the given <code>index</code>. May be <code>null</code>
   *         if the item itself is <code>null</code> or the index is greater or
   *         equal to the {@link #getSize(Object) size} of
   *         <code>arrayOrCollection</code>.
   * @throws NlsIllegalArgumentException if the given <code>arrayOrList</code>
   *         is invalid (<code>null</code> or neither array nor
   *         {@link java.util.List}).
   ...
   * <code>index</code> in <code>arrayOrCollection</code>. It uses a default
   * value for <code>maximumGrowth</code> and no <code>arrayReceiver</code> (
   * <code>null</code>).
   * 
   ...
   * @return the item at position <code>index</code> in <code>arrayOrList</code>
   *         that has been replaced by <code>item</code>. This can be
   *         <code>null</code>. Additional if the <code>arrayOrList</code> has
   ...
   * {@link java.util.List} is given that has a {@link java.util.List#size()
   * size} less or equal to the given <code>index</code>, the
   * {@link java.util.List#size() size} of the {@link java.util.List} will be
   * increased to <code>index + 1</code> by {@link java.util.List#add(Object)
   * adding} <code>null</code> values so the <code>item</code> can be set. It
   * uses a default value for <code>maximumGrowth</code>.
   * 
   ...
   *        {@link java.lang.reflect.Array#getLength(Object) length}. It can be
   ...
   * {@link java.util.List#size() size} of the {@link java.util.List} will be
   * increased to <code>index + 1</code> by {@link java.util.List#add(Object)
   * adding} <code>null</code> values so the <code>item</code> can be set.
   * However the number of {@link java.util.List#add(Object) adds} is limited to
   ...
   *        <code>index + 1</code> so the <code>item</code> can be set. Set this
   *        value to <code>0</code> to turn off this feature (and leave the
   *        {@link #getSize(Object) size} untouched). Please always specify a
   *        real maximum (<code>&lt;=65536</code>) and do NOT use
   ...
   *        Otherwise (if <code>null</code>) this method behaves for arrays as
   *        if <code>maximumGrowth</code> was <code>0</code>. If an array should
   *        be increased, a new array with the size of <code>index + 1</code> is
   *        created. The original items are
   ...
   *         with a {@link java.lang.reflect.Array#getLength(Object) length}
   *         increased by <code>1</code> and the elements of
   *         <code>arrayOrCollection</code> appended with the given
   ...
   * @return <code>null</code> if the given <code>item</code> was NOT contained
   *         in <code>arrayOrCollection</code>, the given
   *         <code>arrayOrCollection</code> if it was a {@link Collection} and
   *         the <code>item</code> has been removed. Otherwise, in case of an
   *         array, a new array with a
   *         {@link java.lang.reflect.Array#getLength(Object) length} decreased
   *         by <code>1</code> and the elements of
   *         <code>arrayOrCollection</code> without the first occurrence of the
   *         given <code>item</code> is returned.
   */
