 ...
 * with <em>encodings</em>. An encoding defines a mapping of {@link Character}s
...
public interface EncodingUtil {
  ...
  /**
   * The encoding <code>US-ASCII</code> (American Standard Code for Information
   * Interchange) also just called <code>ASCII</code>.<br>
  ...
  /**
   * The encoding <code>ISO-8859-1</code> also called <code>Latin-1</code>. It
   * is covering most Western European languages.<br>
   * This is a basic encoding for Java contained in <code>lib/rt.jar</code>.
   */
  String ENCODING_ISO_8859_1 = "ISO-8859-1";

  /**
   * The encoding <code>ISO-8859-2</code> also called <code>Latin-2</code>. It
  ...
  /**
   * The encoding <code>ISO-8859-3</code> also called <code>Latin-3</code>. It
   * is covering the South European languages.<br>
  ...
  /**
   * The encoding <code>ISO-8859-4</code> also called <code>Latin-4</code>. It
   * is covering the North European languages.<br>
   * This is a basic encoding for Java contained in <code>lib/rt.jar</code>.
   */
  ...
  /**
   * The encoding <code>ISO-8859-6</code>. It is covering common Arabic language
   * characters.<br>
   * This is an extended encoding for Java contained in
   * <code>lib/charsets.jar</code>.
   */
  ...
  /**
   * The encoding <code>ISO-8859-8</code>. It is covering modern Hebrew (used in
   * Israel).<br>
   * This is an extended encoding for Java contained in
   * <code>lib/charsets.jar</code>.
   */
  ...
  /**
   * The encoding <code>ISO-8859-9</code> also called <code>Latin-5</code>. It
   * is covering Turkish and Kurdish.<br>
   * This is a basic encoding for Java contained in <code>lib/rt.jar</code>.
   */
  String ENCODING_ISO_8859_9 = "ISO-8859-9";

  /**
   * The encoding <code>ISO-8859-10</code> also called <code>Latin-6</code>. It
   * is used for Nordic languages.<br>
   * <b>ATTENTION:</b><br>
   ...
   * <code>x-iso-8859-11</code>. It is covering common Thai language characters.
   */
  ...
  /**
   * The encoding <code>ISO-8859-13</code> also called <code>Latin-7</code>. It
   * is covering Baltic languages.<br>
   * This is a basic encoding for Java contained in <code>lib/rt.jar</code>.
   */
  String ENCODING_ISO_8859_13 = "ISO-8859-13";

  /**
   * The encoding <code>ISO-8859-14</code> also called <code>Latin-8</code>. It
   * is covering Celtic languages.<br>
   * This encoding is NOT supported by Java.
   */
  String ENCODING_ISO_8859_14 = "ISO-8859-14";

  /**
   * The encoding <code>ISO-8859-15</code> also called <code>Latin-9</code>. It
   * is very similar to {@link #ENCODING_ISO_8859_1 Latin-1} but adds the
  ...
  /**
   * The encoding <code>ISO-8859-16</code> also called <code>Latin-10</code>. It
   * is covering South-Eastern European languages and includes the euro-sign.<br>
   * This encoding is NOT supported by Java.
   */
  String ENCODING_ISO_8859_16 = "ISO-8859-16";

  /**
   * The encoding <code>KOI8-R</code>. It is covering Russian and Bulgarian. It
   * is therefore related to {@link #ENCODING_ISO_8859_5} and
  ...
  /**
   * The encoding <code>KOI8-U</code>. It is covering Ukrainian. It is related
   * to {@link #ENCODING_KOI8_R}, {@link #ENCODING_ISO_8859_5} and
   * {@link #ENCODING_WINDOWS_1251}.<br>
   * <b>ATTENTION:</b><br>
   * This encoding is NOT supported by Java.
   */
  ...
  /**
   * The encoding <code>CP437</code> also called <code>DOS-US</code>. It is used
   * by MS-DOS and is based on {@link #ENCODING_US_ASCII} but NOT completely
   * compatible.
   */
  ...
  /**
   * The encoding <code>CP850</code>. It is used by MS-DOS for Western European
   * languages and is therefore related to {@link #ENCODING_ISO_8859_1}.
   */
  String ENCODING_CP_850 = "IBM850";

  /**
   * The encoding <code>CP852</code>. It is used by MS-DOS for Central European
   * languages and is therefore related to {@link #ENCODING_ISO_8859_2}.
   */
  String ENCODING_CP_852 = "IBM852";

  /**
   * The encoding <code>CP855</code>. It is used by MS-DOS for Cyrillic letters
   * and is therefore related to {@link #ENCODING_ISO_8859_5}.
   */
  ...
  /**
   * The encoding <code>CP857</code>. It is used by MS-DOS for Western European
   * languages and is like {@link #ENCODING_CP_850} but replaces one character
  ...
  /**
   * The encoding <code>CP860</code>. It is used by MS-DOS for Portuguese and is
   * therefore related to {@link #ENCODING_ISO_8859_1}.
   */
  String ENCODING_CP_860 = "IBM860";

  /**
   * The encoding <code>CP861</code>. It is used by MS-DOS for Nordic languages
  ...
  /**
   * The encoding <code>CP865</code>. It is used by MS-DOS for Nordic languages
   * except Icelandic for which {@link #ENCODING_CP_861} is used. It is
   * therefore related to {@link #ENCODING_ISO_8859_10}.
   */
  String ENCODING_CP_865 = "IBM865";

  /**
   * The encoding <code>CP866</code>. It is used by MS-DOS for Cyrillic letters
   * and is therefore related to {@link #ENCODING_CP_855} and
  ...
  /**
   * The encoding <code>CP1250</code> also called <code>Windows-1250</code>. It
   * is used by Microsoft Windows for Central European languages and is similar
   * to {@link #ENCODING_ISO_8859_2}.<br>
   * This is a basic encoding for Java contained in <code>lib/rt.jar</code>.
   */
  String ENCODING_WINDOWS_1250 = "windows-1250";

  /**
   * The encoding <code>CP1251</code> also called <code>Windows-1251</code>. It
  ...
  /**
   * The encoding <code>CP1252</code> also called <code>Windows-1252</code>. It
   * is used by Microsoft Windows for Western European languages and is similar
   * to {@link #ENCODING_ISO_8859_1}.<br>
   * This is a basic encoding for Java contained in <code>lib/rt.jar</code>.
   */
  String ENCODING_WINDOWS_1252 = "windows-1252";

  /**
   * The encoding <code>CP1253</code> also called <code>Windows-1253</code>. It
  ...
  /**
   * The encoding <code>CP1254</code> also called <code>Windows-1254</code>. It
  ...
  /**
   * The encoding <code>CP1255</code> also called <code>Windows-1255</code>. It
  ...
  /**
   * The encoding <code>CP1256</code> also called <code>Windows-1256</code>. It
  ...
  /**
   * The encoding <code>CP1257</code> also called <code>Windows-1257</code>. It
  ...
  /**
   * The encoding <code>CP1258</code> also called <code>Windows-1258</code>. It
