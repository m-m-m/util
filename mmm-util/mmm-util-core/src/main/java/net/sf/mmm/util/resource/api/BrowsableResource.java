...
public interface BrowsableResource extends DataResource {
   ...
   * resources} contained in this {@link BrowsableResource}.<br/>
   * If this is no {@link #isFolder() folder}, this method will always return an
   * empty {@link Iterable}.
   * 
  ...
  /**
   * This method iterates the immediate child-{@link BrowsableResource
   * resources} contained in this {@link BrowsableResource} and are
