...
public interface AnnotationUtil {
  ...
  /**
   * This method determines if the given <code>annotationType</code> represents
   * an {@link Annotation} that has the {@link java.lang.annotation.Retention}
   * {@link java.lang.annotation.RetentionPolicy#RUNTIME runtime} and can
   ...
   * @return <code>true</code> if the given <code>annotationType</code> can be
   *         resolved at runtime.
   */
  ...
  /**
   * This method determines if the given <code>annotationType</code> represents
   * an {@link Annotation} that has a {@link java.lang.annotation.Target}
   * compatible with the given <code>targetType</code>.<br>
   * 
   * @param <A> is the type of the annotation to check.
   * @param annotationType is the type of the annotation to check.
   * @param targetType is the expected target-type to check.
   * @return <code>true</code> if the given <code>annotationType</code> can be
   *         used to annotate elements of the given <code>targetType</code>.
   */
