...
/**
 ...
 maintain.<br>
 The {@link CharacterStreamScanner} is an interface that covers typical tasks
 when paring strings or streams and therefore makes your life a lot easier.
 You can concentrate on the syntax you want to parse and do NOT need to repeat
 checks if the end is already reached all the time. For parsing strings there is
 the implementation {@link CharacterSequenceScanner} that bundles the 
