...
public interface BasicUtil {
   ...
   * to {@link Object#equals(Object)} the objects may be <code>null</code>.
   * 
   ...
   * @return <code>true</code> if both objects are <code>null</code> or the first is NOT <code>null</code> and
   *         <code>o1.equals(o2)</code>, <code>false</code> otherwise.
   */
   ...
   * checks that both arrays have the same <code>length</code> and if so that the objects contained in the
   * arrays are {@link #isEqual(Object, Object) equal}. Additionally the given arrays may be <code>null</code>
   * .
   * 
   ...
   * @return <code>true</code> if both arrays are <code>null</code> or the first is NOT <code>null</code> and
   *         both arrays have the same <code>length</code> and {@link #isEqual(Object, Object) equal} content,
  ...
  /**
   * This method checks if two given objects are {@link Object#equals(Object) equal} to each other. In advance
   * to {@link Object#equals(Object)} the objects may be <code>null</code> and arrays are
   ...
   * <code>checkEqual</code>) to the given <code>value</code>.
   * 
   * @param value is the value to check. It may be <code>null</code>.
   * @param array is the array to check.
   * @param checkEqual - if <code>true</code> the <code>value</code> only needs to be
   *        {@link #isEqual(Object, Object) equal} to an element, if <code>false</code> it needs to be the
   *        same (<code>==</code>).
   * @return the according index or <code>-1</code> if <code>value</code> is NOT contained in
   *         <code>array</code>.
   */
  ...
  /**
   * This method determines if the given <code>array</code> contains an element that equals (see
   * <code>checkEqual</code>) to the given <code>value</code>.
   * 
   ...
   *        {@link #isEqual(Object, Object) equal} to an element, if <code>false</code> it needs to be the
   *        same (<code>==</code>).
   * @return <code>true</code> if the <code>array</code> contains <code>value</code>.
   */
   ...
   * @return <code>true</code> if both {@link CharIterator}s produced the same {@link CharIterator#next()
   *         next} chars until both ended at the same time, <code>false</code> otherwise.
   */
