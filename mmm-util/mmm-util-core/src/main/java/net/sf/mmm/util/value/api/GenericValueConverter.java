...
public interface GenericValueConverter<SOURCE> {
  ...
  /**
   * This method converts the given <code>value</code> to the given
   * <code>type</code>.
   * 
   ...
   * @param targetClass is the type the <code>value</code> should be converted
   *        to.
   ...
   */
  <TARGET extends Number> TARGET convertValue(SOURCE value, Object valueSource, TARGET minimum,
      TARGET maximum) throws ValueNotSetException, WrongValueTypeException,
