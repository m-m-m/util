...
public abstract class AbstractConverterToArray<ARRAY> extends
    AbstractValueConverterToContainer<ARRAY> {
  ...
  @Override
  protected void convertContainerEntry(Object element, int index, ARRAY container,
      Object valueSource, GenericType<? extends ARRAY> targetType, Object value) {
