 ...
 * @param <NODE> is the generic type of the {@link DoubleLinkedNode node} itself.
 * 
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 2.0.0
 */
public interface DoubleLinkedNode<V, NODE extends DoubleLinkedNode<V, NODE>> extends LinkedNode<V, NODE> {
