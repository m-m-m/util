...
public interface FileUtil {
  ...
  /**
   * This method gets the {@link File} representing the {@link #PROPERTY_USER_HOME home directory of the user}
   * .
   * 
  ...
  /**
   * This method copies the file given by <code>source</code> to the file given by <code>destination</code>.
   * 
   ...
   * @param destination is the file to copy to. It will be created if it does NOT exist and overridden
   *        otherwise.
   * @param keepFlags - <code>true</code> if the flags of the file should be copied as well,
   *        <code>false</code> otherwise (a new file is created with default flags and only the content is
   *        copied).
   * @throws RuntimeIoException if the operation fails.
   */
   ...
   *        the returned permissions. It may be <code>null</code> to apply the permissions to all distinct
   *        classes.
   ...
   * @param allowOverwrite - if <code>false</code> and the <code>destination</code> already exists, a
   *        {@link RuntimeIoException} is thrown, else if <code>true</code> the <code>destination</code> will
   *        be overwritten.
   * @throws RuntimeIoException if the operation fails.
   */
  ...
  /**
   * This method {@link File#delete() deletes} the given <code>path</code>. If the <code>path</code> denotes a
   ...
   * <code>directory</code> recursively. If the given <code>directory</code> denotes an {@link File#exists()
   ...
   *        <code>cwd</code>.
   * @param fileType is the type of the requested files or <code>null</code> if files of any type are
   *        acceptable.
   * @return an array containing all the {@link File files} that match the given <code>path</code> and apply
   *         to <code>ignore</code>
   */
  File[] getMatchingFiles(File cwd, String path, FileType fileType);

  /**
   * This method adds all files matching the given <code>path</code> and <code>fileType</code> to the
   ...
   * @return <code>false</code> if the path is a regular string and <code>true</code> if the given path
