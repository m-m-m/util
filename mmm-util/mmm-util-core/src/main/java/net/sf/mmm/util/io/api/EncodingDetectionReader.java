...
/**
 * This class represents a {@link Reader} that automatically detects an encoding while reading the data.
 * Beside being a regular {@link Reader} this class acts as API that additionally allows to
 * {@link #getEncoding() get} the detected encoding in case you need this information (e.g. to save it as
 * meta-data).
 * 
