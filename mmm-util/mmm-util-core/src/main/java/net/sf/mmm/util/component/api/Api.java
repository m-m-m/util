 ...
 * to access a {@link ComponentSpecification component}. The main idea is to abstract from the implementation
 * of the component so it gets replaceable and the design is maintainable.<br/>
 ...
 * <em>API</em> of a {@link ComponentSpecification component} is therefore the combination of all these types.
 * It has to be <em>self-contained</em> what means that it only contains references to types legally
 * considered as part of the <em>API</em>. With references we are NOT talking about JavaDoc-links.<br/>
