...
@CliClass
@CliModes(//
{ @CliMode(id = CliMode.ID_HELP, title = NlsBundleUtilCoreRoot.INF_MAIN_MODE_HELP, //
usage = NlsBundleUtilCoreRoot.MSG_MAIN_MODE_HELP_USAGE) })
public abstract class AbstractMain extends AbstractLoggableObject {
  ...
  required = true, usage = NlsBundleUtilCoreRoot.MSG_MAIN_OPTION_HELP_USAGE, mode = CliMode.ID_HELP)
