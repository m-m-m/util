 ...
 * identify which code belongs to a particular usecase. Therefore you should define a class or interface with
 * string constants for the names of your usecases. The javadoc of these constants shall provide further
 * documentation of the usecase like the detailed description or links to further documentation.
 * 
