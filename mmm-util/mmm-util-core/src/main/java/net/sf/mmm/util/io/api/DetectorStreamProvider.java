...
/**
 * This is the interface of a service that provides {@link DetectorStream
 * detector-streams}. <br>
...
public interface DetectorStreamProvider {
   ...
   * the data such that the given values correspond to the data.<br>
   ...
   * also available in the detected {@link DetectorStream#getMetadata()
   * metadata}.
   * 
   * @param stream is the stream to wrap. This stream must be a fresh stream
   *        that is untouched since it was opened.
