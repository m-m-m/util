...
public interface CharIterator {
  ...
  /**
   * This is a character that is illegal according to the unicode specification. It is used to indicate that
   * this iterator has reached its end.
   */
  char END_OF_ITERATOR = 0xfeff;

  /**
   * This method determines whether there is a {@link #next() next} char available or the end of this iterator
   * has been reached.
   * 
   * @see #next()
  ...
  /**
   * This method returns the next character to iterate or {@link #END_OF_ITERATOR} if the end of this iterator
   * has been reached. If {@link #END_OF_ITERATOR} is returned further calls will always return
