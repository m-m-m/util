...
public abstract interface PojoPropertyAccessor extends PojoAttributeName {
   ...
   * {@link #getPropertyType()}. {@link GenericType#getRetrievalClass() getUpperBound()} if the
   * {@link #getMode() mode} is for {@link PojoPropertyAccessorMode#isReading() reading} and
   * {@link #getPropertyType()}. {@link GenericType#getAssignmentClass() getLowerBound()} otherwise.
   * 
