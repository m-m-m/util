...
public interface DetectorInputStream extends DetectorStream {
   ...
   * the {@link #getMetadata() metadata} can be retrieved. This method is a
   * simple getter - it will always return the same stream object.<br>
   ...
   * detection is {@link #isDone() done}) in order to get the complete
