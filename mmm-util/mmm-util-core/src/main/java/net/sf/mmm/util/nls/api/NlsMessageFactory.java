...
public interface NlsMessageFactory {
   ...
   * @param argument2 is the {@link NlsMessage#getArgument(String) value} of the second argument.
   * @return the new {@link NlsMessage} instance.
   */
   ...
   * @param key2 is the {@link NlsMessage#getArgument(String) key} of the second argument.
   * @param argument2 is the {@link NlsMessage#getArgument(String) value} of the second argument.
   * @param key3 is the {@link NlsMessage#getArgument(String) key} of the third argument.
   ...
   * @param key3 is the {@link NlsMessage#getArgument(String) key} of the third argument.
   * @param argument3 is the {@link NlsMessage#getArgument(String) value} of the third argument.
   * @param key4 is the {@link NlsMessage#getArgument(String) key} of the fourth argument.
   * @param argument4 is the {@link NlsMessage#getArgument(String) value} of the fourth argument.
   * @return the new {@link NlsMessage} instance.
   * @since 1.1.1
   */
