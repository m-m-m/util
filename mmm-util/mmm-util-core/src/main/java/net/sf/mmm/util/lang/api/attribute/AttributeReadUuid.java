...
public abstract interface AttributeReadUuid {
   ...
   * the existing {@link UUID} will be used (e.g. for chained {@link net.sf.mmm.util.nls.api.NlsThrowable
   * exceptions}).<br>
   * The {@link UUID} will appear in a
   * {@link net.sf.mmm.util.nls.api.NlsThrowable#printStackTrace(java.util.Locale, net.sf.mmm.util.nls.api.NlsTemplateResolver, Appendable)
   * stacktrace} but NOT in the {@link net.sf.mmm.util.nls.api.NlsThrowable#getMessage() message}. It will
   * therefore be written to log-files if the {@link net.sf.mmm.util.nls.api.NlsThrowable} is logged. If you
   * supply the {@link UUID} to the end-user in an error panel or popup (see
