/* $Id: Filetype.java 304 2007-06-13 23:58:29Z hohwille $
...
/**
 * A {@link ContentType} represents the type of some content (typically a file
 * or BLOB). A {@link ContentType} is similar to a mimetype but more
...
public interface ContentType extends TreeNode<ContentType> {
   ...
   * displaying the {@link ContentType} (to the end-user) you should use the
   * {@link #getTitle() title} instead. However the {@link #getTitle() title} of
   * a {@link ContentType} may change over the time while the {@link #getId()
   * ID} will NOT. Therefore you may use this method for internal decisions.
   * 
  ...
  /**
   * This method gets the display name of this {@link ContentType} (e.g.
  ...
  /**
   * This method gets the list of all extensions associated with this
   * {@link ContentType} including the {@link #getDefaultExtension() default
   * extension} (e.g. contains ".jpg" and ".jpeg").
   * 
  ...
  /**
   * This method gets the mimetype of this {@link ContentType} (e.g.
   * "image/png").
   * 
