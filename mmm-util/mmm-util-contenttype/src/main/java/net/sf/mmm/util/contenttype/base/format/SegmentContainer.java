...
/**
 * A {@link SegmentContainer} is like a list of {@link Segment}s. As it is also
 * a {@link Segment} itself a {@link SegmentContainer} can contain other
 * {@link SegmentContainer}s. This class is abstract - see the available
...
public abstract class SegmentContainer extends Segment {
   ...
   * 
   * @param index is the index of the requested child {@link Segment}. See
   *        {@link #getSegmentCount()}.
  ...
  /**
   * This method determines the number of {@link #getSegment(int) contained
   * child segments}.
   * 
