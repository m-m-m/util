...
public class TextTableInfo {
  ...
  public void setLineSeparator(String newline) {
    ...
    if (!StringUtil.LINE_SEPARATOR_CRLF.equals(newline) && !StringUtil.LINE_SEPARATOR_LF.equals(newline)
        && !StringUtil.LINE_SEPARATOR_LFCR.equals(newline) && !StringUtil.LINE_SEPARATOR_CR.equals(newline)) {
