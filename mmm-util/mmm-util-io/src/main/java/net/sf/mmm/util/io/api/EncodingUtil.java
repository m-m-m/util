...
public interface EncodingUtil {
  ...
  /**
   * The encoding <code>ISO-8859-11</code>. The {@link java.nio.charset.Charset#name() canonical name} however
   * is <code>x-iso-8859-11</code>. It is covering common Thai language characters.
   */
  String ENCODING_ISO_8859_11 = "x-iso-8859-11";

  /**
   * The encoding <code>ISO-8859-12</code>. The work on this encoding for Devanagari was stopped so it does
   * NOT exist at all.
   */
  @Deprecated
  ...
  /**
   * The encoding <code>CP437</code> also called <code>DOS-US</code>. It is used by MS-DOS and is based on
   * {@link #ENCODING_US_ASCII} but NOT completely compatible.
   */
  String ENCODING_CP_437 = "IBM437";

  /**
   * The encoding <code>CP737</code>. It is used by MS-DOS for Greek and is therefore related to
   * {@link #ENCODING_CP_869} and {@link #ENCODING_ISO_8859_7}.
   */
  String ENCODING_CP_737 = "x-IBM737";

  /**
   * The encoding <code>CP850</code>. It is used by MS-DOS for Western European languages and is therefore
   * related to {@link #ENCODING_ISO_8859_1}.
   */
  String ENCODING_CP_850 = "IBM850";

  /**
   * The encoding <code>CP852</code>. It is used by MS-DOS for Central European languages and is therefore
   * related to {@link #ENCODING_ISO_8859_2}.
   */
  String ENCODING_CP_852 = "IBM852";

  /**
   * The encoding <code>CP855</code>. It is used by MS-DOS for Cyrillic letters and is therefore related to
   * {@link #ENCODING_ISO_8859_5}.
   */
  String ENCODING_CP_855 = "IBM855";

  /**
   * The encoding <code>CP857</code>. It is used by MS-DOS for Turkish and is therefore related to
   * {@link #ENCODING_ISO_8859_9}.
   */
  String ENCODING_CP_857 = "IBM857";

  /**
   * The encoding <code>CP857</code>. It is used by MS-DOS for Western European languages and is like
  ...
  /**
   * The encoding <code>CP860</code>. It is used by MS-DOS for Portuguese and is therefore related to
   * {@link #ENCODING_ISO_8859_1}.
   */
  String ENCODING_CP_860 = "IBM860";

  /**
   * The encoding <code>CP861</code>. It is used by MS-DOS for Nordic languages especially for Icelandic and
   * is therefore related to {@link #ENCODING_ISO_8859_10}.
   */
  String ENCODING_CP_861 = "IBM861";

  /**
   * The encoding <code>CP863</code>. It is used by MS-DOS for French and is therefore related to
   * {@link #ENCODING_ISO_8859_15}.
   */
  String ENCODING_CP_863 = "IBM863";

  /**
   * The encoding <code>CP865</code>. It is used by MS-DOS for Nordic languages except Icelandic for which
   * {@link #ENCODING_CP_861} is used. It is therefore related to {@link #ENCODING_ISO_8859_10}.
   */
  String ENCODING_CP_865 = "IBM865";

  /**
   * The encoding <code>CP866</code>. It is used by MS-DOS for Cyrillic letters and is therefore related to
   * {@link #ENCODING_CP_855} and {@link #ENCODING_ISO_8859_5}.
   */
  String ENCODING_CP_866 = "IBM866";

  /**
   * The encoding <code>CP869</code>. It is used by MS-DOS for Greek and is therefore related to
  ...
  /**
   * The encoding <code>CP1255</code> also called <code>Windows-1255</code>. It is used by Microsoft Windows
   * for Hebrew and is similar to {@link #ENCODING_ISO_8859_8}.
   */
  String ENCODING_WINDOWS_1255 = "windows-1255";

  /**
   * The encoding <code>CP1256</code> also called <code>Windows-1256</code>. It is used by Microsoft Windows
  ...
  /**
   * The encoding <code>CP1258</code> also called <code>Windows-1258</code>. It is used by Microsoft Windows
   ...
   * to the given <code>nonUtfEncoding</code>.
   * 
   ...
   * @return a new {@link EncodingDetectionReader} that can be used to read the <code>inputStream</code>.
   */
