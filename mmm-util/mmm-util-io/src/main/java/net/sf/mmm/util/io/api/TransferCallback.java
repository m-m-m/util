 ...
 * 
 * @see net.sf.mmm.util.io.base.StreamUtilImpl#transferAsync(java.io.InputStream, java.io.OutputStream,
 *      boolean, TransferCallback)
 * 
...
public interface TransferCallback {
   ...
   * 
   * @param bytesTransferred is the number of bytes that have been transferred until the task has been
   *        stopped.
   */
