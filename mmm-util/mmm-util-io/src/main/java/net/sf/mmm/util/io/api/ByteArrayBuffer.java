...
/**
 * This is the interface for a byte[] buffer. It is similar to {@link java.nio.ByteBuffer} but a lot simpler.
 * However it allows to {@link #setCurrentIndex(int) set the current index} so the internal
 * {@link #getBytes() buffer}-array can be consumed externally and proceeded very fast.<br>
 * 
