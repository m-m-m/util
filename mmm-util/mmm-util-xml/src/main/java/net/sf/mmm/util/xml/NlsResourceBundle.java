...
public class NlsResourceBundle extends AbstractResourceBundle {
   ...
   * before.
   * 
   * @see net.sf.mmm.util.xml.api.XmlWriterIF#writeStartElement(String, String)
   * @see net.sf.mmm.util.xml.api.XmlWriterIF#writeAttribute(String, String)
   */
   ...
   * already closed.
   * 
   * @see net.sf.mmm.util.xml.api.XmlWriterIF#writeEndElement(String, String)
   */
   ...
   * 
   * @see net.sf.mmm.util.xml.api.XmlWriterIF
   */
