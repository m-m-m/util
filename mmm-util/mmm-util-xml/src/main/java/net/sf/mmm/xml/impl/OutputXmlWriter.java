...
public class OutputXmlWriter extends AbstractXmlWriter {
  ...
  /**
   * The constructor. It will write an XML header containing the given encoding.
   * 
   * @param writer
   ...
   *        is the encoding written to the xml header.
   * @param xmlVersion
   *        is the explicit xml version written to the xml header. Legal values
   *        are "1.0" or "1.1".
   * @param standalone
   ...
   *        output). Typical indentations are " ", " ", " ", or "\t".
   * @param encoding
   *        is the charsetname used to encode special charaters. It will also be
   *        written to the encoding attribute of the xml header.
   * @param xmlVersion
   *        is the explicit xml version written to the xml header. Legal values
   *        are "1.0" or "1.1".
   * @param standalone
   ...
   *        <code>null</code> is allowed and will cause the encoding attribute
   *        be omitted in the header.
   * @param standalone
   *        is the flag telling if the xml comes standalone or depends on TODO.
   *        A value of <code>null</code> is allowed and will cause the
