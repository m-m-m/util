 ...
 * <b>ATTENTION:</b><br/>
 * The Java 1.8+ version of this interface also defines default methods that can NOT be supported in prior java
 * versions. Therefore, <code>mmm-util-core</code> offers helper methods that give similar features. However, we
 * strongly recommend that you update your project to Java 1.8+ to make use of closures (lambda expressions) and other
 * benefits.
 * 
