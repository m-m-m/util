 ...
 * 
 * @param <T> is the generic type of the argument to {@link #test(Object) test}.
 * 
...
public interface Predicate<T> {
  ...
  /**
   * Returns <code>true</code> if the input object matches some criteria.
   * 
   * @param value is the input object to test.
   * @return <code>true</code> if the input object matches some criteria, <code>false</code> otherwise.
   */
