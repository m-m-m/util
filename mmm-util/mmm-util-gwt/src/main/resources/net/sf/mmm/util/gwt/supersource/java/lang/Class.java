...
/**
 * Generally unsupported. This class is provided so that the GWT compiler can choke down class literal
 * references.
 * 
...
public final class Class<T> implements Type {
   ...
   * @skip
   */
  static <T> Class<T> createForArray(String packageName, String className, String seedName, Class<?> componentType) {
   ...
   * @skip
   */
  static <T> Class<T> createForClass(String packageName, String className, String seedName, Class<? super T> superclass) {
   ...
   * @skip
   */
  static <T> Class<T> createForEnum(String packageName, String className, String seedName, Class<? super T> superclass,
   ...
   * @skip
   */
  static Class<?> createForPrimitive(String packageName, String className, String seedName) {
  ...
  static void setName(Class<?> clazz, String packageName, String className, String seedName) {

    if (clazz.isClassMetadataEnabled()) {
      clazz.typeName = packageName + className;
    } else {
      /*
       * The initial "" + in the below code is to prevent clazz.hashCode() from being autoboxed. The class
       * literal creation code is run very early during application start up, before class Integer has been
       * initialized.
       */
      clazz.typeName = "Class$" + (seedName != null ? seedName : "" + clazz.hashCode());
    }
  }
