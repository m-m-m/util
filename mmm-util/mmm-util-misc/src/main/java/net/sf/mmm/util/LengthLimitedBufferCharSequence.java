...
public class LengthLimitedBufferCharSequence extends AbstractCharSequence {
   ...
   * E.g. if the maximum length is set to <code>3</code> and the characters of
   * the alphabet (a,b,c,...) are sequentially appended to this sequence its
   * String representation will be "", "a", "ab", "abc", "bcd", "cde", "def",
   * ...
   * 
