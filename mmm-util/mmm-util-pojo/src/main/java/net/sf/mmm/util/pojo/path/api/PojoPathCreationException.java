 ...
 * {@link net.sf.mmm.util.pojo.api.Pojo} was <code>null</code> but
...
public class PojoPathCreationException extends PojoPathException {
   ...
   *        {@link net.sf.mmm.util.pojo.api.Pojo} supplied to the
   *        {@link PojoPathNavigator}.
   */
  public PojoPathCreationException(Object initialPojo, String pojoPath) {

    super(NlsBundlePojo.ERR_PATH_CREATION, initialPojo, pojoPath);
  }
