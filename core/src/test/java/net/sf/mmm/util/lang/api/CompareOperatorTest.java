...
public class CompareOperatorTest extends Assertions {
  ...
  public void testEqual() {
    ...
    assertThat(op.toNlsMessage().getLocalizedMessage(Locale.US)).isEqualTo("equal to");
    assertThat(op.toNlsMessage().getLocalizedMessage(Locale.GERMAN)).isEqualTo("gleich");
  ...
  public void testNotEqual() {
    ...
    assertThat(op.toNlsMessage().getLocalizedMessage(Locale.US)).isEqualTo("not equal to");
    assertThat(op.toNlsMessage().getLocalizedMessage(Locale.GERMAN)).isEqualTo("ungleich");
  ...
  public void testGreaterThan() {
    ...
    assertThat(op.toNlsMessage().getLocalizedMessage(Locale.US)).isEqualTo("greater than");
    assertThat(op.toNlsMessage().getLocalizedMessage(Locale.GERMAN)).isEqualTo("größer als");
  ...
  public void testGreaterOrEqual() {
    ...
    assertThat(op.toNlsMessage().getLocalizedMessage(Locale.US)).isEqualTo("greater or equal to");
    assertThat(op.toNlsMessage().getLocalizedMessage(Locale.GERMAN)).isEqualTo("größer oder gleich");
  ...
  public void testLessThan() {
    ...
    assertThat(op.toNlsMessage().getLocalizedMessage(Locale.US)).isEqualTo("less than");
    assertThat(op.toNlsMessage().getLocalizedMessage(Locale.GERMAN)).isEqualTo("kleiner als");
  ...
  public void testLessOrEqual() {
    ...
    assertThat(op.toNlsMessage().getLocalizedMessage(Locale.US)).isEqualTo("less or equal to");
    assertThat(op.toNlsMessage().getLocalizedMessage(Locale.GERMAN)).isEqualTo("kleiner oder gleich");
