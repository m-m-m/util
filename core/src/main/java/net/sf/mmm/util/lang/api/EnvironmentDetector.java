 ...
 *
 * @deprecated will be removed (no automagic)
...
public interface EnvironmentDetector {
   ...
   *         {@link #getEnvironmentType()}{@code .equals(}{@link #ENVIRONMENT_TYPE_DEVELOPMENT}{@code )}.
   */
  boolean isDevelopmentEnvironment();

  /**
   * @return the result of
   *         {@link #getEnvironmentType()}{@code .equals(}{@link #ENVIRONMENT_TYPE_PRODUCTION}{@code )}.
   */
