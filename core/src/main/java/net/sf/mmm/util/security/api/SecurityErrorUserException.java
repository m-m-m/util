 ...
 * complete his attack. A typical problem is e.g. if an attacker can distinguish between "account does not
 * exist" and "invalid credentials" he can easily scan for valid accounts. A large list of valid accounts can
 * be the basis for another account wit a standard password and rotating logins what is hard to detect and
 * prevent. <br>
 * <b>ATTENTION:</b><br>
