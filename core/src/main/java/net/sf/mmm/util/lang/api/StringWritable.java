...
/**
 * This is the abstract interface for an object that can be {@link #write(Appendable) written as string representation}
...
public abstract interface StringWritable {
   ...
   * @throws RuntimeIoException if an error occurred whilst writing the data.
   */
