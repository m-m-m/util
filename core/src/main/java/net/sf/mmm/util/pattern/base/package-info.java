 ...
 * syntax such as java-regex-, glob- and path-patterns. <a name="documentation"></a>
 * <h2>Pattern-Util Base</h2> Besides the {@link net.sf.mmm.util.pattern.base.RegexPatternCompiler} that only delegates
