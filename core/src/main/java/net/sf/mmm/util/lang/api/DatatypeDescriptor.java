...
/**
 * This is the interface to describe a {@link Datatype}. Allows to {@link #getSegment(Object, int) disassemble} a
 * (composite) datatype into its segments as well as to {@link #create(Object...) assemble} a {@link Datatype} from its
 * segments.
 *
...
public interface DatatypeDescriptor<T> {
  ...
  /**
   * Gets the {@link List} of {@link DatatypeSegmentDescriptor}s the {@link #getDatatype() described datatype} is
   * composed of. <br>
   ...
   * @param index is the index of the segment to retrieve. Has to correspond to the {@link List#get(int) list index} of
   *        {@link #getSegmentDescriptors() segment descriptors}.
   * @return the atomic value of the requested segment. Has to correspond to {@link DatatypeSegmentDescriptor#getType()}
   *         .
   */
   ...
   *        {@link #getSegmentDescriptors()}. {@link DatatypeSegmentDescriptor#isOptional() Optional} segments may be
   *        omitted (from the end of the list). The type of each segment has to match the corresponding
