...
public interface NlsTemplate extends Serializable {
   ...
   * {@code arguments} into the translated message writing into the given {@code buffer}.
   *
   * @param locale is the locale to translate to.
   ...
   * @return {@code true} if the (translated) message has been appended to the given
   *         {@code messageBuffer} or {@code false} if the translation failed.
