 ...
 * The ISO 8601 defines multiple formats for date and times. The following forms are handled by this implementation:<br>
 * <table border="1">
 * <tr bgcolor="#ccccff">
 * <th>Type</th>
 * <th>Basic</th>
 ...
 * </ul>
 * As you can see by the example the basic format is harder to read (for humans). Therefore you should use the extended
 * format if possible. <br>
...
public interface Iso8601Util extends Iso8601UtilLimited {
  ...
  /**
   * This method formats the given {@code calendar} as a date in the format "yyyy-MM-dd" according to {@link Iso8601Util
   * ISO 8601}.
   *
  ...
  /**
   * This method formats the given {@code calendar} as a date and time in the format "yyyy-MM-ddTHH:mm:ss&#177;hh:mm"
   * according to {@link Iso8601Util ISO 8601}.
   *
   * @param calendar is the date to format.
   * @return the given {@code calendar} as date string.
   */
  ...
  /**
   * This method formats the given {@code calendar} as a date and time according to {@link Iso8601Util ISO 8601}.
   *
   ...
   * {@code calendar}. If the given {@code date} does NOT specify the time or timezone, the values from the given
   * {@code calendar} will be kept.
   *
   * @param date is the date to parse.
