...
public interface AnnotationUtil {
  ...
  /**
   * This method determines if the given {@code annotationType} represents an {@link Annotation} that has
  ...
  /**
   * This method determines if the given {@code annotationType} represents an {@link Annotation} that has
   * a {@link java.lang.annotation.Target} compatible with the given {@code targetType}. <br>
   * 
   * @param <A> is the type of the annotation to check.
   * @param annotationType is the type of the annotation to check.
   * @param targetType is the expected target-type to check.
   * @return {@code true} if the given {@code annotationType} can be used to annotate elements of
   ...
   * {@link ElementType#TYPE classes}. If the {@code annotation} is
   ...
   * @param annotatedClass is the class potentially annotated with the given {@code annotation}. This
   ...
   * @return the requested annotation or {@code null} if neither the {@code annotatedClass} nor one
   ...
   *        annotation}.
   * @param annotationClass is the type of the requested annotation.
   * @return the requested annotation or {@code null} if neither the {@code annotatedType} nor one
   ...
   * @param annotationClass is the type of the requested annotation.
   * @return the requested annotation or {@code null} if neither the {@code annotatedMethod} nor one
