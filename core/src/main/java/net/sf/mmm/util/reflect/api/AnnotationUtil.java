...
public interface AnnotationUtil {
   ...
   * {@link java.lang.annotation.Retention} {@link java.lang.annotation.RetentionPolicy#RUNTIME runtime} and
   ...
   * {@code annotation} in the class {@link Class#getSuperclass() hierarchy} of the given
   * {@code annotatedClass}. <br>
   * <b>INFORMATION:</b><br>
   ...
   * {@link ElementType#TYPE classes}. If the {@code annotation} is {@link java.lang.annotation.Inherited
   * inherited} you may want to directly use {@link Class#getAnnotation(Class)} instead.
   *
   * @see #getTypeAnnotation(Class, Class)
   *
   * @param <A> is the type of the requested annotation.
   * @param annotatedClass is the class potentially annotated with the given {@code annotation}. This should
   *        NOT be an {@link Class#isInterface() interface}, {@link Class#isPrimitive() primitive},
   ...
   *         {@link Class#getSuperclass() super-classes} are {@link Class#getAnnotation(Class) annotated} with
   *         the given {@code annotation}.
  ...
  /**
   * This method gets the first {@link Class#getAnnotation(Class) annotation} of the type given by
   * {@code annotation} in the declaration of the given {@code annotatedType}. <br>
   * Instead of {@link #getClassAnnotation(Class, Class)} this method will also scan implemented interfaces
   * for the given {@code annotation}. <br>
   * This method is only useful if the given {@code annotation} is a
   * {@link java.lang.annotation.RetentionPolicy#RUNTIME runtime} annotation.
   *
   * @param <A> is the type of the requested annotation.
   * @param annotatedType is the class or interface potentially annotated with the given {@code annotation}.
   ...
   *         {@link Class#getSuperclass() super-classes}, or any implemented {@link Class#getInterfaces()
   *         interfaces} (no matter if implemented directly or indirectly) are
   *         {@link Class#getAnnotation(Class) annotated} with the given {@code annotation}.
   */
  <A extends Annotation> A getTypeAnnotation(Class<?> annotatedType, Class<A> annotationClass);

  /**
   * This method gets the first {@link Class#getAnnotation(Class) annotation} of the type given by
   * {@code annotation} in the {@link ReflectionUtil#getParentMethod(Method) hierarchy} of the given
   ...
   *         {@link Method#getAnnotation(Class) annotated} with the given {@code annotation}.
   */
