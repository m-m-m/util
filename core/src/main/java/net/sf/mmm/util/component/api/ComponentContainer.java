...
public interface ComponentContainer {
   ...
   * @throws ResourceMissingException if there is no component registered that implements the given {@code apiClass}.
   * @throws ResourceAmbiguousException if there are multiple components registered that implement the given
   *         {@code apiClass}.
   */
  <COMPONENT_API> COMPONENT_API get(Class<COMPONENT_API> apiClass)
   ...
   * @return the requested component.
   * @throws ResourceMissingException if there is no component registered under the given {@code componentId} or the
   *         registered component does NOT realize the given {@code apiClass}.
   */
