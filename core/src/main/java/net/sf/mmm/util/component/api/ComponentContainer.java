...
public interface ComponentContainer {
   ...
   *         {@code apiClass}.
   */
  <COMPONENT_API> COMPONENT_API get(Class<COMPONENT_API> apiClass) throws ResourceAmbiguousException,
      ResourceMissingException;

  /**
   * This method gets the component that realizes the given {@code apiClass} and is registered under the
   * given {@code componentId}.
   * 
   * @param <COMPONENT_API> is the generic type of the {@code apiClass}.
   * @param apiClass is the class reflecting the API of the requested component. This should be an interface.
   ...
   *         {@code componentId} or the registered component does NOT realize the given
   *         {@code apiClass}.
   */
