...
/**
 * Contains abstract interfaces to tag common concerns of objects. <a name="documentation"></a>
 * <h2>Util Lang API Concern</h2> This package contains marker interfaces used to tag and track common concerns of the
