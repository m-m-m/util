...
/**
 * This is the interface for a compiler that can {@link #compile(String) compile} an pattern-expression given
 * as string into a {@link Pattern}. <br>
 * The intention is to abstract from {@link Pattern#compile(String, int)} and therefore also allow other
