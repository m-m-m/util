...
abstract class AbstractBrowsableClasspathResource extends AbstractBrowsableResource implements ResourcePath {
  ...
  /**
   * @return the qualified java name ({@link Package#getName() package name} or {@link Class#getName() class name}).
   *         Will be {@code null} for a {@link ClasspathFile} that does not point to a {@link Class} file (*.class).
   */
