 ...
 * <h2>Util Date API</h2> This package contains the API for utilities that help to deal with date and time. The JDK
 * comes with rich support for date and time. On the other side the APIs like {@link java.util.Date} and
 * {@link java.util.Calendar} are very poor. This problem has been solved with Java 8 and JSR310. Where ever possible we
 * strongly encourage you to use JSR310 ({@code java.time.*}). However until then and for some other gaps you might find
