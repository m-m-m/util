...
/**
 * This is the {@link AbstractComponent abstract base class for a component} that provides a {@link #getLogger() logger}
 * .
 *
...
public abstract class AbstractLoggableComponent extends AbstractComponent {
   ...
   * <b>ATTENTION:</b><br>
   * This method is called from the constructor. It is not final to allow tests to replace the logger with a mock. You
   * should never override this method unless you are exactly aware about what you are doing!
   *
