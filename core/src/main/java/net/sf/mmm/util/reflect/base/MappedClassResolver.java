...
/**
 * This is an implementation of the {@link ClassResolver} interface that uses an internal {@link Map} to define specific
 * mappings. If no mapping is found for the {@link #resolveClass(String) requested} type the default strategy
...
public class MappedClassResolver implements ClassResolver {
  ...
  /**
   * This method adds a mapping for the given {@code type} using the {@link Class#getSimpleName() simple-name}.
   *
