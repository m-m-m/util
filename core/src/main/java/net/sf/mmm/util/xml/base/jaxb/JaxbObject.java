...
/**
 * This is the interface for a JAXB serializable object that needs to {@link #afterUnmarshal(Unmarshaller, Object)
...
public interface JaxbObject {
  ...
  /**
   * This method is automatically invoked by JAXB after un-marshaling this bean. It allows to link the parent object.
   *
