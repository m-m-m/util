...
public class DefaultNlsTemplateResolver extends AbstractResourceBundleNlsTemplateResolver {
   ...
   *
   * @param map the {@link Map} where to {@link Map#put(Object, Object) register} the {@link NlsTemplate}s by their
   *        {@link net.sf.mmm.util.nls.api.NlsMessage#getInternationalizedMessage() i18n message}.
   */
