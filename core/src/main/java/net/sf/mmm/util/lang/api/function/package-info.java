...
/**
 * Contains a temporary backport for functional interfaces from {@code java.util.function}.
 * <a name="documentation"></a><h2>Util Lang API Function</h2>
 * This package contains backports for the interfaces located in the package {@code java.util.function} that have
 * been introduced with Java 1.8. Initially it was our plan to use the proper interfaces directly and create a backport
 * with {@code mmm-util-backport-java.util.function}. <br>
 ...
 * {@code java.util.function} and mark them as deprecated. In APIs that take such an interface we will replace it
