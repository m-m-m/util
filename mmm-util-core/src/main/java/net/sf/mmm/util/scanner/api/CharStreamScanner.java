...
public interface CharStreamScanner {
   ...
   * {@link CharFilter#accept(char) accepted} by the given <code>filter</code> or the end is reached. <br>
   * After the call of this method, the {@link #getCurrentIndex() current index} will point to the next
   * character after the first {@link CharFilter#accept(char) accepted} character or to the end if NO such
   * character exists and <code>acceptEof</code> is <code>true</code>. Otherwise, if <code>null</code> is
   ...
   *         <code>filter</code> character or <code>null</code> if there was no
   *         {@link CharFilter#accept(char) accepted} character and <code>acceptEof</code> is
   *         <code>false</code>.
   * @since 7.0.0
   */
