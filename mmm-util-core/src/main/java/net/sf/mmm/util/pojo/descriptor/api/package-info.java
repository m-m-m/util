 ...
 * <a name="documentation"></a><h2>POJO Introspection API</h2>
 ...
 * it works on any {@link net.sf.mmm.util.pojo.api.Pojo} and is NOT 
 * limited by restrictions of the java-beans specification. Further it fully
 * supports the generic type-system introduced with Java5. <br>
