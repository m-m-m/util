...
public interface GenericTypeFactory {
   ...
   * 
   * @param type is the {@link Type} to represent.
   * @param definingType is the {@link GenericType} where the given <code>type</code> is defined in. It is
   *        needed to resolve {@link java.lang.reflect.TypeVariable}s.
   * @return the according {@link GenericType}.
   */
   ...
   * 
   * @param type is the {@link Type} to represent.
   * @param definingType is the {@link Class} where the given <code>type</code> is defined in. It is needed to
