...
public interface ExceptionUtil extends ExceptionUtilLimited, Security {
  ...
  String CDI_NAME = "net.sf.mmm.service.base.server.RemoteInvocationExceptionConverter";
  ...
  /**
   * Converts the given <code>exception</code> for the <em>client</em>. With client we mean any kind of system
