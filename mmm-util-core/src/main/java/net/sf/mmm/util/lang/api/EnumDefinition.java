...
public interface EnumDefinition<TYPE, CATEGORY> extends SimpleDatatype<String> {
  ...
  /**
   * This method gets the {@link Formatter} used to {@link Formatter#format(Object) format} instances of the
   * enum as {@link String} for end-users. By default {@link net.sf.mmm.util.lang.base.FormatterToString} can
