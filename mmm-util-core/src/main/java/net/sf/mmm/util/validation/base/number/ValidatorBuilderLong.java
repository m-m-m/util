 ...
 * @since 7.1.0
 */
public class ValidatorBuilderLong<PARENT>
    extends NumberValidatorBuilder<Long, PARENT, ValidatorBuilderLong<PARENT>> {
   ...
   */
  public ValidatorBuilderLong<PARENT> size(long min, long max) {

    return size(new Range<>(Long.valueOf(min), Long.valueOf(max)));
  }
