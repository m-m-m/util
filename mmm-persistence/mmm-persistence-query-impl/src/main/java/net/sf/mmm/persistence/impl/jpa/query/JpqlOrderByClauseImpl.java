...
public class JpqlOrderByClauseImpl<E> extends AbstractJpqlFragment<E> implements JpqlOrderByClause<E> {
   ...
   * @param property - see {@link net.sf.mmm.persistence.api.jpa.query.JpqlWhereClause#orderBy(String)}.
   * @param order - see
   *        {@link net.sf.mmm.persistence.api.jpa.query.JpqlWhereClause#orderBy(String, SortOrder)}. May be
   *        <code>null</code>.
   */
  public JpqlOrderByClauseImpl(JpqlQueryContext<E> context, String propertyBasePath, String property, SortOrder order) {
