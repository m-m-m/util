...
public interface PersistenceManager {
   ...
   * @throws ObjectNotFoundException if the requested {@link GenericEntity entity} could NOT be found.
   */
  <ID, ENTITY extends GenericEntity<ID>> ENTITY getReference(Class<ENTITY> entityClass, ID id)
      throws ObjectNotFoundException;
   ...
   * 
   * @param entity is the {@link GenericEntity} for which the class is requested.
