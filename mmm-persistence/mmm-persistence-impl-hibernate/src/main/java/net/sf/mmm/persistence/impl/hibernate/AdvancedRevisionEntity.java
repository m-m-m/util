...
/**
 * This is a custom {@link org.hibernate.envers.DefaultRevisionEntity revision entity} also containing the
 * actual user.
 *
...
@Table(name = "REVINFO")
public class AdvancedRevisionEntity implements GenericEntity<Long> {
