...
public @interface CliStyle {
  ...
  /**
   * @return determines how to {@link CliStyleHandling handle} a {@link CliOption} that is supplied as separate CLI
  ...
  /**
   * @return determines how to {@link CliStyleHandling handle} a {@link CliOption} with property-type {@link Boolean}
  ...
  /**
   * @return determines how to {@link CliStyleHandling handle} a boolean {@link CliOption} that is supplied as CLI
  ...
  /**
   * @return a {@link Class} with a public non-arg constructor that implements a {@link Filter} of Strings in order to
   *         decide if the {@link CliOption#name() name} or {@link CliOption#aliases() alias} of a {@link CliOption} is
  ...
  /**
   * @return determines how to {@link CliStyleHandling handle} a {@link CliOption} with a {@link CliOption#name() name}
   *         or {@link CliOption#aliases() alias} that is NOT {@link Filter#accept(Object) accepted} by
  ...
  /**
   * @return determines how to {@link CliStyleHandling handle} an undefined {@link CliMode mode}. The default is
  ...
  /**
   * @return determines how to {@link CliStyleHandling handle} a {@link CliMode mode} that is declared more than once.
  ...
  /**
   * @return the {@link CliContainerStyle style} of container values. It shall NOT be {@link CliContainerStyle#DEFAULT}.
   *         The default is {@link CliContainerStyle#MULTIPLE_OCCURRENCE}. This setting can be overridden via
  ...
  /**
   * @return determines how to {@link CliStyleHandling handle} if the property-type {@link CliOption} or
   *         {@link CliArgument} is a Map and two entries with the same key are supplied on the commandline. The default
   *         is {@link CliStyleHandling#EXCEPTION}.
   */
  CliStyleHandling valueDuplicateMapKey() default CliStyleHandling.EXCEPTION;

  /**
   * @return determines how to {@link CliStyleHandling handle} if boolean {@link CliOption options} that have a
