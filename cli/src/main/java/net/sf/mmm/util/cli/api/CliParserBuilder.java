...
public interface CliParserBuilder {
   ...
   * <ul>
   * <li>it needs to have (declared or inherited) fields annotated with {@link CliOption} and / or
   * {@link CliArgument}.</li>
   * <li>It's class or one of it's super-classes may also be annotated with {@link CliClass}.</li>
   * <li>It is recommended to use the {@link net.sf.mmm.util.cli.api.AbstractMain main-program} itself, but it
   * can be any {@link net.sf.mmm.util.pojo.api.Pojo}.</li>
   * </ul>
   *
   *
   * @param pojo is the annotated object for the CLI-state.
   * @return the {@link CliParser} used to {@link CliParser#parseParameters(String...) parse} the
   *         commandline-arguments and potentially {@link CliParser#printHelp(Appendable) print the help}.
   */
