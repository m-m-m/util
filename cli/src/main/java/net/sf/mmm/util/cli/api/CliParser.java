...
/**
 * This is the interface used to {@link #parseParameters(String...) parse} the command-line arguments of a main-program.
 *
 * @see CliClass
 *
...
public interface CliParser {
  ...
  /**
   * The prefix for {@link CliOption#name() name} or {@link CliOption#aliases() alias} of a short option. Value is
   * {@value} (e.g. "-h").
   */
  String PREFIX_SHORT_OPTION = "-";

  /**
   * The prefix for {@link CliOption#name() name} or {@link CliOption#aliases() alias} of a long option. Value is
   * {@value} (e.g. "--help").
   */
  String PREFIX_LONG_OPTION = "--";

  /**
   * The argument used to indicate that {@link CliOption options} are complete and {@link CliArgument arguments} will
   * follow. This allows to specify an argument that is equal to an option (e.g. "cat -- --help" would print the
   * contents of a file named "--help" rather that printing the help usage output).
   */
  String END_OPTIONS = "--";

  /**
   * This method prints the help (program usage) generated from the annotations to the given {@link Appendable} using
   * default {@link CliOutputSettings settings}.
   *
