...
* https://m-m-m.github.io/maven/apidocs/net/sf/mmm/util/cli/api/package-summary.html#package.description[CLI API] provides all you need to build a powerful CLI easily using anotations.
* https://m-m-m.github.io/maven/apidocs/net/sf/mmm/util/cli/api/AbstractMain.html[AbstractMain] and https://m-m-m.github.io/maven/apidocs/net/sf/mmm/util/cli/api/AbstractVersionedMain.html[AbstractVersionedMain] to directly extend and save even more implementation effort.
