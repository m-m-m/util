...
public class GenericFunction extends BasicFunction {
  ...
  /** the name of the field containing the {@link Function#getName() name} */
  private static final String FIELD_NAME_NAME = "NAME";

  /**
   * the name of the field containing the
   * {@link Function#getOperatorSymbol() symbol}
   */
  private static final String FIELD_NAME_SYMBOL = "SYMBOL";

  /**
   * the name of the field containing the
   * {@link Function#getOperatorPriority() "operator priority"}
   */
    ...
    if (result == null) {
      ...
      while (signatureList.hasNext()) {
        ...
        if (currentSignature.isApplicable(signature)) {
          ...
          if ((applicableSignature == null) || (applicableSignature.isApplicable(currentSignature))) {
