...
public class CoreNlsResourceBundle extends AbstractResourceBundle {
    ...
    /**
     * exception message if partial function implementation is illegal by itself (declaration).
     * 
     * @see net.sf.mmm.term.impl.GenericFunction#addImplementation(Class)
     */
    ...
    /**
     * exception message if partial function implementation is missing a
     * required (public static final) field..
     * 
     * @see net.sf.mmm.term.impl.GenericFunction#addImplementation(Class)
     */
