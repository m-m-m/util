 ...
 * messages via {@link NlsMessage}s.
 * 
...
public interface NlsLocalizer {
  ...
  /**
   * This method localizes the given <code>internationalizedMessage</code> with
   * the given <code>arguments</code> filled in to the given target
   * <code>locale</code>.
   * 
  ...
  /**
   * This method localizes the given <code>internationalizedMessage</code> to
   * the given target <code>locale</code>.
   * 
   * @param locale is the {@link Locale} to translate to.
   * @param internationalizedMessage is the
   *        {@link NlsMessage#getInternationalizedMessage() internationalized
