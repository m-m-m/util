 ...
 * interface for {@link PojoPropertyAccessorIndexedOneArgMode#SET_INDEXED
 * setting} an indexed property using the getter from another accessor returning
 * an array or {@link java.util.List}.
 * 
...
public class PojoPropertyAccessorProxySetIndexed extends
  ...
  public Object invoke(Object pojoInstance, int index, Object item) {
    ...
    Object result = getDependencies().getCollectionReflectionUtil().set(arrayOrList, index, item,
        arrayReceiver);
