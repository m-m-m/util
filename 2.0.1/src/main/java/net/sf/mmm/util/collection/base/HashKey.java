 ...
 * {@link Object#equals(Object)} method of the {@link #getDelegate()
 * delegate-object}. Additionally it sill matches even if the
 * {@link #getDelegate() delegate-object} has been modified and therefore
 * changed its {@link Object#hashCode() hash-code}.
 * 
 * @param <T> is the templated type of the {@link #getDelegate()
 *        delegate-object}.
 * 
