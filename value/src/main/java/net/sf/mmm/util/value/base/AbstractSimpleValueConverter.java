...
/**
 * This is an abstract base-implementation of the {@link ValueConverter} interface that simply works with {@link Class}
 * rather than {@link GenericType}.
 *
 ...
 * @since 1.0.1
 */
public abstract class AbstractSimpleValueConverter<SOURCE, TARGET> extends AbstractComponent implements ValueConverter<SOURCE, TARGET> {
