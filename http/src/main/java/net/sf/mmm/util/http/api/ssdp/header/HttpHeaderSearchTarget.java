 ...
 * @since 8.5.0
 */
public class HttpHeaderSearchTarget extends AbstractHttpHeader implements HttpRequestHeader {

  /** The {@link #getName() name} of this {@link HttpHeader}. */
  public static final String HEADER = "ST";

  /** The factory instance of this {@link HttpHeader}. */
  static final HttpHeaderSearchTarget FACTORY = new HttpHeaderSearchTarget();

  /**
   * The constructor.
   */
  public HttpHeaderSearchTarget() {
    super();
  }
   ...
   * @param value
   */
  public HttpHeaderSearchTarget(String value) {
    super(value);
