 ...
 * @since 8.4.0
 */
public class HttpHeaderMaximum extends AbstractHttpHeader implements HttpRequestHeader {

  /** The {@link #getName() name} of this {@link HttpHeader}. */
  public static final String HEADER = "MX";

  /** The factory instance of this {@link HttpHeader}. */
  static final HttpHeaderMaximum FACTORY = new HttpHeaderMaximum();

  /**
   * The constructor.
   */
  public HttpHeaderMaximum() {
    super();
  }
   ...
   * @param value
   */
  public HttpHeaderMaximum(String value) {
    super(value);
