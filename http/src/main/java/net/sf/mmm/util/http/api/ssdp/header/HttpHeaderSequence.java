 ...
 * @since 8.5.0
 */
public class HttpHeaderSequence extends AbstractHttpHeader implements HttpRequestHeader {

  /** The {@link #getName() name} of this {@link HttpHeader}. */
  public static final String HEADER = "SEQ";

  /** The factory instance of this {@link HttpHeader}. */
  static final HttpHeaderSequence FACTORY = new HttpHeaderSequence();

  /**
   * The constructor.
   */
  public HttpHeaderSequence() {
    super();
  }
   ...
   * @param value
   */
  public HttpHeaderSequence(String value) {
    super(value);
