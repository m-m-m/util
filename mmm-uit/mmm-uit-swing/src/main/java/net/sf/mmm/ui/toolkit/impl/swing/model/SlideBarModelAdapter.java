/* $Id: SlideBarModelAdapter.java 191 2006-07-24 21:00:49Z hohwille $ */
 ...
 */
public class SlideBarModelAdapter<E> implements UIListModelListenerIF {
     ...
     */
        ...
        public JLabel get(Object key) {
            ...
            if (label == null) {
                label = new JLabel(SlideBarModelAdapter.this.model.getElementAsString(index
                        .intValue()));
     ...
     * @param miniModel
     */
    public SlideBarModelAdapter(JSlider slider, UIListModelIF<E> miniModel) {
