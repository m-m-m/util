...
/**
 * This is the {@link UiHandlerEvent} for the action {@link #onChange(AttributeReadValue, boolean)}.
 * 
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 * @param <VALUE> is the generic type of the changed {@link AttributeReadValue#getValue() value}.
 */
public interface UiHandlerEventChange<VALUE> extends UiHandlerEvent {

  /**
   * This method is invoked if an UI object has changed its {@link AttributeReadValue#getValue() value}.
   * 
   * @param changedObject is the object that has changed its {@link AttributeReadValue#getValue() value}.
   ...
   */
  void onChange(AttributeReadValue<VALUE> changedObject, boolean programmatic);
