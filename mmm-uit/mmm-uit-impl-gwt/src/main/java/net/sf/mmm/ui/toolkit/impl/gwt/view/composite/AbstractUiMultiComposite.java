 ...
 * @since 1.0.0
 */
public abstract class AbstractUiMultiComposite<E extends AbstractUiElementGwt> extends
   ...
   */
  public AbstractUiMultiComposite(UiFactoryGwt uiFactory) {
  ...
  public E removeChild(int index) {
    ...
    E component = doRemoveChild(index);
