...
package net.sf.mmm.ui.toolkit.impl.smartgwt;
...
import net.sf.mmm.ui.toolkit.impl.smartgwt.view.window.UiWorkbenchImpl;

/**
 * This is the implementation of {@link net.sf.mmm.ui.toolkit.api.UiFactory}
 * using SmartGWT as underlying UI technology.
 * 
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
public class UiFactorySmartGwt extends AbstractUiFactoryGwt {
   ...
   */
  public UiFactorySmartGwt(String title) {
  ...
  public UiWorkbench createWorkbench(String title) {
    ...
    return new UiWorkbenchImpl(this);
  }
