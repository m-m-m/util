...
/**
 * This is the interface for an adapter to one or multiple physical widgets of
 * the underlying native widget toolkit.
 * 
 * @see net.sf.mmm.ui.toolkit.api.element.UiElement
 * 
 * @author hohwille
 * @since 1.0.0
 * @param <VALUE> is the generic type of the {@link #getValue() value}.
 */
public abstract interface UiAdapter<VALUE> extends AttributeWriteHtmlId, AttributeWriteOnlyVisible, AttributeWriteTooltip, AttributeWriteEnabled,
    AttributeWriteOnlyStyles, AttributeWriteValue<VALUE> {
