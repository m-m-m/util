/* $Id: SyncTreeAccess.java 191 2006-07-24 21:00:49Z hohwille $ */
...
public class SyncTreeAccess extends AbstractSyncControlAccess {
     ...
     * {@link org.eclipse.swt.widgets.Tree#getSelection() selection} of the
     * tree.
     */
    ...
    /**
     * operation to
     * {@link org.eclipse.swt.widgets.Tree#removeAll() "remove all"} items of
     * the tree.
     */
     ...
     */
    public SyncTreeAccess(UIFactory uiFactory, int swtStyle) {
    ...
    /**
     * This method
     * {@link org.eclipse.swt.widgets.Tree#removeAll() "removes all"} items
     * from the tree.
     */
