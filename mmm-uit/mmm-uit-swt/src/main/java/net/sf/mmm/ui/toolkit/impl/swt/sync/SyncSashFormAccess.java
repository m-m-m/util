/* $Id: SyncSashFormAccess.java 191 2006-07-24 21:00:49Z hohwille $ */
...
public class SyncSashFormAccess extends AbstractSyncCompositeAccess {
     ...
     */
    public SyncSashFormAccess(UIFactory uiFactory, int swtStyle) {
     ...
     */
    public SyncSashFormAccess(UIFactory uiFactory, int swtStyle, SashForm swtSashForm) {
