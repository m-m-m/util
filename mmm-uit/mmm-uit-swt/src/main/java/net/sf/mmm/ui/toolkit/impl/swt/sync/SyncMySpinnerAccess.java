/* $Id: SyncMySpinnerAccess.java 191 2006-07-24 21:00:49Z hohwille $ */
...
public class SyncMySpinnerAccess extends AbstractSyncCompositeAccess {
    ...
    /**
     * operation to set the {@link MySpinner#setModel(UIListModelIF) model} of
     * the spinner.
     */
     ...
     */
    public SyncMySpinnerAccess(UIFactory uiFactory, int swtStyle, UIListModelIF listModel) {
     ...
     *        is the model to set.
     */
    public void setModel(UIListModelIF listModel) {
