/* $Id: AbstractSyncItemAccess.java 191 2006-07-24 21:00:49Z hohwille $ */
...
public abstract class AbstractSyncItemAccess extends AbstractSyncWidgetAccess {
     ...
     */
    public AbstractSyncItemAccess(UIFactory uiFactory, int swtStyle) {
     ...
     * {@link org.eclipse.swt.widgets.Item#getText() text} of the item.
     * 
     ...
     * {@link org.eclipse.swt.widgets.Item#setText(String) text} of the
     * item.
     * 
     * @param buttonText
     *        is the text to set.
    ...
    /**
     * This method gets the
     * {@link org.eclipse.swt.widgets.Item#getImage() image} of the item.
     * 
     * @return the image of the item or <code>null</code> if no image is
     *         set.
     */
