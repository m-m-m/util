/* $Id: SyncGroupAccess.java 191 2006-07-24 21:00:49Z hohwille $ */
...
public class SyncGroupAccess extends AbstractSyncCompositeAccess {
     ...
     */
    public SyncGroupAccess(UIFactory uiFactory, int swtStyle) {
     ...
     */
    public SyncGroupAccess(UIFactory uiFactory, int swtStyle, Group swtGroup) {
