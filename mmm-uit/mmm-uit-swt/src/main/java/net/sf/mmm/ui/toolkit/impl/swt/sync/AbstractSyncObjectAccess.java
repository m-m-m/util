...
public abstract class AbstractSyncObjectAccess implements Runnable {
    ...
    /** the ui display */
    private final UIDisplayIF display;
     ...
     */
    public AbstractSyncObjectAccess(UIFactory uiFactory, int swtStyle) {
    ...
    protected boolean checkReady() {
        ...
        if (operation == null) {
            ...
            System.out.println("Synchonization bug: the operation '" + operation
                    + "' was NOT completed!");
            return false;
        }
    }
    ...
    /**
     * This method gets the {@link Widget#getStyle() style} of this widget.
     * 
