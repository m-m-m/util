/* $Id: UITreeModelIF.java 191 2006-07-24 21:00:49Z hohwille $ */
 ...
 * 
 * @see net.sf.mmm.ui.toolkit.api.widget.UITreeIF
 * 
 * @param <N>
 ...
 */
public interface UITreeModelIF<N> {
     ...
     */
    void addListener(UITreeModelListenerIF<N> listener);
     ...
     */
    void removeListener(UITreeModelListenerIF<N> listener);
     ...
     * 
     * @param node
     *        is a node retrieved from this model via the method
     ...
     *        <code>getRootNode</code> or <code>getChildNode</code>.
     * @param index
     *        is the position of the requested child node. The value must be
