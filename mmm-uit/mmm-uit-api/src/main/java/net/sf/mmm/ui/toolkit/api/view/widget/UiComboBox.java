...
/**
 * This is the interface for a combo-box UI. A combo-box is used to display items in a list as a
 * pull-down-menu.<br>
 * By default only the selected item is displayed together with an arrow-down button. If selected, the
