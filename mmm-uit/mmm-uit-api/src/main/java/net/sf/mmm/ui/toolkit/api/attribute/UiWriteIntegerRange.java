...
public interface UiWriteIntegerRange extends UiReadIntegerRange {
   ...
   * 
   * @param newMinimum is the new minimum value. It must be less than (or equal
   *        to) the {@link #getMaximumValue() maximum}. Use
   *        {@link #LOWEST_MINIMUM} for no minimum. Also {@link #LOWEST_MINIMUM}
   *        will be set if the value is less than that.
   * @throws IllegalArgumentException if the given value is greater than the
   ...
   * 
   * @param newMaximum is the new maximum value. It must be greater than (or
   *        equal to) the {@link #getMinimumValue() minimum}. Use
   *        {@link #HIGHEST_MAXIMUM} for no maximum. Also
   *        {@link #HIGHEST_MAXIMUM} will be set if the value is greater than
   *        that.
