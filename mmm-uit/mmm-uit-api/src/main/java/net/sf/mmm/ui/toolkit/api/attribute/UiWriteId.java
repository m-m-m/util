...
/**
 * This interface gives write access to a {@link #setId(String) ID}.
 * 
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
public interface UiWriteId extends UiReadId {

  /**
   * This method set the identifier of this object. Use this method to give the
   * object a meaningful identifier after creation.<br/>
   * <b>ATTENTION:</b><br>
