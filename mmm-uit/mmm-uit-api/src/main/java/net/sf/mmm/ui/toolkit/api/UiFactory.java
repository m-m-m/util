 ...
 * the user interface. An application should create only one instance of {@link UiFactory}.
 * 
 * @see UiService
 * 
...
public interface UiFactory extends AttributeWriteDisposed {
   ...
   * country settings and is used for nationalization of the GUI elements.
   * 
  ...
  /**
   * This method sets the locale of this factory. This will cause a nationalization of all existing GUI
   * elements created by this factory, that are currently attached to a window. The nationalization will cause
   * translation of the texts (as long as you provide them as {@link net.sf.mmm.util.nls.api.NlsMessage}) as
   * well as the {@link #getScriptOrientation() script-orientation}.
   * 
  ...
  /**
   * This method gets the orientation of the users script. This is taken into account when rendering texts as
   * well as when calculating the layout. Therefore menu-items or widgets located inside a panel may appear
  ...
  /**
   * This method sets the users script-orientation. You should set this value at the beginning before creating
   * your GUI with this factory. If you set this option at a later time, all existing {@link UiObject
   * GUI-Objects} created by this factory will be refreshed. Depending on the implementation of this toolkit
   * this may be an expensive operation, needs to dispose and rebuild all GUI elements and can cause the loss
  ...
  /**
   * This method gets the script-orientation of the design of the GUI. This property allows the creator of the
   * GUI to design in the orientation according to his script so it feels native.<br>
   * If the {@link #getScriptOrientation() script-orientation} of the user is different to the designed
   * orientation the layout is automatically mirrored accordingly.
   * 
  ...
  /**
   * This method sets the {@link #getDesignOrientation() designed script-orientation}. You should set this
   * value at the beginning before creating {@link UiNode UI nodes} with this factory.
   * 
  ...
  /**
   * This method gets the {@link UiWorkbench} for this {@link UiFactory} instance. That {@link UiWorkbench}
   * represents the main-window of the application. On the first call of this method the {@link UiWorkbench}
   * will be created.
   * 
   ...
   * <b>ATTENTION:</b><br>
   * For writing portable user-interfaces prefer to use {@link #getOrCreateWorkbench()} and then do
  ...
  /**
   * This method creates a new button. According to the style this can be a radio-, toggle-, check- or a
   * regular button.
   * 
   * @param text is the text that explains the action triggered by the button. It will be shown inside the
   *        button.
  ...
  /**
   * This method creates a new {@link UiBorderPanel} with the given <code>title</code>.
   * 
   * @param <CHILD> is the generic type of the {@link UiBorderPanel#getChild() child element}.
   * 
   ...
   * 
   * @param title is the {@link UiBorderPanel#getTitle() border-title}.
   * @param child is the {@link UiBorderPanel#getChild() child element} displayed within the border.
   * @return the new {@link UiBorderPanel}.
   */
  <CHILD extends UiElement> UiBorderPanel<CHILD> createBorderPanel(String title, CHILD child);

  /**
   * This method creates a new {@link UiSimplePanel} with the given <code>orientation</code>.
   * 
   * @param <CHILD> is the generic type of the {@link UiSimplePanel#getChild(int) child elements}.
   * @param orientation is the {@link UiSimplePanel#getOrientation() orientation} of the
  ...
  /**
   * This method creates a new {@link UiGridPanel} with the given number of columns.
   * 
   * @return the new {@link UiBorderPanel}.
   */
   ...
   * 
   * @param multiSelection - if <code>true</code> the user can select multiple items of the tree, else only
   *        one.
   * @return the created tree.
   */
   ...
   * 
   * @param multiSelection - if <code>true</code> the user can select multiple items/cells of the table, else
   *        only one.
   * @return the created table.
   */
   ...
   *        {@link net.sf.mmm.ui.toolkit.base.model.NumericUIRangeModel} for a regular slide-bar.
   ...
   * This method creates a new progress-bar.
   * 
   * @param orientation defines the axis along which the progress-bar is oriented.
   * @return the new progress-bar.
   */
  ...
  /**
   * This method creates an action that prints the given component if its {@link UiAction#getActionListener()
   * listener} is invoked.
   * 
