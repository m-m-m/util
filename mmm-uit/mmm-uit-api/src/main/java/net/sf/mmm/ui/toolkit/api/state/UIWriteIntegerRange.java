...
public interface UIWriteIntegerRange extends UIReadIntegerRange {
   ...
   * 
   * @param newMaximum
   *        is the new maximum value. It must be greater than (or equal to) the
   *        {@link #getMinimumValue() minimum}. Use {@link #HIGHEST_MAXIMUM}
   *        for no maximum. Also {@link #HIGHEST_MAXIMUM} will be set if the
