...
/**
 * This class represents the event sent by the list model to its listeners to notify about changes of the
 * list.
 * 
...
public final class UIListModelEvent extends UIModelEvent {
  ...
  /**
   * This method gets the index of the first item that has changed (updated, removed or added/inserted). If
   * only one item has changed, the value is equal to {@link #getEndIndex()}
   * 
  ...
  /**
   * This method gets the index of the last item that has changed (updated, removed or added/inserted). If
   * only one item has changed, the value is equal to {@link #getStartIndex()}.
   * 
