 ...
 * popup with a warning or additional required input). It is not visible in the task-bar. It usually has the
 * top focus of the application and may be {@link #isModal() modal}. A dialog is created from a frame that
 * will be his {@link #getParent() parent}.
 * 
