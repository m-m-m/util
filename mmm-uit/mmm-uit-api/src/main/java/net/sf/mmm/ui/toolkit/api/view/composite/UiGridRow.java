...
public interface UiGridRow<CHILD extends UiElement> extends UiExtendableComposite<CHILD> {
  ...
  /**
   * This method gets the {@link GridCellInfo} for the {@link #getChild(int)
   * cell} identified by the given <code>column</code> in this {@link UiGridRow}
   * .<br/>
   * <b>NOTE:</b><br>
   * The {@link GridCellInfo} are in sync with the {@link #getChild(int)
   * children} of this {@link UiGridRow}. Operations like
   * {@link #removeChild(int)} or {@link #insertChild(UiElement, int)} will
   * update the {@link GridCellInfo}s accordingly.
   * 
   * @param column is the index of the column of the cell in this row. Needs to
