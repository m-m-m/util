 ...
 * @since 1.0.0
 */
public abstract class AbstractUiMultiComposite<DELEGATE, CHILD extends AbstractUiElement<?>> extends
    AbstractUiComposite<DELEGATE, CHILD> implements UiMultiComposite<CHILD> {
