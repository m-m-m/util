...
/**
 * This is the interface for a date and time box. It is a widget that allows the user to specify a date and
 * time in a comfortable way. By default the timezone should be set to the users locale. An advanced
 * implementation will allow the user to specify the timezone as well.<br/>
