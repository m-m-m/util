...
/**
 * This is the abstract interface for a UI list widget. Such a widget presents a list. The way the list is
 * presented is not further specified here.
 * 
 ...
 * @since 1.0.0
 */
public abstract interface UiListWidget<E> extends UiWidget, AttributeWriteSelectionIndex,
    AttributeWriteSelectionValue<E> {
