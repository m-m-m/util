...
/**
 * This is the interface of a list model listener. Such a listener gets notified about any change of list
...
public interface UIListModelListener extends EventListener {
  ...
  /**
   * This method is called by the list model if the list has changed (items have been updated, inserted or
   * removed).
   * 
