/* $Id: LayoutConstraints.java 191 2006-07-24 21:00:49Z hohwille $ */
 ...
 * {@link net.sf.mmm.ui.toolkit.api.UIComponentIF} inside a
 * {@link net.sf.mmm.ui.toolkit.api.composite.UIPanelIF}.
 * 
...
public class LayoutConstraints {
     ...
     */
    private static class DummySize implements UIReadSizeIF {
    ...
    private static final UIReadSizeIF NO_SIZE = new DummySize();

    /**
     * The default layout constraints:<br>
     * Default alignment is {@link Alignment#CENTER}, default {@link #weight}
     * is <code>1.0</code> and default insets are {@link Insets#NO_SPACE}.
     */
     ...
     */
    public static final LayoutConstraints FIXED_HORIZONTAL = new LayoutConstraints(
            Alignment.CENTER, Filling.HORIZONTAL, 0.0, Insets.NO_SPACE);
     ...
     * {@link net.sf.mmm.ui.toolkit.api.state.UIReadSizeIF size}.<br>
     ...
     * sized as its {@link net.sf.mmm.ui.toolkit.api.state.UIReadSizeIF size}.
     ...
     * {@link UIReadSizeIF#getWidth() width} or
     * {@link UIReadSizeIF#getHeight() height} is greater than <code>0</code>,
     * it overrides the size-value of the associated
     * {@link net.sf.mmm.ui.toolkit.api.UIComponentIF component}.
     */
    public final UIReadSizeIF size;
