...
/**
 * This is the interface for a list UI. A list is used to display items in a list so the user can select one
 * or multiple of these items.<br>
 * The list shows several items in rows. If the number of items is too large to fit, a scrollbar is displayed.
 * 
