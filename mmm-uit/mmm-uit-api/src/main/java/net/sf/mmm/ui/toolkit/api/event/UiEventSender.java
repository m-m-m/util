 ...
 * {@link UiEventListener#onEvent(net.sf.mmm.ui.toolkit.api.view.UiNode, UiEventType) events}.
 * 
...
public interface UiEventSender {
  ...
  /**
   * This method removes a {@link UiEventListener}. If that <code>listener</code> was not registered before
  ...
  /**
   * This method sends an {@link UiEventListener#onEvent(net.sf.mmm.ui.toolkit.api.view.UiNode, UiEventType)
