/* $Id: UIPanelIF.java 191 2006-07-24 21:00:49Z hohwille $ */
 ...
 * <li>it is designed to be simple to use and understand</li>
 ...
 * table structures with multiple columns and multiple horizontal layouted
 ...
 * <li>the layout can order the components only horizontal or vertial</li>
 * </ul>
 * 
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 */
public interface UIPanelIF extends UICompositeIF, UIWriteOrientationIF {
     ...
     */
    void addComponent(UIComponentIF component);
     ...
     *        this panel.
     */
    void addComponent(UIComponentIF component, LayoutConstraints constraints);
     ...
     */
    void addComponent(UIComponentIF component, LayoutConstraints constraints, int position);
