/* $Id: UIObjectIF.java 191 2006-07-24 21:00:49Z hohwille $ */
 ...
 * {@link UIObjectIF#getType()}method.
 * 
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 */
public interface UIObjectIF {
     ...
     * <pre>
     * UIObjectIF uiObject = ...;
     * if (uiObject.getType() == UIButtonIF.TYPE) {
     *   UIButtonIF button = (UIButtonIF) uiObject;
     *   ...
     * }
     * </pre>
     * 
     ...
     *         {@link net.sf.mmm.ui.toolkit.api.window.UIWindowIF window},
     ...
     * 
     * @return <code>true</code> if this component is a
     *         {@link net.sf.mmm.ui.toolkit.api.widget.UIWidgetIF widget},
     *         <code>false</code> otherwise.
     */
    boolean isWidget();
