...
/**
 * Contains the API for widgets. <a name="documentation"/><h2>UIT API Widget</h2> This package and its
 * sub-packages contain the API for {@link net.sf.mmm.ui.toolkit.api.widget.UiWidget widgets} to build a user
 * interface. It abstracts from underlying native UI toolkits and allows to build a portable cross-technology
 ...
 * features like
 * <ul>
 * <li>{@link net.sf.mmm.ui.toolkit.api.feature.UiFeatureValidation validation}</li>
 * <li>{@link net.sf.mmm.ui.toolkit.api.attribute.AttributeReadModified#isModified() dirty handling}</li>
 * <li>
 ...
 * {@link net.sf.mmm.ui.toolkit.api.common.Accessibility} is an important but also complex topic. This layer
 * support standards such as {@link net.sf.mmm.ui.toolkit.api.common.Accessibility#WAI_ARIA WAI-ARIA} as well
 * as keyboard control and other features to increase accessibility.
 * </ul>
 * <h3>Limitations</h3> Please also note the following limitations before you make your choice:
 * <ul>
