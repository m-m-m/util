...
/**
 * This is the abstract base implementation of {@link UiWidgetFactory} using {@link UiSingleWidgetFactory}.
 * This is helpful for implementations that can NOT use reflection. Implementations extending this
 * {@link Class} need to {@link #register(UiSingleWidgetFactory) register} instances of
 * {@link UiSingleWidgetFactory} for all supported types of {@link UiWidget}s.
 * 
