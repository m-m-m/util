...
/**
 * This is the abstract base class for a {@link UiWidgetCustom custom widget} that customizes a
 * {@link UiWidgetField}. The main usecase is to create {@link UiWidgetField field widgets} for custom
 * {@link net.sf.mmm.util.lang.api.Datatype} based on existing {@link UiWidgetField field widgets}.
 * 
 ...
 * @since 1.0.0
 */
public abstract class UiWidgetCustomField<VALUE, DELEGATE_VALUE, DELEGATE extends UiWidgetField<DELEGATE_VALUE>>
    extends UiWidgetCustom<VALUE, DELEGATE> implements UiWidgetField<VALUE> {
  ...
  protected String getSource() {
    ...
    String source = getDelegate().getLabel();
    if (source == null) {
  ...
  protected ChangeEventSender<VALUE> createChangeEventSender() {
    ...
    getDelegate().addChangeHandler(new UiHandlerEventValueChange<DELEGATE_VALUE>() {
      ...
      public void onValueChange(AttributeReadValue<DELEGATE_VALUE> source, boolean programmatic) {
        ...
        changeEventSender.onValueChange(UiWidgetCustomField.this, programmatic);
      }
    });
