...
public interface DomUtil {
   ...
   * @return the parsed XML DOM document.
   * @throws XmlException if the input stream produced an IOException or the XML is invalid.
   */
   ...
   * @return {@code true} if the XML fragment represented by the given nodes equals, {@code false} otherwise.
   */
  ...
  /**
   * This method gets the value of the {@code attribute} from the given {@code element} as a boolean value.
   *
