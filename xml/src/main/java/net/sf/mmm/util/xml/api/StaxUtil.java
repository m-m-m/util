...
public interface StaxUtil {
   ...
   * @throws net.sf.mmm.util.xml.api.ValueException if the attribute is NOT defined or its value can NOT be converted to
   *         {@code type}.
   */
   ...
   *        .
   * @return the requested attribute as the given {@code type}.
   * @throws net.sf.mmm.util.xml.api.ValueException if the attribute value can NOT be converted to {@code type}.
   */
  <V> V parseAttribute(XMLStreamReader xmlReader, String namespaceUri, String localAttributeName, Class<V> type, V defaultValue);
