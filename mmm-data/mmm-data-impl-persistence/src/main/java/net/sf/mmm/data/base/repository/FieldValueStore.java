...
public interface FieldValueStore {
   ...
   * {@link #loadFields(AbstractDataObject) load} and
   * {@link #saveFields(AbstractDataObject) save} it.
   * 
   ...
   */
  void loadFields(AbstractDataObject contentObject) throws DataException;
   ...
   * @throws DataException if the operation fails.
   */
  void saveFields(AbstractDataObject contentObject) throws DataException;
