...
public interface RevisionHistory {
   ...
   * 
   * @see net.sf.mmm.data.api.entity.security.DataSecurityOperation
   * 
   * @param action is the action for that the date of performing is requested.
   *        This should be the name of an
   *        {@link net.sf.mmm.data.api.entity.security.DataSecurityOperation action} - e.g.
   *        {@link net.sf.mmm.data.api.entity.security.DataSecurityOperation#ACTION_CREATE}.
   ...
   *         revision.
   */
  DataSecurityUser getSubject(String action);
}
