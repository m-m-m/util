 ...
 * <b>ATTENTION:</b><br>
 * Please note that any other {@link net.sf.mmm.content.api.ContentObject
 * entity} may also be a {@link net.sf.mmm.content.api.ContentObject#isFolder()
...
public abstract interface ContentFolder extends ContentResource {
  ...
  /**
   * The name of the {@link net.sf.mmm.content.reflection.api.ContentClass}
