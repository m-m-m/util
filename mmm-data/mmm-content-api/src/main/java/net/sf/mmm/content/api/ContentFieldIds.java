 ...
 * {@link net.sf.mmm.content.reflection.api.ContentField#getId() field IDs}.
 * 
 * @author hohwille
 * @since 1.0.0
 */
public interface ContentFieldIds {
  ...
  /**
   * {@link net.sf.mmm.content.reflection.api.ContentField#getId() Field ID} for
   * {@link net.sf.mmm.content.reflection.api.ContentReflectionObject#getDeletedFlag()}
   * .
   */
  ...
  /**
   * {@link net.sf.mmm.content.reflection.api.ContentField#getId() Field ID} for
   * {@link net.sf.mmm.content.reflection.api.ContentReflectionObject#isDeleted()}
   * .
   */
  ...
  /**
   * {@link net.sf.mmm.content.reflection.api.ContentField#getId() Field ID} for
   * {@link net.sf.mmm.content.reflection.api.ContentReflectionObject#getJavaClass()}
   * .
   */
  ...
  /**
   * {@link net.sf.mmm.content.reflection.api.ContentField#getId() Field ID} for
   * {@link net.sf.mmm.content.reflection.api.ContentReflectionObject#getContentModifiers()}
   * .
   */
