 ...
 * {@link net.sf.mmm.data.api.ContentObject} and its sub-types. Therefore an
 * according {@link net.sf.mmm.data.reflection.api.ContentClass} is created
 * that can be configured via this annotation.<br>
 * 
 * @see net.sf.mmm.data.api.ContentObject
 * @see net.sf.mmm.data.reflection.api.ContentClass
 * 
...
public @interface ContentClassAnnotation {
  ...
  /**
   * The {@link net.sf.mmm.data.datatype.api.ContentId#getObjectId() id} of
   * the {@link net.sf.mmm.data.reflection.api.ContentClass}. If omitted the
   ...
   * 
   * @see net.sf.mmm.data.reflection.api.ContentClass#CLASS_ID_MINIMUM_CUSTOM
   */
  int id() default -1;

  /**
   * The {@link net.sf.mmm.data.reflection.api.ContentClass#getTitle() title}
  ...
  /**
   * The
   * {@link net.sf.mmm.data.reflection.api.ContentClassModifiers#isExtendable()
   * extendable} flag of a
   * {@link net.sf.mmm.data.reflection.api.ContentClassModifiers#isSystem()
  ...
  /**
   * The
   * {@link net.sf.mmm.data.reflection.api.ContentClassModifiers#isFinal()
   * final} flag of a {@link net.sf.mmm.data.reflection.api.ContentClass}
