...
/**
 * Provides the API for the reflection of {@link net.sf.mmm.data.api.DataObjectView
 * data-objects}.
 * <a name="documentation"/><h2>Data Reflection API</h2> 
 * This package contains the API for the reflection of 
 * {@link net.sf.mmm.data.api.DataObjectView data-objects}. The reflection is
 * provided in advance to the java reflection API for the following reasons:
 * <ul>
 *   <li><b>Dynamic Typing</b><br/>
 *   The {@link net.sf.mmm.data.api.entity.DataEntityView} model also allows 
 ...
 *   fields. If the {@link net.sf.mmm.data.api.entity.DataEntityView} model has
 ...
 * {@link net.sf.mmm.data.api.DataObjectView} and gives generic access to  
