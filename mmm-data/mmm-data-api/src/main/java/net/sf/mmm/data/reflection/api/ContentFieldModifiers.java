 ...
 * {@link net.sf.mmm.data.reflection.api.ContentField content-field}.<br>
 ...
 * 
 * @see net.sf.mmm.data.reflection.api.ContentField#getContentModifiers()
 * 
...
public interface ContentFieldModifiers extends ContentModifiers {
   ...
   * {@link net.sf.mmm.data.api.ContentObject instance}.<br>
   ...
   * {@link net.sf.mmm.data.reflection.api.ContentField#getFieldValue(Object)
   * read} and (if not {@link #isReadOnly() read-only} be
   * {@link net.sf.mmm.data.reflection.api.ContentField#setFieldValue(Object, Object)
   ...
   * from {@link net.sf.mmm.data.api.ContentObject#getParent() parent} if not
   * set.<br/>
   * If a {@link net.sf.mmm.data.api.ContentObject} <code>O</code> is an
   ...
   * {@link net.sf.mmm.data.api.ContentObject#getParent() parent} (
   * <code>O.parent.f</code>). Therefore the
   * {@link net.sf.mmm.data.api.ContentObject#getParent() parent} needs to be
   * of the same type ({@link ContentClass}) (<code>O.parent</code> instanceof
   * <code>C</code>).<br/>
   * <b>ATTENTION:</b><br>
   * In a statically typed {@link net.sf.mmm.data.reflection.api
