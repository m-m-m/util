...
/**
 * This is the view (read-only) interface for an object of the
 ...
 * @since 1.0.0
 */
@DataClassAnnotation(id = DataObjectView.CLASS_ID, title = DataObjectView.CLASS_TITLE, isExtendable = BooleanEnum.FALSE)
public abstract interface DataObjectView extends RevisionedPersistenceEntity<Long>,
   ...
   * siblings (e.g.
   * {@link net.sf.mmm.data.api.entity.resource.DataEntityResourceView}).<br>
   * 
  ...
  /**
   * The deleted-flag of a {@link DataNodeView} is inherited so
   * {@link #isDeleted()} will return <code>true</code> if a
   * {@link DataNodeView#getParent() parent object} is marked as deleted.<br>
   ...
   * {@link DataNodeView#getParent() parent}.
   * 
   * @see #getDeletedFlag()
   * 
