...
/**
 * This interface allows to {@link #getDataClass(String) get} a {@link DataClass} by its
 * {@link DataClass#getTitle() name}.
 * 
...
public interface DataClassReadAccessByTitle {
   ...
   * 
   * @param title is the {@link DataClass#getTitle() title} of the requested class.
