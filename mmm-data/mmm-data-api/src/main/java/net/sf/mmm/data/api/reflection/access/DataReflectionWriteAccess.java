...
public interface DataReflectionWriteAccess {
   ...
   * 
   * @param <CLASS> is the generic type of the according
   ...
   * @throws DataReflectionException if the class could not be created. This can
   ...
   * @param modifiers are the {@link DataField#getModifiers() modifiers} for the
   *        field to create.
   * @return the created field.
   * @throws DataReflectionException if the field could not be created. This can
   *         have one of the following reasons:
   *         <ul>
   ...
   * @throws DataReflectionException if the deleted flag could not be modified.
