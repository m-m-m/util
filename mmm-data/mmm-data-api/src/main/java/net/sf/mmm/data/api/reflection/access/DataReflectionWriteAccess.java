...
public interface DataReflectionWriteAccess {
   ...
   * @param type is the {@link DataField#getFieldType() type} of the values
   ...
   * @throws DataReflectionException if the deleted flag could not be
   *         modified. This can have one of the following reasons:
   *         <ul>
   *         <li>the given class or field has the system flag set</li>
   *         </ul>
   */
  void setDeleted(DataReflectionObject<? extends DataObject> classOrField,
