...
import net.sf.mmm.data.api.ContentNode;
...
public abstract interface ContentReflectionObject<CLASS> extends
   ...
   * {@link net.sf.mmm.data.api.ContentObject#isDeleted()} will return
   ...
   * inherit the flag.
   * 
   * @see net.sf.mmm.data.api.ContentObject#isDeleted()
   * 
   ...
   * {@link net.sf.mmm.data.reflection.api.ContentClass} is destroyed then
   ...
   * {@link net.sf.mmm.data.api.ContentObject} or at least
