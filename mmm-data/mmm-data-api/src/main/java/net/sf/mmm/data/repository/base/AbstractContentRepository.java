...
package net.sf.mmm.data.repository.base;
...
import net.sf.mmm.data.repository.api.ContentObjectWrongTypeException;
import net.sf.mmm.data.repository.api.ContentRepository;
