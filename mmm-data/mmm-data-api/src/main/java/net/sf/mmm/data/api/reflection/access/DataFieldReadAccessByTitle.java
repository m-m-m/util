...
/**
 * This interface allows to {@link #getDataField(String) get} a
 * {@link DataField} by its {@link DataField#getTitle() title}.
 * 
...
public interface DataFieldReadAccessByTitle {
   ...
   * 
   * @param title is the {@link DataField#getTitle() title} of the requested
   *        field.
