...
public abstract interface ContentEntity extends ContentObject {
   ...
   * {@link net.sf.mmm.data.reflection.api.ContentClass type}. This method
   ...
   * same {@link net.sf.mmm.data.reflection.api.ContentClass type}. Then all
   * unset {@link net.sf.mmm.data.reflection.api.ContentField fields} are
   ...
   * {@link net.sf.mmm.data.reflection.api.ContentClass type} as this
   * instance.
   * 
