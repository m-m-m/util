 ...
 * from a lists that are embedded in a {@link DataSelectionTree tree-nodes}.
 * In other words: if you have a {@link DataSelectionTree} you can declare an
 ...
 * {@link net.sf.mmm.data.api.reflection.DataField}s. Other examples could
...
public abstract interface DataSelectionTreeList<NODE extends DataSelectionTree<NODE>> extends
