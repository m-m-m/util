...
public class ContentClassLoaderNative extends AbstractContentClassLoader {
   ...
   * {@inheritDoc}
   */
  public AbstractContentClass loadClasses() throws IOException, DataReflectionException {

    Context context = new Context();
    parseConfiguration(context);
    AbstractContentClass<? extends DataObject> rootClass = context
        .getContentClass(DataObject.CLASS_ID);
    if (rootClass == null) {
  ...
  public AbstractContentClass loadClassRecursive(Class<?> javaClass, Context context) {
    ...
    if (contentClass == null) {
      ...
      DataClassModifiers contentClassModifiers = ContentClassModifiersBean.getInstance(isSystem,
    ...
    for (PojoPropertyDescriptor methodPropertyDescriptor : methodPojoDescriptor
      ...
      try {
        ...
        if (declareField) {
          ...
          DataFieldModifiers contentFieldModifiers = ContentFieldModifiersBean.getInstance(
