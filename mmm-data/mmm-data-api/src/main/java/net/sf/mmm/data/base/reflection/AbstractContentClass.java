 ...
 * @since 1.0.0
 */
public abstract class AbstractContentClass<CLASS extends DataObject> extends
    AbstractContentReflectionObject<CLASS> implements DataClass<CLASS> {
   ...
   * {@inheritDoc}
   */
  public AbstractContentClass<? extends DataObject> getParent() {
   ...
   */
  public void addSubClass(AbstractContentClass subClass) throws DataReflectionException {
   ...
   */
  public void addField(AbstractContentField field) throws DataReflectionException {
  ...
  private class FieldsCollection extends AbstractCollection<AbstractContentField<? super CLASS, ?>> {
    ...
    public int size() {
      ...
      int result = 0;
      for (DataField<CLASS, ?> field : AbstractContentClass.this.declaredFields.values()) {
