 ...
 * {@link net.sf.mmm.data.api.DataObjectView content-object}s (also called
 ...
 *      implementations of the {@link net.sf.mmm.data.api.DataObjectView
...
public interface DataReflectionService extends DataReflectionReadAccess {
  ...
  /**
   * the tag-name of a {@link DataClass content-class} in the content-model
   * XML representation
   */
   ...
   * XML representation
   */
  String XML_ATR_NAME = DataObjectView.FIELD_NAME_TITLE;

  /**
   * the tag-name of a {@link DataField content-field} in the content-model
   * XML representation
   */
