...
/**
 * This is the base implementation of the {@link ContentFieldModifiers}
 * interface.
 * 
...
public class ContentFieldModifiersBean extends AbstractContentModifiersBean implements
   ...
   */
  public ContentFieldModifiersBean(ContentFieldModifiers modifiers) {
   ...
   * {@link ContentFieldModifiers} instance.
   * 
   * @see String#intern()
   * @see #getInstance(boolean, boolean, boolean, boolean, boolean, boolean)
   * 
   * @return the according singleton {@link ContentFieldModifiers} instance.
   */
  public ContentFieldModifiers intern() {
   ...
   */
  public static ContentFieldModifiers getInstance(boolean isSystem, boolean isFinal,
