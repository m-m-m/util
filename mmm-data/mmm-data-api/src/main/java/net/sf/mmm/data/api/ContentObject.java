 ...
 * <tr>
 * <td>{@link Class}</td>
 * <td>{@link net.sf.mmm.data.reflection.api.ContentClass}</td>
 * </tr>
 * <tr>
 * <td>{@link java.lang.reflect.Field Field}/{@link java.lang.reflect.Method
 * Method}</td>
 * <td>{@link net.sf.mmm.data.reflection.api.ContentField ContentField}</td>
 * </tr>
 * <tr>
 * <td>{@link ClassLoader}</td>
 * <td>{@link net.sf.mmm.data.reflection.api.ContentClassLoader
 * ContentClassLoader}</td>
 * </tr>
 * </table>
 * <br>
 * The tree spanned by the hierarchy of the
 * {@link net.sf.mmm.data.reflection.api.ContentClass}es is called
 ...
 * {@link net.sf.mmm.data.reflection.api.ContentClass}. For more details see
 * {@link net.sf.mmm.data.base.AbstractContentObject AbstractContentObject}.
 * 
 * @see net.sf.mmm.data.datatype.api.ContentId
 * 
...
public abstract interface ContentObject extends RevisionedPersistenceEntity<Long>,
   ...
   * {@link net.sf.mmm.data.reflection.api.ContentClass} reflecting this
   * type.
   */
   ...
   * particular {@link net.sf.mmm.data.reflection.api.ContentClass types}
   * (e.g. {@link net.sf.mmm.data.reflection.api.ContentClass} or
   * {@link net.sf.mmm.data.reflection.api.ContentField}) the title has to be
   * unique. <br>
   * 
