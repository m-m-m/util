...
/**
 * This is the interface for a {@link DataObject} that is a regular
 * persistent entity.
 * 
...
public abstract interface DataEntity extends DataObject {
   ...
   * {@link net.sf.mmm.data.api.reflection.DataClass type}. This method
   ...
   * same {@link net.sf.mmm.data.api.reflection.DataClass type}. Then all
   * unset {@link net.sf.mmm.data.api.reflection.DataField fields} are
   ...
   * {@link net.sf.mmm.data.api.reflection.DataClass type} as this
   * instance.
   * 
