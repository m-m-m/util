 ...
 * {@link DataObject} can represent a historic {@link #getRevision()
 * revision} out of this history. It therefore is immutable so operations to
 * modify the {@link DataObject} will fail.</li>
 * </ul>
 ...
 * Method}</td>
 * <td>{@link net.sf.mmm.data.api.reflection.DataField ContentField}</td>
 * </tr>
 * <tr>
 * <td>{@link ClassLoader}</td>
 * <td>{@link net.sf.mmm.data.api.reflection.DataClassLoader
 ...
 * {@link net.sf.mmm.data.api.reflection.DataClass}. For more details see
...
public abstract interface DataObject extends RevisionedPersistenceEntity<Long>,
   ...
   * {@link net.sf.mmm.data.api.reflection.DataClass} reflecting this
   * type.
   */
   ...
   * particular {@link net.sf.mmm.data.api.reflection.DataClass types}
   * (e.g. {@link net.sf.mmm.data.api.reflection.DataClass} or
