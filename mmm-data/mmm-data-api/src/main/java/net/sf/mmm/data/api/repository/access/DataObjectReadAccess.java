...
public interface DataObjectReadAccess {
   ...
   * @param entityClass is the java-class reflecting the type of the requested entity.
   ...
   * @return the object with the given identifier.
   * @throws ObjectNotFoundException if no object exists with the given <code>id</code>.
   */
   ...
   * 
   * @param path is the {@link DataEntityResource#getPath() path} of the requested object.
   ...
   *         </ul>
   */
  <E extends DataEntityResource> E getByPath(String path, Class<E> entityClass) throws DataException;
