...
/**
 * This is the view interface for a {@link net.sf.mmm.data.api.DataObject} that
 * is a regular persistent entity. This is the topmost
 * {@link net.sf.mmm.data.api.reflection.DataClass type} that can be
...
public abstract interface DataEntityView extends DataObjectView {
