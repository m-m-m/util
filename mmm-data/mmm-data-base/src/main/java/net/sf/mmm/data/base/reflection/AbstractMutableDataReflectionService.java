...
/**
 * This an the abstract base implementation of the {@link MutableDataReflectionService} interface.
 * 
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
public abstract class AbstractMutableDataReflectionService extends AbstractDataReflectionService implements
    MutableDataReflectionService, ClassResolver {
  ...
  /**
   * This method initializes the default {@link #getTitle2JavaClassMap() name2JavaClassMap}.
   * 
  ...
  /**
   * This method initializes the default {@link #getClassResolver() class-resolver}.
   * 
   ...
   * 
   * @throws DataReflectionNotEditableException if this model is NOT {@link #isEditable() editable}.
   */
   ...
   * {@inheritDoc}
   */
  public <CLASS extends DataObject> AbstractDataClass<? extends CLASS> createDataClass(DataClass<CLASS> superClass,
      String title, DataClassModifiers modifiers) throws DataReflectionException {
    ...
    AbstractDataClass<CLASS> newClass = createDataClass(null, title, parentClass, modifiers, superClass.getJavaClass(),
        false);
    // TODO
   ...
   * {@inheritDoc}
   */
  public <CLASS extends DataObject, FIELD> DataField<CLASS, FIELD> createDataField(DataClass<CLASS> declaringClass,
    ...
    AbstractDataField<CLASS, FIELD> field = createDataField(null, title, contentClass, type, modifiers, false);
  ...
  public void setDeleted(DataReflectionObject<? extends DataObject> classOrField, boolean newDeletedFlag)
    ...
    if (classOrField.isDataClass()) {
      fireEvent(new DataReflectionEvent((DataClass<? extends DataObject>) classOrField, ChangeType.UPDATE));
    } else {
      fireEvent(new DataReflectionEvent((DataField<? extends DataObject, ?>) classOrField, ChangeType.UPDATE));
    }
  }
