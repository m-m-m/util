...
public class MutableLinkListImpl<TARGET extends AbstractDataEntity> extends
   ...
   * {@link net.sf.mmm.data.api.entity.DataEntity} may have multiple
   ...
   * field.
   */
  private List<LinkImpl<TARGET>> allLinkList;
   ...
   *        {@link #entity}. A {@link net.sf.mmm.data.api.entity.DataEntity} may
   *        have multiple {@link net.sf.mmm.data.api.link.LinkList} fields. This
   *        list will contain the links for all of these fields, while this
  ...
  public MutableLinkListImpl(AbstractDataEntity entity, long fieldId,
      List<LinkImpl<TARGET>> allLinkList) {
    ...
    // TODO: initalize linkList
    for (LinkImpl<TARGET> link : allLinkList) {
