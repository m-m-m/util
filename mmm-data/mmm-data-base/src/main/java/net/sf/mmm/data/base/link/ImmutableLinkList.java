 ...
 * create an unmodifiable view on a {@link net.sf.mmm.data.api.link.MutableLinkList}.
 * 
 ...
 * @since 1.0.0
 */
public class ImmutableLinkList<TARGET extends DataEntity> extends AbstractLinkList<TARGET> implements
    MutableLinkList<TARGET> {
