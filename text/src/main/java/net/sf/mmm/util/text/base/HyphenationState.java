...
public class HyphenationState {
   ...
   */
  public HyphenationState(String word, String normalizedWord, char hyphen, int maxPatternLength, int offset, StringHasher hasher) {
  ...
  private static boolean isSubstring(char[] string, String substring, int offset) {
