...
/**
 * This is the abstract base class for a rule used to {@link #transform(String, String) replace} a given string.
 *
...
public abstract class TransformerRule {
   ...
   * @return the replaced {@code string} or {@code null} if this rule does NOT apply and the {@code string} should NOT
   *         be replaced.
   */
