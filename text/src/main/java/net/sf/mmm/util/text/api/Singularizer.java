...
public interface Singularizer {
  ...
  /**
   * This method gets the singular form of the given term (some word) {@code pluralForm} that is (potentially)
   * in plural form. Additionally it preserves the case of the term. <br>
   * The following table illustrates some examples how an implementation for English language could
   * behave:<br>
   * <table border="1">
   * <tr>
   * <th>{@code term}</th>
