...
public class TextColumnInfo {
  ...
  public enum IndentationMode {
     ...
     * After newline in the text, no {@link TextColumnInfo#getIndent() indent} is added for the following line
     * of the column.
     */
    ...
    /**
     * Do NOT add {@link TextColumnInfo#getIndent() indent} for the first line, but for each following lines,
     * even after a single newline in the text. If a column-line starts with a newline (duplicate newlines),
     * this indicates a new paragraph. So after an empty line in the column, no
    ...
    /**
     * Do NOT add {@link TextColumnInfo#getIndent() indent} for the first line, but for each following lines,
     * even after a newline in the text.
     */
