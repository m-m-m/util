...
/**
 * A {@link Hyphenator} is used to hyphenate words. If a word is to long to fit at the end of a line of text, it may be
 * hyphenated according to the {@link #getLocale() locale}. <br>
...
public interface Hyphenator {
  ...
  /**
   * This method gets the {@link Locale} this {@link Hyphenator} works for. It may differ from (be more general than)
   * the {@link Locale} this {@link Hyphenator} was {@link HyphenatorBuilder#getHyphenator(Locale) requested for}.
   *
  ...
  /**
   * This method gets the character used to separate the hyphenated parts of a word. This is typically the character
   * '-'. However it may differ for specific {@link Locale}s.
   *
