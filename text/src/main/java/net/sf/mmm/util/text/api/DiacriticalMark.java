...
public enum DiacriticalMark {
  ...
  ACUTE(UnicodeUtil.ACUTE_ACCENT, UnicodeUtil.COMBINING_ACUTE_ACCENT, "acute accent") {
    ...
    protected void initialize() {
      ...
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_A_WITH_RING_ABOVE, UnicodeUtil.LATIN_SMALL_LETTER_A_WITH_RING_ABOVE_AND_ACUTE);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_A_WITH_RING_ABOVE, UnicodeUtil.LATIN_CAPITAL_LETTER_A_WITH_RING_ABOVE_AND_ACUTE);

      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_STROKE, UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_STROKE_AND_ACUTE);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_STROKE, UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_STROKE_AND_ACUTE);

      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_DIAERESIS, UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_DIAERESIS_AND_ACUTE);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_DIAERESIS, UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_DIAERESIS_AND_ACUTE);
  ...
  CARON(UnicodeUtil.CARON, UnicodeUtil.COMBINING_CARON, "caron") {
    ...
    protected void initialize() {
      ...
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_DIAERESIS, UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_DIAERESIS_AND_CARON);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_DIAERESIS, UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_DIAERESIS_AND_CARON);
      ...
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_D_WITH_SMALL_LETTER_Z, UnicodeUtil.LATIN_CAPITAL_LETTER_D_WITH_SMALL_LETTER_Z_WITH_CARON);
    }
  ...
  DIAERESIS(UnicodeUtil.DIAERESIS, UnicodeUtil.COMBINING_DIAERESIS, "diaeresis") {
    ...
    protected void initialize() {
      ...
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_GRAVE, UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_DIAERESIS_AND_GRAVE);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_GRAVE, UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_DIAERESIS_AND_GRAVE);

      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_CARON, UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_DIAERESIS_AND_CARON);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_CARON, UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_DIAERESIS_AND_CARON);

      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_A_WITH_MACRON, UnicodeUtil.LATIN_SMALL_LETTER_A_WITH_DIAERESIS_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_A_WITH_MACRON, UnicodeUtil.LATIN_CAPITAL_LETTER_A_WITH_DIAERESIS_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_MACRON, UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_DIAERESIS_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_MACRON, UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_DIAERESIS_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_MACRON, UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_DIAERESIS_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_MACRON, UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_DIAERESIS_AND_MACRON);

      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_ACUTE, UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_DIAERESIS_AND_ACUTE);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_ACUTE, UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_DIAERESIS_AND_ACUTE);
    }
  ...
  DOT_ABOVE(UnicodeUtil.DOT_ABOVE, UnicodeUtil.COMBINING_DOT_ABOVE, "dot above") {
    ...
    protected void initialize() {
      ...
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_A_WITH_MACRON, UnicodeUtil.LATIN_CAPITAL_LETTER_A_WITH_DOT_ABOVE_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_A_WITH_MACRON, UnicodeUtil.LATIN_SMALL_LETTER_A_WITH_DOT_ABOVE_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_MACRON, UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_DOT_ABOVE_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_MACRON, UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_DOT_ABOVE_AND_MACRON);
    }
  ...
  GRAVE(UnicodeUtil.GRAVE_ACCENT, UnicodeUtil.COMBINING_GRAVE_ACCENT, "grave accent") {
    ...
    protected void initialize() {
      ...
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_DIAERESIS, UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_DIAERESIS_AND_GRAVE);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_DIAERESIS, UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_DIAERESIS_AND_GRAVE);
    }
  ...
  HOOK_ABOVE(UnicodeUtil.HOOK_ABOVE, UnicodeUtil.COMBINING_HOOK_ABOVE, "hook above") {
    ...
    protected void initialize() {
      ...
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_DOTLESS_J_WITH_STROKE, UnicodeUtil.LATIN_SMALL_LETTER_DOTLESS_J_WITH_STROKE_AND_HOOK);
  ...
  MACRON(UnicodeUtil.MACRON, UnicodeUtil.COMBINING_MACRON, "macron") {
    ...
    protected void initialize() {
      ...
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_A_WITH_DIAERESIS, UnicodeUtil.LATIN_CAPITAL_LETTER_A_WITH_DIAERESIS_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_A_WITH_DIAERESIS, UnicodeUtil.LATIN_SMALL_LETTER_A_WITH_DIAERESIS_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_DIAERESIS, UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_DIAERESIS_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_DIAERESIS, UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_DIAERESIS_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_DIAERESIS, UnicodeUtil.LATIN_CAPITAL_LETTER_U_WITH_DIAERESIS_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_DIAERESIS, UnicodeUtil.LATIN_SMALL_LETTER_U_WITH_DIAERESIS_AND_MACRON);

      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_A_WITH_DOT_ABOVE, UnicodeUtil.LATIN_CAPITAL_LETTER_A_WITH_DOT_ABOVE_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_A_WITH_DOT_ABOVE, UnicodeUtil.LATIN_SMALL_LETTER_A_WITH_DOT_ABOVE_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_DOT_ABOVE, UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_DOT_ABOVE_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_DOT_ABOVE, UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_DOT_ABOVE_AND_MACRON);

      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_OGONEK, UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_OGONEK_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_OGONEK, UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_OGONEK_AND_MACRON);

      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_TILDE, UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_TILDE_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_TILDE, UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_TILDE_AND_MACRON);
  ...
  OGONEK(UnicodeUtil.OGONEK, UnicodeUtil.COMBINING_OGONEK, "ogonek") {
    ...
    protected void initialize() {
      ...
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_MACRON, UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_OGONEK_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_MACRON, UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_OGONEK_AND_MACRON);
    }
  },
  ...
  RING_ABOVE(UnicodeUtil.RING_ABOVE, UnicodeUtil.COMBINING_RING_ABOVE, "ring above") {
    ...
    protected void initialize() {
      ...
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_A_WITH_ACUTE, UnicodeUtil.LATIN_SMALL_LETTER_A_WITH_RING_ABOVE_AND_ACUTE);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_A_WITH_ACUTE, UnicodeUtil.LATIN_CAPITAL_LETTER_A_WITH_RING_ABOVE_AND_ACUTE);
    }
  ...
  SHORT_SOLIDUS_OVERLAY(UnicodeUtil.SOLIDUS, UnicodeUtil.COMBINING_SHORT_SOLIDUS_OVERLAY, "short solidus") {
    ...
    protected void initialize() {
      ...
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_ACUTE, UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_STROKE_AND_ACUTE);
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_ACUTE, UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_STROKE_AND_ACUTE);
    }
  },
  ...
  TILDE(UnicodeUtil.TILDE, UnicodeUtil.COMBINING_TILDE, "tilde") {
    ...
    protected void initialize() {
      ...
      addComposition(UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_MACRON, UnicodeUtil.LATIN_CAPITAL_LETTER_O_WITH_TILDE_AND_MACRON);
      addComposition(UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_MACRON, UnicodeUtil.LATIN_SMALL_LETTER_O_WITH_TILDE_AND_MACRON);
    }
  ...
  protected void addComposition(char uncomposed, char composed) {
    ...
    if (old != null) {
      throw new IllegalStateException("Duplicate composition for character: " + u);
    }
  }
  ...
  /**
   * @deprecated use {@link #getSeparateCharacter()} instead.
   * @return the {@link #getSeparateCharacter()}.
   */
  @Deprecated
   ...
   * @return the composed character (e.g. '&auml;' or '&aacute;') or {@code null} if no such composition
   *         exists in unicode.
   */
  ...
  /**
   * This method de-composes the given {@code character} with this {@link DiacriticalMark}. In other words
   * this {@link DiacriticalMark} is removed from the given {@code character} if it is {@link #compose(char)
   * composed}. It is the inverse operation of {@link #compose(char)}.
   *
