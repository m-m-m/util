...
public class HyphenatorBuilderImplTest extends AbstractHyphenatorTest {
  ...
  public void testEnUs() {
    ...
    checkHyphenations(hyphenator, "word", "this", "a", "con-struc-tion",
        ...
        "spec-tro-elec-tro-chem-istry", "hy-phen-ation", "hyp-not-ic", "care-tak-er", "as-pi-rin", "as-pir-ing", "in-de-pen-dent", "tri-bune", "pro-gress",
        "even-ing", "pe-ri-od-ic", "as-so-ciate", "squirmed", "bio-rhythm", "ho-mol-o-gous", "be-tray-al", "de-spair", "per-fect-ly");
    // , "Af-ghan-i-stan"
  }
}
