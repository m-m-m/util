...
/**
 * This class represents a {@link java.io.FileFilter file-filter} that only accepts {@link java.io.File#isFile()
 * "plain files"}. Use {@link #getInstance()} to get the instance of this filter.
 *
