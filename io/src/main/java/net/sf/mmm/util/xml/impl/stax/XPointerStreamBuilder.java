...
/**
 * This is the interface used to create an {@link XMLStreamReader} facade that adapts a given {@link XMLStreamReader}
...
public interface XPointerStreamBuilder {
  ...
  /**
   * This method creates a {@link XMLStreamReader} facade that adapts the given {@code xmlReader} so only the contents
   * pointed by the given {@code xpointerExpression} are visible.
   *
