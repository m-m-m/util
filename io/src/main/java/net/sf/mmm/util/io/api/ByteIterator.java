...
public interface ByteIterator {
   ...
   * to the next byte in the iteration or to the end if there is no such byte {@link #hasNext() available}. <br>
   * <b>ATTENTION:</b><br>
   ...
   * @return the number of bytes that have actually been skipped. This will typically be equal to {@code byteCount}.
   *         However the value may be less if the end of this iterator has been reached before the according number of
   *         bytes have been skipped. The value will always be greater or equal to {@code 0}.
   */
