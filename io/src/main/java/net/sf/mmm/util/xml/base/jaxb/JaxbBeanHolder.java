...
/**
 * This class is a container {@link #getBean() holding} a JAXB bean. Storing this {@link JaxbBeanHolder} instead of the
 * {@link #getBean() bean} itself in a field of some class allows the actual {@link #getBean() bean} to be
 * {@link #refresh() reloaded} in the meantime. If {@link java.io.Flushable} is implemented, then it can also be saved
 * via {@link java.io.Flushable#flush()}.
 *
