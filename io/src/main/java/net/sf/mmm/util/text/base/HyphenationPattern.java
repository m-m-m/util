...
public class HyphenationPattern {
   ...
   * @param hasher is the {@link StringHasher hash-algorithm} to use for the {@link #getWordPartHash() word-part-hash}.
   */
  ...
  /**
   * This method gets the <em>word-part</em>, that is the {@link HyphenationPattern pattern} without digits. If the
   * word-part is a substring of the word to hyphenate (enclosed with '.'), the {@link #getHyphenationPositions()
   * hyphenation-points} are applied to the {@link HyphenationState}.
   *
   ...
   * <b>ATTENTION:</b><br>
   * The result may be different to the {@link String#hashCode() hash-code} of {@link #getWordPart() word-part}. A
   * specific hash algorithm is used that allows efficient calculation of shifting substrings.
   *
   * @return the hash.
   */
  ...
  /**
   * This method gets the original pattern ({@link #getWordPart() word-part} with {@link #getHyphenationPositions()
