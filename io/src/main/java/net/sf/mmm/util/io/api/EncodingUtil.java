...
public interface EncodingUtil {
  ...
  /**
   * The encoding {@code UTF-16}. It is an 16-bit Unicode Transformation Format. The byte-order is
  ...
  /**
   * The encoding {@code UTF-32}. It is an 32-bit Unicode Transformation Format. The byte-order is
   * determined by an optional {@link ByteOrderMark}. <br>
   * <b>ATTENTION:</b><br>
  ...
  /**
   * The encoding {@code ISO-8859-1} also called {@code Latin-1}. It is covering most Western
  ...
  /**
   * The encoding {@code ISO-8859-2} also called {@code Latin-2}. It is covering the Central and
  ...
  /**
   * The encoding {@code ISO-8859-3} also called {@code Latin-3}. It is covering the South European
   * languages. <br>
  ...
  /**
   * The encoding {@code ISO-8859-4} also called {@code Latin-4}. It is covering the North European
   * languages. <br>
   * This is a basic encoding for Java contained in {@code lib/rt.jar}.
   */
  ...
  /**
   * The encoding {@code ISO-8859-5}. It is covering mostly Slavic languages that use a Cyrillic
   * alphabet. <br>
   * This is a basic encoding for Java contained in {@code lib/rt.jar}.
   */
  ...
  /**
   * The encoding {@code ISO-8859-9} also called {@code Latin-5}. It is covering Turkish and
   * Kurdish. <br>
   * This is a basic encoding for Java contained in {@code lib/rt.jar}.
   */
  ...
  /**
   * The encoding {@code ISO-8859-11}. The {@link java.nio.charset.Charset#name() canonical name} however
   * is {@code x-iso-8859-11}. It is covering common Thai language characters.
   */
  String ENCODING_ISO_8859_11 = "x-iso-8859-11";

  /**
   * The encoding {@code ISO-8859-12}. The work on this encoding for Devanagari was stopped so it does
   * NOT exist at all.
   */
  @Deprecated
  ...
  /**
   * The encoding {@code ISO-8859-16} also called {@code Latin-10}. It is covering South-Eastern
  ...
  /**
   * The encoding {@code CP850}. It is used by MS-DOS for Western European languages and is therefore
   * related to {@link #ENCODING_ISO_8859_1}.
   */
  String ENCODING_CP_850 = "IBM850";

  /**
   * The encoding {@code CP852}. It is used by MS-DOS for Central European languages and is therefore
   * related to {@link #ENCODING_ISO_8859_2}.
   */
  ...
  /**
   * The encoding {@code CP861}. It is used by MS-DOS for Nordic languages especially for Icelandic and
  ...
  /**
   * The encoding {@code CP1250} also called {@code Windows-1250}. It is used by Microsoft Windows
  ...
  /**
   * The encoding {@code CP1251} also called {@code Windows-1251}. It is used by Microsoft Windows
  ...
  /**
   * The encoding {@code CP1252} also called {@code Windows-1252}. It is used by Microsoft Windows
  ...
  /**
   * The encoding {@code CP1253} also called {@code Windows-1253}. It is used by Microsoft Windows
  ...
  /**
   * The encoding {@code CP1254} also called {@code Windows-1254}. It is used by Microsoft Windows
  ...
  /**
   * The encoding {@code CP1255} also called {@code Windows-1255}. It is used by Microsoft Windows
   * for Hebrew and is similar to {@link #ENCODING_ISO_8859_8}.
   */
  String ENCODING_WINDOWS_1255 = "windows-1255";

  /**
   * The encoding {@code CP1256} also called {@code Windows-1256}. It is used by Microsoft Windows
   * for Arabic and is similar to {@link #ENCODING_ISO_8859_6}.
   */
  String ENCODING_WINDOWS_1256 = "windows-1256";

  /**
   * The encoding {@code CP1257} also called {@code Windows-1257}. It is used by Microsoft Windows
  ...
  /**
   * The encoding {@code CP1258} also called {@code Windows-1258}. It is used by Microsoft Windows
   * for Vietnamese and is similar to {@link #ENCODING_WINDOWS_1252}.
   */
   ...
   * encoding. As long as no UTF characteristic was detected and only ASCII-characters ({@code <128})
   * are hit, the encoding remains {@link #ENCODING_US_ASCII}. As soon as an UTF sequence was detected (e.g.
