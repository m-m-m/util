...
/**
 * Provides the API for utilities that help to read and write data, process bytes, etc. <a name="documentation"></a>
 * <h2>IO-Util API</h2> Dealing with {@link java.io} is NOT an easy task. This package provides utilities that make it
