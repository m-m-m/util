...
/**
 * This is the interface used to {@link #getHyphenator(Locale) retrieve} a {@link Hyphenator} for a given {@link Locale}
 * . <br>
...
public interface HyphenatorBuilder {
  ...
  /**
   * This method {@link #getHyphenator(Locale) gets} the {@link Hyphenator} for the {@link Locale#getDefault() default
   * locale}.
   *
