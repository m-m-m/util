 ...
 *
 * @deprecated Java serialization has been the source of several security issues. Prefer custom serialization
 *             (e.g. to JSON or XML).
...
public class GenericSerializableException extends RuntimeException implements NlsThrowable, NlsMessage {
   ...
   */
  public GenericSerializableException(Throwable cause, String message, String originalExceptionName, StackTraceElement[] stacktrace, boolean technical,
  ...
  public GenericSerializableException createCopy(ExceptionTruncation truncation) {
    ...
    GenericSerializableException copy = new GenericSerializableException(newCause, getMessage(), this.originalExceptionName, newStacktrace, this.technical,
        this.code, this.uuid);
